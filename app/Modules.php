...
class Modules extends Model
{
    ...
    {
        $moduleFields = ['id', 'varTitle', 'varModuleName', 'varModuleNameSpace'];
        $response = false;
        $response = Self::getRecords($moduleFields)
            ->publish()
            ->deleted()
    ...
    public static function getLogModuleList($ignoreIds = false)
    {
        $moduleFields = [
            'id',
            'varTitle',
...
public static function getFrontCmsModulesList($ignoreIds = false) {
        $moduleFields = [
            'id',
            'varTitle',
            'varModelName',
