...
class LiveUsers extends Model {
    ...
    /**
     * This method handels retrival of live users for chart
     * @return  Object
     * @since   2022-06-14
     * @author  NetQuick
     */
    static function getChartUsers() {
    	$moduleFields = [
    		'varCity',
				'varLatitude',
				'varLongitude'
    	...
    	$users = Self::select($moduleFields)
    	->orderBy('varCity')
    	->groupBy('varCity')
    	->whereNotNull('varCity')
    	->whereNotNull('varLatitude')
    	->whereNotNull('varLongitude')
    	->get();
    	return $users;
    }
