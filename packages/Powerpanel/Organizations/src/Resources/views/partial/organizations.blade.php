<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionOrganizationsModule" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionOrganizationsModule']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Organizations</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="parentorg" class="form-control bootstrap-select bs-select layout-class" id="organization-template-layout">
