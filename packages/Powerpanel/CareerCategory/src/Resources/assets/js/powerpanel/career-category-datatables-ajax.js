...
var TableDatatablesAjax = function() {
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div CareerCategory_title_P_2'
                    },
                    // {
                    //     "data": 3,
                    //     className: 'text-center CareerCategory_sdate_P_3',
                    //     "name": 'dtDateTime',
                    //     "bSortable": true
                    // }, {
                    //     "data": 4,
                    //     className: 'text-center CareerCategory_edate_P_4',
                    //     "name": 'dtEndDateTime',
                    //     "bSortable": true
                    // },
                    {
                        "data": 3,
                        className: 'text-center CareerCategory_order_P_5',
                        "name": 'intDisplayOrder'
                    },
                    //  {
                    //     "data": 6,
                    //     className: 'text-center CareerCategory_hits_P_6',
                    //     "bSortable": false
                    // },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-center publish_switch CareerCategory_publish_P_7'
                    },
                    {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div CareerCategory_dactions_P_8'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/career-category/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function(e) {
            ...
            if (action.length >= 2) {
                $.cookie('FaqCategorysearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else if (action.length < 1) {
                $.removeCookie('FaqCategorysearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div CareerCategory_title_A_2',
                        "bSortable": true
                    },
                    //  {
                    //     "data": 2,
                    //     "name": 'dtDateTime',
                    //     className: 'text-center CareerCategory_sdate_A_3'
                    // }, {
                    //     "data": 3,
                    //     className: 'text-center CareerCategory_edate_A_4',
                    //     "name": 'dtEndDateTime',
                    //     "bSortable": false
                    // },
                    //  {
                    //     "data": 4,
                    //     className: 'text-center CareerCategory_hits_A_6',
                    //     "bSortable": false
                    // },
                    {
                        "data": 2,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div CareerCategory_dactions_A_8'
                    },
                    {
                        "data": 3,
                        "bSortable": false,
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/career-category/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div CareerCategory_title_D_2'
                    },
                    // {
                    //     "data": 2,
                    //     className: 'text-center CareerCategory_sdate_D_3',
                    //     "name": 'dtDateTime',
                    //     "bSortable": true
                    // }, {
                    //     "data": 3,
                    //     className: 'text-center CareerCategory_edate_D_4',
                    //     "name": 'dtEndDateTime',
                    //     "bSortable": true
                    // },
                    // {
                    //     "data": 4,
                    //     className: 'text-center CareerCategory_hits_D_6',
                    //     "bSortable": false
                    // },
                    {
                        "data": 2,
                        "bSortable": false,
                        className: 'text-center publish_switch CareerCategory_publish_D_7'
                    },
                    {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div CareerCategory_dactions_D_8'
                    },
                ],

                "ajax": {
                    "url": window.site_url + "/powerpanel/career-category/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[2]);
                },
                "order": [
                    [2, "desc"]
                ]
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div CareerCategory_title_T_2'
                    },
                    //  {
                    //     "data": 2,
                    //     className: 'text-center CareerCategory_sdate_T_3',
                    //     "name": 'dtDateTime',
                    //     "bSortable": true
                    // }, {
                    //     "data": 3,
                    //     className: 'text-center CareerCategory_edate_T_4',
                    //     "name": 'dtEndDateTime',
                    //     "bSortable": true
                    // },
                    // {
                    ...
                    // },
                    {
                        "data": 2,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div CareerCategory_dactions_T_8'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/career-category/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div CareerCategory_title_F_2'
                    },
                    //  {
                    //     "data": 3,
                    //     className: 'text-center CareerCategory_sdate_F_3',
                    //     "name": 'dtDateTime',
                    //     "bSortable": true
                    // }, {
                    //     "data": 4,
                    //     className: 'text-center CareerCategory_edate_F_4',
                    //     "name": 'dtEndDateTime',
                    //     "bSortable": true
                    // },
                    //  {
                    //     "data": 5,
                    //     className: 'text-center CareerCategory_hits_F_6',
                    //     "bSortable": false
                    // },
                    {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div CareerCategory_dactions_F_8'
                    },
                ],
                "columnDefs": [{
                    "targets": [4],
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/career-category/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[4]);
                },
...
$(window).on('load', function() {
    if ($.cookie('FaqCategorysearch')) {
        $('#searchfilter').val($.cookie('FaqCategorysearch'));
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/career-category/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
