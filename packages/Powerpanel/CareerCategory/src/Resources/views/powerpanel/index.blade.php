    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                ...
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('career-category-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/career-category/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('careercategory::template.careerCategoryModule.addCareerCategory') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('careercategory::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('careercategory::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('careercategory::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                                ...
                                $tablearray = [
                                    'DataTableTab'=>[
                                        'ColumnSetting'=>[
                                            ...
                                            ['Identity_Name'=>'order','TabIndex'=>'2','Name'=>'Order'],
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'CareerCategory','Permission_Delete'=>'career-category-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'careerCategory'])
                @endif
                @else
                @if (File::exists(base_path() . '/resources/views/powerpanel/partials/addrecordsection.blade.php') != null)
                @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/career-category/add')])
                @endif
            @endif
...
@section('scripts')
    <script type="text/javascript">
        window.site_url = '{!! url("/") !!}';
        var DELETE_URL = '{!! url("/powerpanel/career-category/DeleteRecord") !!}';
        var rollbackRoute = window.site_url + "/powerpanel/career-category/rollback-record";
        var APPROVE_URL = '{!! url("/powerpanel/career-category/ApprovedData_Listing") !!}';
        var getChildData = window.site_url + "/powerpanel/career-category/getChildData";
        var getChildData_rollback = window.site_url + "/powerpanel/career-category/getChildData_rollback";
        var ApprovedData_Listing = window.site_url + "/powerpanel/career-category/ApprovedData_Listing";
        var Get_Comments = window.site_url + "/powerpanel/career-category/Get_Comments";
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/careercategory/career-category-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
