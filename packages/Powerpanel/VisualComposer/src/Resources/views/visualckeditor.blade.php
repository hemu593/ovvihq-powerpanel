<script src="{{ $CDN_PATH.'resources/global/plugins/ckeditor/ckeditor.js?v='.time() }}" type="text/javascript"></script>
<script type="text/javascript">
var baseURL = '{!!ENV('APP_URL').'powerpanel/'!!}';
...
//     link: {
//         decorators: {   
//             // defaultProtocol: 'http://', // https://ckeditor.com/docs/ckeditor5/latest/features/link.html#adding-default-link-protocol-to-external-links
//             openInNewTab: {
//                 mode: 'manual',
...
var simpleConfig = ckconfig;
var cmsConfig = ckconfig;
