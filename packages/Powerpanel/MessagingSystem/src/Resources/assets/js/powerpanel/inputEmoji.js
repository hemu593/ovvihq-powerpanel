(function ($) {
	$.fn.emoji = function (params) {
		...
		this.each(function (n, input) {
			...
			var $button = $("<span class='span_emoji_icon'>").html(settings.button).css({cursor: 'pointer', 'font-size': settings.fontSize}).on('click', showEmoji);
			var $list = $('<div class="Emoji_list_div">').css(defaults.listCSS).css(settings.listCSS);
