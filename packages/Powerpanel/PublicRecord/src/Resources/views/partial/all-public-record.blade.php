<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionPublicRecordModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionPublicRecordModuleTemplate']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Public Record</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group hide">
                         ...
                         <div class="form-group">
                            <label class="control-label form_title">Limit (Note: All the news will be shown if Limit not entered)</label>
