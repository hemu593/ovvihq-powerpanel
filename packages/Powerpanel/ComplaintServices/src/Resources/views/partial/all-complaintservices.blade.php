<div class="ac-modal modal fade bd-example-modal-lg" id="sectionComplaintServicesModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">  <!-- composer-element-popup ckeditor-popup ckbusiness-popup -->  
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            {!! Form::open(['method' => 'post','id'=>'frmSectionComplaintServicesModuleTemplate']) !!}
            <input type="hidden" name="editing">
            <input type="hidden" name="template">
            <div class="modal-header mb-2">
                <h5 class="modal-title" id="exampleModalLabel">Complaint Services</h5>
            ...
            <div class="modal-body">
                ...
                <div class="cm-floating" style="display: none">
                    ...
                    <select name="section_config" class="form-select" id="config"> <!-- form-control bootstrap-select bs-select layout-class -->
                        ...
                        <option value="3">Title, Email</option>
                        <option value="4">Image, Title, Email</option>
                        <option value="5">Image, Title, Short Description,Email</option>
                    </select>
                </div> 
                <div class="cm-floating" style="display: none">
                 ...
                 <div class="cm-floating">
                    <label class="control-label form_title">Limit 
                        <span class="img-note" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Note: All the Complaint Services will be shown if Limit not entered">
