<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionComplaintServicesModule" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionComplaintServicesModule']) !!}
                        ...
                        <div class="form-group" style="display: none">
                            ...
                            <select name="section_config" class="form-control bootstrap-select bs-select config-class" id="config">
                               <option value="">Configurations</option>
                                ...
                                <option value="5" selected>Image, Title, Short Description,Email</option>
                            </select>
                        </div>
                        <div class="form-group" style="display: none">
                                        ...
                                        <table class="responsive new_table_desing table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="45%" align="left">{{ trans('visualcomposer::template.common.title') }}</th>
                                                    <th width="45%" align="left">Updated Date</th>
                                                </tr>
                                            </thead>
                                        </table>
                                        <div class="table-scrollable full-info-table" id="mcscroll" style="height: 200px">
                                            <table class="responsive new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_complaint-services_ajax">
