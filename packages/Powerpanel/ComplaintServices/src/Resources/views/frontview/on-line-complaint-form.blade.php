                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group ac-form-group">
                            ...
                            {!! Form::text('first_name', old('first_name'), array('id'=>'first_name', 'class'=>'form-control ac-input', 'id'=>'first_name', 'autocomplete'=>'off', 'maxlength'=>'60', 'onpaste'=>'return false;', 'ondrop'=>'return false;')) !!}
                    ...
                    <div class="col-sm-6">
                        <div class="form-group ac-form-group">
                            ...
                            <input type="text" class="form-control ac-input startDate" onkeydown="return false" id="date_complaint" name="date_complaint" minlength="1" maxlength="255" spellcheck="true" onpaste="return false;" ondrop="return false;" autocomplete="off">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group ac-form-group">
                            ...
                            <input type="file" class="form-control ac-input" id="file"  accept=".pdf,.doc,.docx" name="file[]" autocomplete="off"  multiple>

                            <span class="ac-note">You can upload maximum 5 document(s) having the extension *.pdf, *.doc,*.docx and files must not exceed 10 MB.</span>
                            @if ($errors->has('file'))
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group ac-form-group n-tar-sm n-tal">
                            <button type="submit" id="online_submit" title="Submit" class="ac-btn ac-btn-primary">Submit</button>
                        </div>
                    </div>
                  
                    <div class="col-sm-12">
                        <div class="form-group ac-form-group">
                            <span class="ac-note">Note: Further information can be submitted directly to {{$ComplaintServices->txtEmail}}.</span>
                        </div>
                    </div>
