    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('team-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/team/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('team::template.teamModule.addTeamMember') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                    ...
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            $tablearray = [
                                'DataTableTab'=>[
                                    'ColumnSetting'=>[
                                        ['Identity_Name'=>'title','TabIndex'=>'1','Name'=>'Name'],
                                        ['Identity_Name'=>'frequency','TabIndex'=>'2','Name'=>'Designation'],
                                        ['Identity_Name'=>'photo','TabIndex'=>'3','Name'=>'Photo'],
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'Team','Permission_Delete'=>'team-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'team'])
                @endif
                @else
...
<script type="text/javascript">
    ...
    var APPROVE_URL = '{!! url("/powerpanel/team/ApprovedData_Listing") !!}';
    var getChildData = window.site_url + "/powerpanel/team/getChildData";
    var getChildData_rollback = window.site_url + "/powerpanel/team/getChildData_rollback";
    var ApprovedData_Listing = window.site_url + "/powerpanel/team/ApprovedData_Listing";
    var rollbackRoute = window.site_url + "/powerpanel/team/rollback-record";
    var Get_Comments = '{!! url("/powerpanel/team/Get_Comments") !!}';
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/team/team-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
