                ...
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('workflow-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/workflow/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('workflow::template.workflowModule.addWorkflow') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                        ...
                        <div class="cm-filter flex-grow-1 order-sm-1 d-flex align-items-center">
                            ...
                            <div class="filter-search d-inline-block">
                                <input type="search" class="form-control search" placeholder="Search by Role" id="searchfilter">
                        ...
                        <div class="table-responsive">
                            @php
                                $tablearray = [
                                    'DataTableTab'=>[
                                        'ColumnSetting'=>[
                                            ['Identity_Name'=>'role','TabIndex'=>'1','Name'=>'Role'],
                                            ['Identity_Name'=>'dactions','TabIndex'=>'2','Name'=>'Action']
                                        ],
                                        'DataTableHead'=>[
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'workflow','Permission_Delete'=>'workflow-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                            {{-- @can('workflow-delete')
                                <button href="javascript:;" class="btn btn-danger waves-effect btn-label deleteMass hide-btn-mob">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/workflow/workflow-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    var moduleName = 'workflow';</script>
@endif
