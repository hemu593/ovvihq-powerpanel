    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-12 lpgap">
                            <article>
                                ...
                                <div class="form-group ac-form-group n-mb-0">
                                    <select class="selectpicker ac-input" data-width="100%" title="Sort by Month" data-size="5">
            ...
            <div class="col-xl-9 n-mt-25 n-mt-xl-0" data-aos="fade-up">
                <div class="cms">
                    <p>When Cable & Wireless submits a Service Filing to the Authority, it is almost invariably accompanied by a claim of confidentiality under the provisions of the ICTA (Confidentiality) Regulations, 2003. The submission includes a redacted version of the filing which is placed on the public record (below). Frequently the Title is also redacted, and the omitted words are replaced by '###'</p>
                </div>
