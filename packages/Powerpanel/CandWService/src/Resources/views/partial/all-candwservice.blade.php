<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectioncandwserviceModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectioncandwserviceModuleTemplate']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>candwservice</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group hide">
                            ...
                            <select name="section_config" class="form-control bootstrap-select bs-select config-class" id="config">
                                ...
                                <option value="1">Upload File &amp; Title</option>
                                <option value="2">Upload File &amp;,Title</option>
                                <option value="3">Title, Start Date</option>
                                <option value="4">Upload File, Title, Start Date</option>
                                <option value="5" selected>Upload File, Title, Start Date</option>
                            </select>
                        </div> 
                        <div class="form-group hide">
                         ...
                         <div class="form-group hide">
                            ...
                            {!! Form::text('candwservice_start_date_time', old('candwservice_start_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'candwservice_start_date_time','autocomplete'=>'off')) !!}
                        </div>
                        <div class="form-group hide">
                            <label class="control-label form_title">End Date</label>
                            {!! Form::text('candwservice_end_date_time', old('candwservice_end_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'candwservice_end_date_time','autocomplete'=>'off')) !!}
                        </div>
                         <div class="form-group">
                            <label class="control-label form_title">Limit (Note: All the candwservice will be shown if Limit not entered)</label>
