<?php
namespace Powerpanel\ServiceCategory\Models;
...
class ServiceCategory extends Model {
    ...
    public static function getRecordIdByAliasID($aliasID) {
        $response = false;
        $response = Cache::tags(['ServiceCategory'])->get('getServiceCategoryRecordIdByAliasID_' . $aliasID);
        if (empty($response)) {
            $response = Self::Select('id')->deleted()->publish()->checkAliasId($aliasID)->first();
            Cache::tags(['ServiceCategory'])->forever('getServiceCategoryRecordIdByAliasID_' . $aliasID, $response);
        }
        return $response;
    }
    /**
    ...
    public static function getRecordDataByAliasID($aliasID) {
        $response = false;
        $response = Cache::tags(['ServiceCategory'])->get('getPublicationsCatRecordDataByAliasID' . $aliasID);
        if (empty($response)) {
            $response = Self::Select(
                    ...
                    ->first();
            Cache::tags(['ServiceCategory'])->forever('getPublicationsCatRecordDataByAliasID' . $aliasID, $response);
        }
        return $response;
    }
    ...
    public static function getLatestForHome($limit = 1) {
        ...
        $aliasFields = ['id', 'varAlias'];
        $response = Cache::tags(['ServiceCategory'])->get('getLatestForHome_' . $limit);
        if (empty($response)) {
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ...
                    ->get();
            Cache::tags(['ServiceCategory'])->forever('getLatestForHome_' . $limit, $response);
        }
        return $response;
    }
    /**
     * This method handels retrival of front latest ServiceCategory list
     * @return  Object
     * @since   2017-10-13
     * @author  NetQuick
     */
    public static function getFrontPopularList($id = false) {
        ...
        $aliasFields = ['id', 'varAlias'];
        $response = Cache::tags(['ServiceCategory'])->get('getFrontPopularServiceCategoryList_' . $id);
        if (empty($response)) {
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ->deleted()
                    ->publish()
                    ...
                    ->take(3)
                    ->get();
            Cache::tags(['ServiceCategory'])->forever('getFrontPopularServiceCategoryList_' . $id, $response);
        }
        return $response;
    }
    ...
    public static function getRecordListDraft($filterArr = false, $isAdmin = false, $ignoreId = array(), $userRoleSector) {
        ...
        $aliasFields = ['id', 'varAlias'];
        $response = Self::getPowerPanelRecords($moduleFields, $aliasFields)->deleted()
                ->filter($filterArr)
                ->where(function ($query) use ($userid) {
                    $query->where("UserID", '=', $userid)->where('chrPageActive', '=', 'PR')
                    ->orWhere('chrPageActive', '!=', 'PR');
    ...
    public static function getRecordList_tab1($filterArr = false, $isAdmin = false, $ignoreId = array(), $userRoleSector) {
        $response = false;
        $cmsPageFields = ['id','fkMainRecord', 'intAliasId', 'varTitle','varSector', 'dtDateTime', 'txtDescription', 'intDisplayOrder', 'varMetaTitle', 'varMetaDescription', 'chrPublish', 'chrDelete','LockUserID','chrLock', 'chrAddStar', 'chrPageActive', 'varPassword', 'chrDraft', 'chrTrash', 'FavoriteID', 'created_at', 'updated_at'];
        $aliasFields = ['id', 'varAlias'];
        $MainIDs = Self::distinct()
                ->select("fkMainRecord")
                ->where('chrMain', 'N')
    ...
    /**
     * This method handels retrival of ServiceCategory records old version *=Delete it afterwards=*
     * @return  Object
     * @since   2016-07-14
     * @author  NetQuick
     */
    ...
    /**
     * This method handels retrival of ServiceCategory records
     * @return  Object
     * @since   2016-07-14
     * @author  NetQuick
     */
    ...
    public function child() {
        return $this->hasMany('Powerpanel\ServiceCategory\Models\ServiceCategory', 'fkMainRecord', 'id');
    }
    ...
    public static function getFeaturedList($limit = 10) {
        $response = false;
        $response = Cache::tags(['ServiceCategory'])->get('getServiceCategoryFeaturedList');
        if (empty($response)) {
            ...
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ...
                    ->take($limit)
                    ->get();
            Cache::tags(['ServiceCategory'])->forever('getServiceCategoryFeaturedList', $response);
        }
        return $response;
    }
    /**
...
//        print_r($response);exit;
    ...
    public static function approved_data_Listing($request) {
        ...
        CommonModel::updateRecords($whereConditions, $updateMainRecord, false, 'Powerpanel\ServiceCategory\Models\ServiceCategory');
    ...
    public static function getFrontList($filterArr = false, $page = 1, $monthid = false, $yearid = false, $print = false) {
        ...
        $moduleFields = ['id',
            ...
            'updated_at'];
        $aliasFields = ['id', 'varAlias'];
        $response = Cache::tags(['ServiceCategory'])->get('getFrontServiceCategoryList_' . $page);
        if (empty($response)) {
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ->deleted()
                    ->publish()
            ...
            Cache::tags(['ServiceCategory'])->forever('getFrontServiceCategoryList_' . $page, $response);
        }
        return $response;
    }
    ...
    public static function getFrontDetail($id) {
        ...
        $aliasFields = ['id', 'varAlias'];
        $response = Cache::tags(['ServiceCategory'])->get('getFrontServiceCategoryDetail_' . $id);
        if (empty($response)) {
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ->deleted()
                    ->publish()
                    ...
                    ->checkAliasId($id)
                    ->first();
            Cache::tags(['ServiceCategory'])->forever('getFrontServiceCategoryDetail_' . $id, $response);
        }
        return $response;
    }
    /**
    ...
    public static function getLatestList($id = false) {
        ...
        $moduleFields = ['id',
            ...
            'chrPublish', 'chrPageActive', 'varPassword', 'chrDraft', 'chrTrash', 'FavoriteID', 'created_at', 'updated_at'];
        $aliasFields = ['id', 'varAlias'];
        $response = Cache::tags(['ServiceCategory'])->get('getFrontLatestServiceCategoryList_' . $id);
        if (empty($response)) {
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ->deleted()
                    ->publish()
                    ...
                    ->take(5)
                    ->get();
            Cache::tags(['ServiceCategory'])->forever('getFrontLatestServiceCategoryList_' . $id, $response);
        }
        return $response;
    }
    /**
    ...
    public static function getAllCategoriesFrontSidebarList() {
        ...
        $aliasFields = ['id', 'varAlias'];
        $response = Cache::tags(['ServiceCategory'])->get('getAllCategoriesFrontSidebarList');
        if (empty($response)) {
            $response = Self::getFrontRecords($moduleFields, $aliasFields)
                    ->deleted()
                    ->publish()
                    ...
                    ->where('chrIsPreview', '=', 'N')
                    ->get();
            Cache::tags(['ServiceCategory'])->forever('getAllCategoriesFrontSidebarList', $response);
        }
        return $response;
    }
    /**
