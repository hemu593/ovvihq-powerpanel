                    ...
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('blog-category-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/blog-category/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('blogcategory::template.blogCategoryModule.addBlogCategory') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/blogcategory/blog-category-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
