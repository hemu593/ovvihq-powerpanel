...
class Role extends Model
{
     ...
     * @author  NetQuick
     */
    public static function getRecordList($filterArr = false, $userIsAdmin = false, $ignoreId = array(), $currentUserRoleData = false)
    {
        $response = false;
        $moduleFields = [
            'id',
     ...
     * @author  NetQuick
     */
    public static function getRecordListCount($filterArr = false, $returnCounter = false, $userIsAdmin = false, $ignoreId = array(), $currentUserRoleData)
    {
        $response = false;
        $moduleFields = [
            'id',
