...
class CreatePublicRecordCategoryTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('public_record_category', function (Blueprint $table) {
    ...
    public function down() {
        Schema::drop('public_record_category');
    }
