<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionRegisterofApplicationsModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionRegisterofApplicationsModuleTemplate']) !!}
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="control-label form_title">Limit (Note: All the Licence Register will be shown if Limit not entered)</label>
