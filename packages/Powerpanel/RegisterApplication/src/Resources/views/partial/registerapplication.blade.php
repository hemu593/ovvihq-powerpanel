<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionRegisterofApplicationsModule" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionRegisterofApplicationsModule']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Register of Applications</b></h5>
                    </div>
                                        ...
                                        <table class="responsive new_table_desing table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="20%" align="left">{{ trans('visualcomposer::template.common.email') }}</th>
                                                    <th width="20%" align="left">{{ trans('Status') }}</th>
                                                    <th width="20%" align="center">Updated Date</th>
                                                </tr>
                                            </thead>
                                        </table>
                                        <div class="table-scrollable full-info-table" id="mcscroll" style="height: 200px">
                                            <table class="responsive new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_registerapplication_ajax">
