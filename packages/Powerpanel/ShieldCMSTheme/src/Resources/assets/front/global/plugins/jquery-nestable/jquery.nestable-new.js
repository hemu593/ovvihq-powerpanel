...
(function($, window, document, undefined) {
    ...
    defaults.autoscroll = true; // Lock to specific axis
        ...
        if (scrollParent[0] != document && scrollParent[0].tagName != 'HTML') {
            ...
            if (!o.axis || o.axis != 'x') {
                ...
                if ((overflowOffset.top + scrollParent[0].offsetHeight) - event.pageY < o.scrollSensitivity) {
                    ...
                    if (o.scrollRepeat) dragTimerY = setTimeout(function() {
                        self.dragAutoScroll(event, scrollParent, overflowOffset)
                    }, o.scrollDelay);
            ...
            if (!o.axis || o.axis != 'y') {
                ...
                if ((overflowOffset.left + scrollParent[0].offsetWidth) - event.pageX < o.scrollSensitivity) {
                    ...
                    if (o.scrollRepeat) dragTimerX = setTimeout(function() {
                        self.dragAutoScroll(event, scrollParent, overflowOffset)
                    }, o.scrollDelay);
