...
var TableDatatablesAjax = function() {
		...
		var handleRecords = function() {
				grid = new Datatable(); //clientsearch
				if(!tableState){
				  $.removeCookie('clientsearch');
		      $("#datatable_ajax").DataTable().state.clear();
		      $("#datatable_ajax").DataTable().destroy();
		    }
		    if (tableState) {
		    	  if($.cookie('clientsearch')) {
					      var clientsearch = $.cookie('clientsearch');
	                $('#searchfilter').val(clientsearch);
	                grid.setAjaxParam("searchValue", clientsearch);
