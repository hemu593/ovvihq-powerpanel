...
var TableDatatablesAjax = function() {
		...
		var handleRecords = function() {
			grid = new Datatable(); //ServiceCategorySearch
			if(!tableState){
	    ...
	    if (tableState) {
	    	  if($.cookie('ServiceCategorySearch')) {
				      var ServiceCategorySearch = $.cookie('ServiceCategorySearch');
                $('#searchfilter').val(ServiceCategorySearch);
                grid.setAjaxParam("searchValue", ServiceCategorySearch);
