        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {"data": 8, className: 'text-center Banners_displayorder_P_8', 'name': 'intDisplayOrder'},
                    {"data": 9, 'bSortable': false, className: 'text-center publish_switch Banners_publish_P_9'},
                    {"data": 10, 'bSortable': false, className: 'text-right Banners_dactions_P_10 last_td_action mob-show_div'},
                    {"data": 11, 'bSortable': false}
                ],
                "columnDefs": [{
                        "targets": [11],
                        "visible": false,
                ...
                "columns": [
                   {
                    ...
                    {"data": 6, 'bSortable': false, className: 'text-center Banners_rotatetime_D_7', 'name': 'varRotateTime'},
                    {"data": 7, 'bSortable': false, className: 'text-center publish_switch Banners_publish_D_9'},
                    {"data": 8, 'bSortable': false, className: 'text-right Banners_dactions_D_10 last_td_action mob-show_div'},
                    {"data": 9, 'bSortable': false}
                ],
                "columnDefs": [{
                        "targets": [9],
                        "visible": false,
        ...
        grid3.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {"data": 6, 'bSortable': false, className: 'text-center Banners_rotatetime_T_7', 'name': 'varRotateTime'},
                    {"data": 7, 'bSortable': false, className: 'text-right Banners_dactions_T_10 last_td_action mob-show_div'},
                    {"data": 8, 'bSortable': false}
                ],
                "columnDefs": [{
                        "targets": [8],
        ...
        grid4.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    {"data": 7, 'bSortable': false, className: 'text-center Banners_rotatetime_F_7', 'name': 'varRotateTime'},
                    {"data": 8, 'bSortable': false, className: 'text-right Banners_dactions_F_10 last_td_action mob-show_div'},
                    {"data": 9, 'bSortable': false}
                ],
                "columnDefs": [{
                        "targets": [9],
