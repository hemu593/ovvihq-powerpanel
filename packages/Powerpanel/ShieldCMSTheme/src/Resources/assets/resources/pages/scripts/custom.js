...
$(document).on('click', '#refresh', function(e) {
    $("#rolefilter, #categoriesfilter, #modulefilter, #foritem, #statusfilter,#sectorfilter,#linkFilterType, #pageFilter, #bannerFilter, #bannerFilterType,#category_id,#searchfilter,.category_filter,.list_head_filter").val('').trigger('change');
    $('#searchfilter').keyup();
});
