								...
								<td style="padding:15px; border:1px solid #f5f5f5;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #092038;">
											...
											<tr>
												<td align="right" valign="middle" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; color:#000; font-weight:600; font-size:14px; padding:1%;">No of People:</td>
												<td align="left" valign="middle" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; color:#000; font-weight:400; font-size:14px; padding:1%;"><a href="tel:{{ $number_of_people }}" title="{{ $number_of_people }}" class="link">{{ $number_of_people }}</a></td>
											</tr>
											@endif
											@if(isset($user_message) && !empty($user_message))
											<tr>
												<td align="right" valign="middle" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; color:#000; font-weight:600; font-size:14px; padding:1%;">Message:</td>
												<td align="left" valign="middle" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; color:#000; font-weight:400; font-size:14px; padding:1%;"><a href="tel:{{ $user_message }}" title="{{ $user_message }}" class="link">{{ $user_message }}</a></td>
											</tr>
											@endif
											
											@if(isset($reservation_date) && !empty($reservation_date))
											<tr>
												<td align="right" valign="middle" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; color:#000; font-weight:600; font-size:14px; padding:1%;">Reservation Date:</td>
												<td align="left" valign="middle" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; color:#000; font-weight:400; font-size:14px; padding:1%;">{{ $reservation_date }}</td>
											</tr>
											@endif
											@if(isset($user_message) && !empty($user_message))
											<tr>
					...
					<tr>
						<td align="center" valign="middle">
							...
							<a href="{{$SOCIAL_FB_LINK}}" target="_blank" title="Facebook" style="text-decoration:none">
								<img src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/fb.png' }}" alt="Facebook"  width="35" height="35" />
							</a>
							@endif
							...
							<a href="{{$SOCIAL_TWITTER_LINK}}" target="_blank" title="Twitter" style="text-decoration:none">
								<img src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/tw.png' }}" alt="Twitter" width="35" height="35" />
							</a>
							@endif
							...
							<a href="{{$SOCIAL_LINKEDIN_LINK}}" target="_blank" title="Linkedin" style="text-decoration:none">
								<img src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/in.png' }}" alt="Linkedin" width="35" height="35" />
							</a>
							@endif
							...
							<a href="{{$Google_Plus_Link}}" target="_blank" title="Google Plus" style="text-decoration:none">
								<img src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/gplus.png' }}" alt="GooglePlus" width="35" height="35" />
							</a>
							@endif
						</td>
					</tr>
