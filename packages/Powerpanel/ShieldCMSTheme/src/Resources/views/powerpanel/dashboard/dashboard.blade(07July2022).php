            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="dashboard-img mb-4">
                        ...
                        <div class="content">
                            <div class="smtitle">Good Morning</div>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
						...
						<div class="card-body">
                            <div id="users-by-country" data-colors='["--vz-light"]' style="height: 153px"></div>
                        </div><!-- end card body -->
                    </div><!-- end card -->
                                            ...
                                            @foreach ($leads as $key=>$lead)
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" class='numeric'>
                                                        <a class="contactUsLead" href="javascript:void(0);" type="button" title="{{ trans('template.powerPanelDashboard.clickDetails') }}" id="{!! $lead->id !!}"><i class="ri-arrow-right-up-line fs-16 body-color"></i></a>
                                                    </td>
                                                </tr>
                                                @endif
                                            @endforeach
                        ...
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="dash-approve-search pull-right">
                                    ...
                                    <div class="cm-search">
                                        <input type="search" class="form-control form-control-solid placeholder-no-fix" placeholder="Search" id="searchfilter">
                                        <span class="open-search cursor-pointer"><i class="ri-search-2-line fs-20"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card header -->
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            @foreach ($approvals as $key=>$approval)
                                                ...
                                                <tr>
                                                    <td><span class="fw-medium link-primary"><a class="body-color" href="{{ url('powerpanel/'.$approval->module->varModuleName) }}?tab=A" title="{!! $approval->module->varTitle !!}">#{!! $approval->id !!}</a></span></td>
                                                    <td><a class="body-color" href="{{ url('powerpanel/'.$approval->module->varModuleName.'?tab=A') }}" title="{!! $approval->module->varTitle !!}">{!! $approval->module->varTitle !!}</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('powerpanel/workflow') }}" title="Create workflow for {!! $approval->module->varTitle !!}">{!! $approval->module->varTitle !!} <span class="badge badge-pill badge-danger">No Workflow</span></a></td>
