@section('css')
<link href="{{ $CDN_PATH.'resources/global/plugins/select2/css/select2.min.$CDN_PATH. }}" rel="stylesheet" type="text/css"/>
<link href="{{ $CDN_PATH.'resources/global/plugins/select2/css/select2-bootstrap.min.$CDN_PATH. }}" rel="stylesheet" type="text/css"/>
@endsection
...
<div class="col-md-12 settings">
	{!! Form::open(['method' => 'post','id'=>'frmUsers']) !!}
					...
					<div class="tab-content settings">
						<div class="form-body">
							...
							<div class="form-group {{ $errors->has('password') ? ' has-error' : '' }} form-md-line-input">
								...
								<label class="form_title" for="password">{{  trans('shiledcmstheme::template.common.password') }} <span aria-required="true" class="required"> * </span></label>
								<span style="color: red;">
							...
							<div class="form-group {{ $errors->has('roles') ? ' has-error' : '' }}">
								...
								{!! Form::select('roles[]', $roles,[], array('class' => 'form-control bs-select select2','multiple')) !!}
								<span style="color: red;">
									{{ $errors->first('roles') }}
								</span>
							</div>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-md-12">
										...
										<a class="btn btn-outline red" href="{{url('powerpanel/users')}}">{{  trans('shiledcmstheme::template.common.cancel') }}</a>
									</div>
								</div>
							</div>
						</div>
...
@endsection
@section('scripts')
<script type="text/javascript">var userAction='add';</script>
