<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionCompaniesModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionCompaniesModuleTemplate']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Companies</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="companiescat" class="form-control bootstrap-select bs-select cat-class" id="cat-template-layout">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            {!! Form::text('companies_start_date_time', old('companies_start_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'companies_start_date_time','autocomplete'=>'off')) !!}
                        </div>
                        <div class="form-group">
                            <label class="control-label form_title">End Date</label>
                            {!! Form::text('companies_end_date_time', old('companies_end_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'companies_end_date_time','autocomplete'=>'off')) !!}
                        </div>
                         <div class="form-group">
                            <label class="control-label form_title">Limit (Note: All the companies will be shown if Limit not entered)</label>
