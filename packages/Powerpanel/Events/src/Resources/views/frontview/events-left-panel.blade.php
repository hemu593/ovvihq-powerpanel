        ...
        <div class="row n-mr-xl-15" data-aos="fade-up">
            <div class="col-12 lpgap">
                <article>
                    ...
                    <div class="form-group ac-form-group n-mb-0">
                        <select class="selectpicker ac-input" data-width="100%" title="Sort by Name" id="sortFilter" data-size="5" data-live-search="true">
            ...
            <div class="col-12 lpgap">
                <article>
                    ...
                    <div class="form-group ac-form-group n-mb-0">
                        <select class="selectpicker ac-input" data-width="100%" title="Sort by Category" id="eventCategory" data-size="5" data-live-search="true">
