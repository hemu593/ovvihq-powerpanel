    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                            ...
                            <div class="btn-group d-inline-block filter-dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <div class="p-3 dropdown-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group input-daterange" id="eventLeadRange">
                                                <span class="input-group-text"><i class="ri-calendar-line fs-13"></i></span>
                                                <input type="text" class="form-control" id="start_date" name="start_date" placeholder="{{ trans('events::template.common.fromdate') }}"  data-provider="flatpickr" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group input-daterange" id="eventLeadRange">
                                                <span class="input-group-text"><i class="ri-calendar-line fs-13"></i></span>
                                                <input type="text" class="form-control" id="end_date" name="end_date" placeholder="{{ trans('events::template.common.todate') }}"  data-provider="flatpickr" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                                            </div>
                                        </div>
                        ...
                        <div class="table-responsive">
                            @php
                                $tablearray = [
                                    'DataTableTab'=>[
                                        'ColumnSetting'=>[
                                            ['Identity_Name'=>'eventName','TabIndex'=>'1','Name'=>'Event Name'],
                                            ['Identity_Name'=>'AttendeeName','TabIndex'=>'2','Name'=>'Attendees Name'],
                                            ['Identity_Name'=>'email','TabIndex'=>'3','Name'=>'Attendees Email'],
                                            ['Identity_Name'=>'sdate','TabIndex'=>'4','Name'=>'Start Date'],
                                            ['Identity_Name'=>'edate','TabIndex'=>'5','Name'=>'End Date'],
                                            ['Identity_Name'=>'noOfAttendee','TabIndex'=>'6','Name'=>'No of Attendees'],
                                            ['Identity_Name'=>'detail','TabIndex'=>'7','Name'=>'Attendee(s) Details'],
                                            ['Identity_Name'=>'message','TabIndex'=>'8','Name'=>'Message'],
                                            ['Identity_Name'=>'date','TabIndex'=>'9','Name'=>'Received Date'],
                                        ],
                                        'DataTableHead'=>[
                                            ['Title'=>'Event Name','Align'=>'left'],
                                            ['Title'=>'Attendees Name','Align'=>'left'],
                                            ['Title'=>'Attendees Email','Align'=>'left'],
                                            ['Title'=>'Start Date','Align'=>'left'],
                                            ['Title'=>'End Date','Align'=>'left'],
                                            ['Title'=>'No of Attendees','Align'=>'left'],
                                            ['Title'=>'Attendee(s) Details','Align'=>'left'],
                            ...
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'eventslead','Permission_Delete'=>'events-lead-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'eventsLead'])
                @endif
                @else
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ trans('events::template.common.alert') }}</h5>
                    <button type="button" class="btn-close fs-10" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <div class="modal-body">
                    <h5 class="mb-2">{{ trans('events::template.eventsleadModule.noExport') }}</h5>
                    <div class="pt-2">
                        <button type="button" class="btn btn-primary bg-gradient waves-effect waves-light btn-label" data-bs-dismiss="modal">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    {{ trans('events::template.common.ok') }}
                                </div>
                            </div>
                        </button>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <h5 class="mb-2">{{ trans('events::template.eventsleadModule.recordsExport') }}</h5>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" value="selected_records" id="selected_records" name="export_type">
                                <label for="selected_records">{{ trans('events::template.eventsleadModule.selectedRecords') }}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" value="all_records" id="all_records" name="export_type" checked>
                                <label for="all_records">{{ trans('events::template.eventsleadModule.allRecords') }}</label>
                            </div>
                        </div>
    ...
    <div class="new_modal modal fade" id="noSelectedRecords" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="mb-2">{{ trans('events::template.eventsleadModule.leastRecord') }}</h5>
                    <div class="pt-2">
                        <button type="button" class="btn btn-primary bg-gradient waves-effect waves-light btn-label" data-bs-dismiss="modal">
                            <div class="d-flex">
                                <div class="flex-shrink-0">
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/events-lead/DeleteRecord") !!}';
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/eventslead/eventslead-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
