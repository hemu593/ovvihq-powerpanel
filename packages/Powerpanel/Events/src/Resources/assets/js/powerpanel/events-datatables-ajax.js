...
var TableDatatablesAjax = function() {
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 2,
                    className: 'text-left Events_title_P_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 3,
                    className: 'text-center Events_cat_P_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 4,
                    className: 'text-center Events_image_P_4',
                    "bSortable": false
                }, {
                    "data": 5,
                    "name": 'dtDateTime',
                    className: 'text-center Events_sdate_P_5'
                }, {
                    "data": 6,
                    "name": 'dtEndDateTime',
                    className: 'text-center Events_edate_P_6'
                }, {
                    "data": 7,
                    className: 'text-center Events_hits_P_7',
                    "bSortable": false
                }, {
                    "data": 8,
                    className: 'text-center publish_switch Events_publish_P_8',
                    "bSortable": false
                }, {
                    "data": 9,
                    className: 'text-right last_td_action Events_dactions_P_9 mob-show_div',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/events/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function(e) {
            ...
            if (action.length >= 2) {
                $.cookie('Eventssearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else {
                $.removeCookie('Eventssearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    "name": 'varTitle',
                    className: 'text-left Events_title_A_2 mob-show_div',
                    "bSortable": true
                }, {
                    "data": 2,
                    className: 'text-center Events_cat_A_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 3,
                    className: 'text-center Events_image_A_4',
                    "bSortable": false
                }, {
                    "data": 4,
                    className: 'text-center Events_sdate_A_5',
                    "name": 'dtDateTime',
                }, {
                    "data": 5,
                    "name": 'dtEndDateTime Events_edate_A_6',
                    className: 'text-center'
                }, {
                    "data": 6,
                    className: 'text-center Events_hits_A_7'
                }, {
                    "data": 7,
                    className: 'text-right last_td_action Events_dactions_A_9 mob-show_div',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/events/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    className: 'text-left Events_title_D_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 2,
                    className: 'text-center Events_cat_D_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 3,
                    className: 'text-center Events_image_D_4',
                    "bSortable": false
                }, {
                    "data": 4,
                    "name": 'dtDateTime',
                    className: 'text-center Events_sdate_D_5'
                }, {
                    "data": 5,
                    "name": 'dtEndDateTime',
                    className: 'text-center Events_edate_D_6'
                }, {
                    "data": 6,
                    className: 'text-center Events_hits_D_7',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-center publish_switch Events_publish_D_8',
                    "bSortable": false
                }, {
                    "data": 8,
                    className: 'text-right last_td_action Events_dactions_D_9 mob-show_div',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/events/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
...
var TableDatatablesAjax3 = function() {
    var handleRecords3 = function() {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    className: 'text-left Events_title_T_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 2,
                    className: 'text-center Events_cat_T_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 3,
                    className: 'text-center Events_image_T_4',
                    "bSortable": false
                }, {
                    "data": 4,
                    "name": 'dtDateTime',
                    className: 'text-center Events_sdate_T_5'
                }, {
                    "data": 5,
                    "name": 'dtEndDateTime',
                    className: 'text-center Events_edate_T_6'
                }, {
                    "data": 6,
                    className: 'text-center Events_hits_T_7',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-right last_td_action Events_dactions_T_9 mob-show_div',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/events/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
        ...
        $(document).on('change', '#category', function(e) {
            ...
            if (action != "") {
                grid33.setAjaxParam("customActionType", "group_action");
                grid3.setAjaxParam("catValue", action);
                grid3.setAjaxParam("id", grid3.getSelectedRows());
                grid3.getDataTable().ajax.reload();
            } else {
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 2,
                    className: 'text-left Events_title_F_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 3,
                    className: 'text-center Events_cat_F_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 4,
                    className: 'text-center Events_image_F_4',
                    "bSortable": false
                }, {
                    "data": 5,
                    "name": 'dtDateTime',
                    className: 'text-center Events_sdate_F_5'
                }, {
                    "data": 6,
                    "name": 'dtEndDateTime',
                    className: 'text-center Events_edate_F_6'
                }, {
                    "data": 7,
                    className: 'text-center Events_hits_F_7',
                    "bSortable": false
                }, {
                    "data": 8,
                    className: 'text-right last_td_action Events_dactions_F_9 mob-show_div',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/events/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
...
$(window).on('load', function() {
    ...
    if ($.cookie('Eventssearch')) {
        $('#searchfilter').val($.cookie('Eventssearch'));
        $('#searchfilter').trigger('keyup');
    }
  }
