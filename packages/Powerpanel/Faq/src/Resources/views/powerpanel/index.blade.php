                ...
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('faq-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/faq/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('faq::template.faqModule.addFaq') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                            ...
                            <div class="btn-group d-inline-block filter-dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <div class="p-3 dropdown-body">
                                        ...
                                        @if($userIsAdmin)
                                            <div class="mb-3">
                                                <select class="form-select categoryFilter" id="sectorfilter">
                            ...
                            $tablearray = [
                                'DataTableTab'=>[
                                    'ColumnSetting'=>[
                                        ...
                                        ['Identity_Name'=>'cat','TabIndex'=>'2','Name'=>'Category'],
...
@section('scripts')
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/faq/faq-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
