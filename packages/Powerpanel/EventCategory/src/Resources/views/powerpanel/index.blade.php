    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                    ...
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('event-category-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/event-category/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('eventcategory::template.eventCategoryModule.addEventCategory') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('eventcategory::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('eventcategory::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('eventcategory::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>
                                        @if($userIsAdmin)
                                            <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'EventCategory','Permission_Delete'=>'event-category-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'event-category'])
                @endif
                @else
...
@section('scripts')
    <script type="text/javascript">
        ...
        var APPROVE_URL = '{!! url("/powerpanel/event-category/ApprovedData_Listing") !!}';
        var getChildData = window.site_url + "/powerpanel/event-category/getChildData";
        var getChildData_rollback = window.site_url + "/powerpanel/event-category/getChildData_rollback";
        var rollbackRoute = window.site_url + "/powerpanel/event-category/rollback-record";
        var ApprovedData_Listing = window.site_url + "/powerpanel/event-category/ApprovedData_Listing";
        var Get_Comments = window.site_url + "/powerpanel/event-category/Get_Comments";
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/eventcategory/event-category-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
