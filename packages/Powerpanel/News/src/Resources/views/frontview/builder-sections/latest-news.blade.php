@if(isset($data['latestNews']) && !empty($data['latestNews']))
    ...
    <section class="n-pt-30 n-pt-lg-60 n-pb-30 n-pb-lg-100 home-notification {{ $class }}" data-aos="fade-up">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 d-md-flex align-self-center">
					...
					<div class="read-more n-mt-10 n-mv-md-0 d-none d-md-block">
						<a href="{{ $recordLinkUrl }}" title="Read More">Read More <i class="fa fa-angle-right d-md-none d-sm-block n-ml-5"></i></a>
					</div>
					<div class="view-all-n n-mt-10 n-mv-md-0 d-none d-md-block">
						<a href="{{ $moduelFrontPageUrl }}" title="All News">All News <i class="fa fa-angle-right d-md-none d-sm-block n-ml-5"></i></a>
					</div>
					<div class="d-block d-md-none n-mt-10 text-center">
						<a class="ac-btn-primary ac-small" href="{{ $recordLinkUrl }}" title="Read More">Read More </a>
						<a class="ac-btn-primary ac-small" href="{{ $moduelFrontPageUrl }}" title="All News">All News</a>
					</div>
				</div>
			</div>
		</div>
