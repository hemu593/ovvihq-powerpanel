...
<div class="ac-modal modal fade bd-example-modal-lg" id="sectionLinksModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">  <!-- composer-element-popup ckeditor-popup ckbusiness-popup -->
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            {!! Form::open(['method' => 'post','id'=>'frmSectionLinksModuleTemplate']) !!}
            ...
            <div class="modal-body">
                ...
                <div class="cm-floating hide" >
                    ...
                    {!! Form::text('link_start_date_time', old('link_start_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'link_start_date_time','autocomplete'=>'off')) !!}
                </div>
                <div class="cm-floating hide">
                    <label class="control-label form_title">End Date</label>
                    {!! Form::text('link_end_date_time', old('link_end_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'link_end_date_time','autocomplete'=>'off')) !!}
                </div>
