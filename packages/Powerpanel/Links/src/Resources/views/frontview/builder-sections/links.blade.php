        ...
        <div class="row">
            <div class="col-12">
                <div class="owl-carousel owl-theme">
                    ...
                    <?php // echo '<pre>';print_r($linksobj);?>
                    @if(isset($linksobj['items']) && count($linksobj['items'])>0 )
                    <div class="item">
                        <article class="-items w-100 n-bs-1 n-mv-30 n-bgc-white-500">
                            <div class="-img">
                                <div class="thumbnail-container">
                                    <div class="thumbnail">
                                        <img src="{!! App\Helpers\resize_image::thumbImage($linksobj->image,110,110) !!}" alt="{{$linksobj->varTitle}}" title="{{$linksobj->varTitle}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="-stitle">
                                <div class="nqtitle n-fw-800 text-uppercase">
                                    @php $sectorName=strtolower($linksobj->varTitle)  @endphp
                                    <a href="{{url($sectorName)}}" alt="$sectorName" >{{$linksobj->varTitle}}</a>
                                </div>
                ...
                <div class="col-md-9 col-md-12 col-xs-12 animated fadeInUp">
                    <div class="right_content">
                        ...
                        <ul>
                            ...
                            @foreach($linkcategory->items as $childlink)
                            @php $link =''; @endphp
                                @if(isset($childlink->varLinkType) &&  $childlink->varLinkType == 'external')
