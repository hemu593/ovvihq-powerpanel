<div class="ac-modal modal fade bd-example-modal-lg" id="sectionPhotoAlbumModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"> <!-- composer-element-popup ckeditor-popup ckbusiness-popup -->    
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="cm-floating">
                    ...
                    <select name="layoutType" class="form-select" id="photoalbum-template-layout"> <!-- form-control bootstrap-select bs-select layout-class -->
