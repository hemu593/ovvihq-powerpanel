    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('photo-album-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/photo-album/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('photoalbum::template.photoAlbumModule.addPhotoAlbum') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('photoalbum::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('photoalbum::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('photoalbum::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>

                                        <div class="mb-3">
                                            <div class="input-group input-daterange" id="photoAlbumRange">
                                                <span class="input-group-text"><i class="ri-calendar-line fs-13"></i></span>
                                                <input type="text" class="form-control" id="start_date" name="start_date" placeholder="{{ trans('photoalbum::template.common.startdate') }}"  data-provider="flatpickr" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="input-group input-daterange" id="photoAlbumRange">
                                                <span class="input-group-text"><i class="ri-calendar-line fs-13"></i></span>
                                                <input type="text" class="form-control" id="end_date" name="end_date" placeholder="{{ trans('photoalbum::template.common.enddate') }}"  data-provider="flatpickr" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                                            </div>
                                        </div>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                                ...
                                $tablearray = [
                                    'DataTableTab'=>[
                                        'ColumnSetting'=>[
                                            ...
                                            ['Identity_Name'=>'photo','TabIndex'=>'5','Name'=>'Photos'],
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'PhotoAlbum','Permission_Delete'=>'photo-album-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'photoAlbum'])
                @endif
                @else
...
<script type="text/javascript">
    ...
    var APPROVE_URL = '{!! url("/powerpanel/photo-album/ApprovedData_Listing") !!}';
    var getChildData = window.site_url + "/powerpanel/photo-album/getChildData";
    var getChildData_rollback = window.site_url + "/powerpanel/photo-album/getChildData_rollback";
    var ApprovedData_Listing = window.site_url + "/powerpanel/photo-album/ApprovedData_Listing";
    var rollbackRoute = window.site_url + "/powerpanel/photo-album/rollback-record";
    var Get_Comments = window.site_url + "/powerpanel/photo-album/Get_Comments";
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/photoalbum/photo-album-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
