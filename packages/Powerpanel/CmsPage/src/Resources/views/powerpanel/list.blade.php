            ...
            <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                <div class="d-xl-flex flex-wrap align-items-center">
                    <div class="flex-shrink-0 addpage-btn order-sm-2">
                        ...
                        <div class="public-status d-inline-block me-3">
                            <ul class="m-0 p-0">
                        ...
                        @can('pages-create')
                            <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/pages/add') }}">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        {{ trans('cmspage::template.pageModule.add') }}
                                    </div>
                                </div>
                            </a>
                        @endcan
...
<script src="{{ $CDN_PATH.'resources/global/scripts/datatable.js?v='.time() }}" type="text/javascript"></script>
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/cmspage/table-cms-pages-ajax.js?v='.time() }}" type="text/javascript"></script>
