@php 
    $showYearFilterPagesArr = [];
    $showMonthFilterPagesArr = [];
    $showCategoryFilterPagesArr = [];
                ...
                <div class="col-12 lpgap">
                    <article>
                        ...
                        <div class="form-group ac-form-group n-mb-0">
                            <select class="selectpicker ac-input" data-width="100%" title="Sort by Month" data-size="5" data-live-search="true">
            ...
            @if(in_array($segment,$showMonthFilterPagesArr))     
                <div class="col-12 lpgap">
                    <article>
                        ...
                        <div class="form-group ac-form-group n-mb-0">
                            <select class="selectpicker ac-input" data-width="100%" title="Sort by Month" id="monthFilter" data-size="5" data-live-search="true">
