                ...
                <div class="col-xl-9 n-mt-25 n-mt-xl-0" data-aos="fade-up">
                    <div class="col-12" data-aos="zoom-in">
                        <ul class="nqul ac-collapse accordion" id="applicationforms">
                            <li class="-li">
                                <a class="-tabs" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Telephony Appication Form <span></span></a>
                                <div id="collapseOne" class="-info collapse show" data-parent="#applicationforms">
                                    <div class="cms">
                                        <p>For ICT Networks and Services that primarily concern telephony, i.e those that include one or more of the following:</p>
                                        <ul>
                                            <li>Fixed Wireline Network</li>
                                            <li>Fixed Wireless Network</li>
                                            <li>Any form of Cellular Network</li>
                                            <li>Fixed Telephony</li>
                                            <li>Mobile Telephony</li>
                                            <li>Resale of Telephony</li>
                                            <li>Internet Telephony</li>
                                        </ul>
                                        <p>that form is ICT Form 1. It is available below in both Acrobat and MS Word format.</p>
                                    </div>
                                    <div class="row">
                            ...
                            <li class="-li">
                                ...
                                <div id="collapseTwo" class="-info collapse" data-parent="#applicationforms">
                                    <div class="cms">
                                        ...
                                        <p>that form is ICT Form 3. It is available below in Acrobat.</p>
                                    </div>
                                    <div class="row">
                                        @php for ($x = 1; $x <= 2; $x++) { @endphp
                                            <div class="col-sm-6 n-gapp-1" data-aos="fade-up">
                            ...
                            <li class="-li">
                                <a class="-tabs collapsed" data-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Operating Permit Application Forms <span></span></a>
                                <div id="collapseFour" class="-info collapse" data-parent="#applicationforms">
                                    <div class="cms">
                                        <p>OfReg Fuels, formerly the Petroluem Inspectorate, is now accepting applciations for Operating Permits for both Premises and Vechicles used to store or transport dangerous substances.</p>
                                        <p>Under the Dangerous Substances Handling & Storage Law, 2003 and subsequent amendement laws and regulations, application forms are due by June 15th 2017 for existing storage locations and transport vehicles.</p>
                                        <p>Dangerous Substances include all major petroluem products and fuel types such as gasoline, diesel & propane as well as certain pressurized cylinders.</p>
                                        <h2>Applications forms can be found below in our publications section</h2>
                                    </div>
                                    <div class="row">
                                        @php for ($x = 1; $x <= 2; $x++) { @endphp
                                            <div class="col-sm-6 n-gapp-1" data-aos="fade-up">
                            ...
                            <li class="-li">
                                <a class="-tabs collapsed" data-toggle="collapse" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Application Fees <span></span></a>
                            ...
                            <li class="-li">
                                <a class="-tabs collapsed" data-toggle="collapse" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">Licence Fees <span></span></a>
                                <div id="collapseSix" class="-info collapse" data-parent="#applicationforms">                                    
                                    <div class="cms">
                                        <h2>Introduction</h2>
