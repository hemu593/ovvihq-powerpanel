<?php
namespace Powerpanel\FormsAndFees\Controllers;
...
class FormsAndFeesController extends FrontController
{
    ...
    {
        parent::__construct();
        Config::set('Constant.MODULE.MODEL_ALIAS', 'Powerpanel\FormsAndFees\Models\\');
    }
    ...
    public function index()
    {
        ...
        return view('forms-and-fees::frontview.forms-and-fees', $data);
    }
            ...
            if (isset($pageContentcms) && $pageContentcms->chrPageActive == 'PR') {
                ...
                if (isset($pageContent->txtDescription) && !empty($pageContent->txtDescription)) {
                    ...
                    foreach ($txtDesc as $key => $value) {
                        if ($value->type == 'formsandfees_template') {
