                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        @can('consultations-create')
                            ...
                            <a class="btn btn-light bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/consultations/add') }}">
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        {{ trans('consultations::template.consultationsModule.addConsultations') }}
                                    </div>
                                </div>
                            </a>
                            @endif
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-2 col-sm-4" id="hidefilter">
                        <select class="form-control" id="statusfilter" data-choices data-choices-search-false>
                            <option value="">{!! trans('consultations::template.common.selectstatus') !!}</option>
                            <option value="Y">{!! trans('consultations::template.common.publish') !!}</option>
                            <option value="N">{!! trans('consultations::template.common.unpublish') !!}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="input-group input-daterange">
                            ...
                            <input type="text" class="form-control" id="start_date" name="start_date" placeholder="{{ trans('consultations::template.common.startdate') }}" readonly data-provider="flatpickr" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                            <input type="text" class="form-control" id="end_date" name="end_date" placeholder="{{ trans('consultations::template.common.enddate') }}" readonly data-provider="flatpickr" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                            <button class="btn btn-outline-primary border-outline-light btn-rh-search" id="consultationsRange" type="button"><i class="ri-search-line fs-13"></i></button>
                        </div>
                    </div>
            ...
            @elseif($iTotalRecords > 0)
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        @endphp
                        @include('powerpanel.partials.datatable-view',['ModuleName'=>'Consultations','Permission_Delete'=>'consultations-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                    </div>
                </div><!-- end card-body -->
                <!-- Modal -->
                @if (File::exists(base_path() . '/resources/views/powerpanel/partials/quickeditpopup.blade.php') != null)
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'consultations'])
                @endif
                @else
                @if (File::exists(base_path() . '/resources/views/powerpanel/partials/addrecordsection.blade.php') != null)
                @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/consultations/add')])
                @endif
            @endif
        </div><!-- end card -->
    </div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/consultations/DeleteRecord") !!}';
    var rollbackRoute = window.site_url + "/powerpanel/consultations/rollback-record";
    var APPROVE_URL = '{!! url("/powerpanel/consultations/ApprovedData_Listing") !!}';
    var getChildData = window.site_url + "/powerpanel/consultations/getChildData";
    var getChildData_rollback = window.site_url + "/powerpanel/consultations/getChildData_rollback";
    var ApprovedData_Listing = window.site_url + "/powerpanel/consultations/ApprovedData_Listing";
    var Get_Comments = window.site_url + "/powerpanel/consultations/Get_Comments";
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/consultations/consultation-datatables-ajax.js' }}" type="text/javascript"></script>
