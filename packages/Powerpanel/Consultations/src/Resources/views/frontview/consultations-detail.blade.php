    ...
    <div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-6 -border">
                                    <ul class="nqul justify-content-between -tag d-flex align-items-center">
                                        ...
                                        @if(strtolower($consultation->varSector) == 'ofreg')
                                        @php
                                        $colourclass = 'ofreg-tag';
                                        @endphp
                                        @elseif(strtolower($consultation->varSector) == 'ict')
                                        @php $colourclass = 'ict-tag'; @endphp
                                        @elseif(strtolower($consultation->varSector) == 'water')
                                        @php $colourclass = 'water-tag'; @endphp
                                        @elseif(strtolower($consultation->varSector) == 'fuel')
                                        @php $colourclass = 'fuel-tag'; @endphp
                                        @elseif(strtolower($consultation->varSector) == 'energy')
            ...
            <div class="col-xl-9" data-aos="fade-up">
                ...
                @endif
                @if(isset($consultations->fkIntDocId) && !empty($consultations->fkIntDocId))
                @php
