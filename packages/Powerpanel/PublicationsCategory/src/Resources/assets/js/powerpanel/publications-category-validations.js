...
var Validate = function() {
    var handleServiceCategory = function() {
        $("#frmPublicationsCategory").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmPublicationsCategory')).show();
            },
        ...
        $('#frmPublicationsCategory input').keypress(function(e) {
            if (e.which == 13 && e.keyCode != 188) {
                if ($('#frmPublicationsCategory').validate().form()) {
                    $('#frmPublicationsCategory').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
