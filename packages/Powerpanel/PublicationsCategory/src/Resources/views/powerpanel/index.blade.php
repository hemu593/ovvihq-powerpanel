    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                ...
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('publications-category-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/publications-category/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('publications-category::template.publications_categoryModule.addPublicationsCategory') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('publications-category::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('publications-category::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('publications-category::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <select class="form-select" id="categoriesfilter">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                                ...
                                $tablearray = [
                                    'DataTableTab'=>[
                                        'ColumnSetting'=>[
                                            ...
                                            ['Identity_Name'=>'cat','TabIndex'=>'2','Name'=>'Parent Category'],
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'PublicationsCategory','Permission_Delete'=>'publications-category-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/publications-category/add')])
                @endif
            @endif
...
@section('scripts')
    <script type="text/javascript">
        window.site_url = '{!! url("/") !!}';
        var DELETE_URL = '{!! url("/powerpanel/publications-category/DeleteRecord") !!}';
        var orgnizationsData = jQuery.parseJSON('{!!$orgdata!!}');
        var APPROVE_URL = '{!! url("/powerpanel/publications-category/ApprovedData_Listing") !!}';
        var getChildData = window.site_url + "/powerpanel/publications-category/getChildData";
        var rollbackRoute = window.site_url + "/powerpanel/publications-category/rollback-record";
        var getChildData_rollback = window.site_url + "/powerpanel/publications-category/getChildData_rollback";
        var ApprovedData_Listing = window.site_url + "/powerpanel/publications-category/ApprovedData_Listing";
        var Get_Comments = window.site_url + "/powerpanel/publications-category/Get_Comments";
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/publicationscategory/publications-category-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
    ...
    @if(Auth::user()->hasRole('user_account'))
        <script type="text/javascript">
            ...
            var moduleName = 'PublicationsCategory';
        </script>
    @endif
@endsection