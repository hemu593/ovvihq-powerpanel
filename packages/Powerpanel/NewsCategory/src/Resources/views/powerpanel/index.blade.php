                    ...
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('news-category-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/news-category/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('news-category::template.news_categoryModule.addNewsCategory') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('news-category::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('news-category::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('news-category::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'newsCategory','Permission_Delete'=>'news-category-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
...
@section('scripts')
    <script type="text/javascript">
        ...
        var APPROVE_URL = '{!! url("/powerpanel/news-category/ApprovedData_Listing") !!}';
        var getChildData = window.site_url + "/powerpanel/news-category/getChildData";
        var getChildData_rollback = window.site_url + "/powerpanel/news-category/getChildData_rollback";
        var ApprovedData_Listing = window.site_url + "/powerpanel/news-category/ApprovedData_Listing";
        var rollbackRoute = window.site_url + "/powerpanel/news-category/rollback-record";
        var Get_Comments = window.site_url + "/powerpanel/news-category/Get_Comments";
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/newscategory/news-category-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
