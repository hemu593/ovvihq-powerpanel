<div class="ac-modal modal fade bd-example-modal-lg" id="sectionVideoAlbumModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"> <!-- composer-element-popup ckeditor-popup ckbusiness-popup -->
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header mb-2">
                <h5 class="modal-title" id="exampleModalLabel">Video Gallery</h5>
            ...
            <div class="modal-body">
                ...
                <div class="cm-floating">
                    ...
                    <select name="layoutType" class="form-select" id="videoalbum-template-layout"> <!-- form-control bootstrap-select bs-select layout-class -->
                ...
                <div class="cm-floating">
                 ...
                 <div class="cm-floating">
                    <label class="control-label form_title">Limit 
                        <span class="img-note" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Note: All the blogs will be shown if Limit not entered">
