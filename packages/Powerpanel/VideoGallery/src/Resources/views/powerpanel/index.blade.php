                    ...
                    <div class="d-xl-flex flex-wrap align-items-center">
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('video-gallery-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/video-gallery/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('videogallery::template.videoGalleryModule.addVideoGallery') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                ...
                                                <option value="N">{!! trans('videogallery::template.common.unpublish') !!}</option>z
                                            </select>
                                        </div>
                            ...
                            $tablearray = [
                                'DataTableTab'=>[
                                    'ColumnSetting'=>[
                                        ...
                                        ['Identity_Name'=>'link','TabIndex'=>'2','Name'=>'Link'],
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/videogallery/video-gallery-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    var moduleName = 'VideoGallery';</script>
@endif
