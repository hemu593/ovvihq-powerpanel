        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [
                    ...
                    { "data": 8, className: 'text-center', "name": 'companyresponse', "bSortable": false },
                    { "data": 9, className: 'text-center', "name": 'attachments', "bSortable": false },
                    { "data": 10, className: 'text-center', "name": 'created_at' },
                ],
                "ajax": {
