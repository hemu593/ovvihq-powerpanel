        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 2,
                    className: 'text-left mob-show_div Number_Allocation_NXX_P_2',
                    "name": 'nxx',
                    "bSortable": true
                }, {
                    "data": 3,
                    className: 'text-center Number_Allocation_cat_P_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 4,
                    className: 'text-center Number_Allocation_service_P_4',
                    "bSortable": false
                }, {
                    "data": 5,
                    "name": 'intDisplayOrder',
                    className: 'text-center Number_Allocation_order_P_5'
                }, {
                    "data": 6,
                    className: 'text-center publish_switch Number_Allocation_publish_P_6',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-right last_td_action mob-show_div Number_Allocation_dactions_P_7',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/number-allocation/get_list", // ajax source
                },
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    "bSortable": true,
                    className: 'text-left Number_Allocation_NXX_P_2 mob-show_div',
                    "name": 'nxx'
                }, {
                    "data": 2,
                    "bSortable": true,
                    ...
                    "data": 5,
                    className: 'text-right Number_Allocation_dactions_P_7 last_td_action mob-show_div ',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/number-allocation/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
    ...
    var handleRecords2 = function() {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/number-allocation/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
    ...
    var handleRecords3 = function() {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/number-allocation/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
    ...
    var handleRecords4 = function() {
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/number-allocation/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
...
$('a[data-toggle="tab"][id="MenuItem2"]').on('shown.bs.tab', function(e) {
    ...
    if (!$.fn.DataTable.isDataTable('#datatable_ajax_approved')) {
        ...
        grid1.getDataTable().column(0).visible(true);
    }
});
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/number-allocation/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
