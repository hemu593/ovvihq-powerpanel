...
namespace Powerpanel\NumberAllocation\Controllers;
...
class NumberAllocationController extends FrontController
{
    ...
    public function index()
    {
        ...
        $companyCategory = CompanyCategory::getCatWithParent();
        ...
        return view('number-allocation::frontview.number-allocation', $data);
            ...
            if (isset($pageContentcms) && $pageContentcms->chrPageActive == 'PR') {
                ...
                if (isset($pageContent->txtDescription) && !empty($pageContent->txtDescription)) {
                    ...
                    foreach ($txtDesc as $key => $value) {
                        if ($value->type == 'numberAllocations_template') {
