...
<div class="ac-modal modal fade bd-example-modal-lg" id="sectionAlertsModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"> <!-- composer-element-popup ckeditor-popup ckbusiness-popup -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="cm-floating">
                    ...
                    <select name="alertType" class="form-select" id="alert-template-layout"> <!-- form-control bootstrap-select bs-select layout-class -->
                ...
                <div class="cm-floating">
                    <label class="control-label form_title">Limit 
                        <span class="img-note" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Note: All the alerts will be shown if Limit not entered">
