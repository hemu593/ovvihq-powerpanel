            ...
            <div class="col-xl-7">
                <div class="accordion ac-form-wd" id="accordionExample">
                    <div class="-tabs d-flex n-fc-white-500 align-items-center">
                        ...
                        <div class="n-ml-15">
                            <span class="n-fs-22">Personal Information</span>
                        ...
                        <div class="n-pa-30 n-pa-md-40">
                            {!! Form::open(['class'=>'w-100 personalInfo_form','id'=>'personalInfo_form']) !!}
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group ac-form-group">
                                            <label class="ac-label" for="companyName">Company Name</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group ac-form-group">
                                            ...
                                            {!! Form::text('phone', '', array('id'=>'phone', 'class'=>'form-control ac-input', 'maxlength'=>'255', 'onpaste'=>'return false;', 'placeholder'=>'Enter phone', 'ondrop'=>'return false;')) !!}
                                            @if ($errors->has('phone'))
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group ac-form-group ac-active-select">
                                            <label class="ac-label">Please select License type <span class="star">*</span></label>
                                            <select class="selectpicker ac-input" data-width="100%" data-size="5" title="Select payment for" id="paymentFor" name="paymentFor">
                                                @foreach($paymentTypeList as $key => $value)
                                                    <option value="{{ $key }}">{{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @if ($errors->has('paymentDesc'))
                                            <span class="error">{{ $errors->first('paymentDesc') }}</span>
                                        @endif
                                    </div>
                                    <div class="col-sm-12 d-none" id="paymentDescField">
                                        <div class="form-group ac-form-group">
                                            <label class="ac-label">Description <span class="star">*</span></label>
                                            {!! Form::textarea('paymentDesc', '', array('id'=> 'paymentDesc', 'class'=>'form-control ac-textarea', 'rows'=>'2', 'spellcheck'=>'true','autocomplete'=>'off','maxlength'=>'400', 'ondrop'=>'return false;')) !!}
                                            @if ($errors->has('paymentDesc'))
                                                <span class="error">{{ $errors->first('paymentDesc') }}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group ac-form-group">
                                            <label class="ac-label" for="yourMessage">Special Instructions</label>
                                            {!! Form::textarea('note',null, array('id'=> 'note', 'class'=>'form-control ac-textarea', 'rows'=>'2', 'spellcheck'=>'true','autocomplete'=>'off','maxlength'=>'400', 'ondrop'=>'return false;')) !!}
                                            @if ($errors->has('note'))
                                    ...
                                    <div class="col-12 text-right">
                                        <a style="float: left" href="{{ url('/payment-information') }}" target="_blank" title="Fees Structure">Fees Structure</a>
                    ...
                    <div class="-tabs d-flex n-fc-white-500 align-items-center">
                        ...
                        <div class="n-ml-15">
                            <span class="n-fs-22">Card Information</span>
                    ...
                    <div id="collapseThree" class="-info collapse" data-parent="#accordionExample">
                        <div class="n-pa-30 n-pa-md-40">
                            {!! Form::open(['class'=>'w-100 cardInfo_form','id'=>'cardInfo_form']) !!}
                                ...
                                <input class="form-control" type="hidden" id="paymentInfo_payment_for" name="paymentInfo_payment_for" value="" />
                                <input class="form-control" type="hidden" id="paymentInfo_desc" name="paymentInfo_desc" value="" />
                                ...
                                <input class="form-control" type="hidden" id="paymentInfo_note" name="paymentInfo_note" value="" />
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group ac-form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group ac-form-group">
                                            ...
                                            {!! Form::text('cardnumber', '', array('id'=>'cardnumber', 'class'=>'form-control ac-input', 'placeholder'=>'Enter your card number')) !!}
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group ac-form-group">
                                            ...
                                            <input id="cvv" type="password" class="form-control ac-input" name="cvv" autocomplete="off" placeholder="Enter your CVV" maxlength="3" minlength="3" onkeypress='javascript: return KeycheckOnlyPhonenumber(event);' />
                ...
                <div class="n-mt-15 text-center d-flex justify-content-center align-items-center">
                    <span class="n-mr-10 n-fs-16 n-ff-2">We are accepting</span>
                    <img src="{{ $CDN_PATH.'assets/images/card.png' }}" alt="Card">
                </div>
            </div>
            ...
            <div class="col-xl-3 n-mt-xl-0 n-mt-25">
                <div class="details">
                    <div class="-title n-pa-15 text-center">
                        ...
                        <div class="ac-note text-center n-fc-white-500" id="info4">This payment is in KYD</div>
                    </div>
                    <div class="-detail n-pa-20">
                        ...
                        <div class="ac-note text-center n-mt-15"> By clicking Pay Now, you agree to our
                        <a href="{{ url('/privacy-policy') }}" target="_blank" title="Privacy Policy">Privacy Policy</a> and <a href="{{ url('/payment-information') }}" target="_blank" title="Privacy Policy">Fee Listing</a>.</div>
                    </div>
                </div>
            </div>
        </div>
