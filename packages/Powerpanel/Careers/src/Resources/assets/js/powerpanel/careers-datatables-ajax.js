...
var TableDatatablesAjax = function() {
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 2,
                    className: 'text-left Careers_title_P_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 3,
                    "name": 'dtDateTime',
                    className: 'text-center Careers_sdate_P_3'
                }, {
                    "data": 4,
                    "name": 'dtEndDateTime',
                    className: 'text-center Careers_edate_P_4'
                }, {
                    "data": 5,
                    className: 'text-center Careers_hits_P_5',
                    "bSortable": false
                }, {
                    "data": 6,
                    className: 'text-center Careers_order_P_6',
                    "name": 'intDisplayOrder'
                }, {
                    "data": 7,
                    className: 'text-center publish_switch Careers_publish_P_7',
                    "bSortable": false
                }, {
                    "data": 8,
                    className: 'text-center Careers_mdate_P_8',
                    "bSortable": false
                }, {
                    "data": 9,
                    className: 'text-right Careers_dactions_P_9 last_td_action mob-show_div',
                    "bSortable": false
                }, {
                    "data": 10,
        ...
        $(document).on('keyup', '#searchfilter', function(e) {
            ...
            if (action.length >= 2) {
                $.cookie('careerssearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else {
                $.removeCookie('careerssearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    "name": 'varTitle',
                    'class': 'text-left Careers_title_A_1 mob-show_div',
                    "bSortable": true
                }, {
                    "data": 2,
                    "name": 'dtDateTime',
                    className: 'text-center Careers_sdate_A_2'
                }, {
                    "data": 3,
                    "name": 'dtEndDateTime',
                    className: 'text-center Careers_edate_A_3'
                }, {
                    "data": 4,
                    className: 'text-center Careers_hits_A_5',
                    "bSortable": false
                }, {
                    "data": 5,
                    className: 'text-center Careers_mdate_A_8',
                    "bSortable": false
                }, {
                    "data": 6,
                    className: 'text-right Careers_dactions_A_9 last_td_action mob-show_div',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/careers/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    className: 'text-left Careers_title_D_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 2,
                    "name": 'dtDateTime',
                    className: 'text-center Careers_sdate_D_3'
                }, {
                    "data": 3,
                    className: 'text-center Careers_edate_D_4',
                    "name": 'dtEndDateTime'
                }, {
                    "data": 4,
                    className: 'text-center Careers_hits_P_5'
                    ...
                    "data": 5,
                    className: 'text-center publish_switch Careers_publish_D_7',
                    "bSortable": false
                }, {
                    "data": 6,
                    className: 'text-center Careers_mdate_D_8',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-right Careers_dactions_D_9 last_td_action mob-show_div',
                    "bSortable": false
                }, {
                    "data": 8,
                    className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/careers/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    className: 'text-left Careers_title_T_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 2,
                    "name": 'dtDateTime',
                    className: 'text-center Careers_sdate_T_3'
                }, {
                    "data": 3,
                    "name": 'dtEndDateTime',
                    className: 'text-center Careers_edate_T_4'
                }, {
                    "data": 4,
                    className: 'text-center Careers_hits_T_5',
                    "bSortable": false
                }, {
                    "data": 5,
                    className: 'text-center Careers_mdate_T_8',
                    "bSortable": false
                }, {
                    "data": 6,
                    className: 'text-right Careers_dactions_T_9 last_td_action mob-show_div',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/careers/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[7]);
                },
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 2,
                    className: 'text-left Careers_title_F_2 mob-show_div',
                    "name": 'varTitle',
                    "bSortable": true
                }, {
                    "data": 3,
                    "name": 'dtDateTime',
                    className: 'text-center Careers_sdate_F_3'
                }, {
                    "data": 4,
                    "name": 'dtEndDateTime',
                    className: 'text-center Careers_edate_F_4'
                }, {
                    "data": 5,
                    className: 'text-center Careers_hits_F_5',
                    "bSortable": false
                }, {
                    "data": 6,
                    className: 'text-center Careers_mdate_F_8',
                    "bSortable": false
                }, {
                    "data": 7,
                    className: 'text-right Careers_dactions_F_9 last_td_action mob-show_div',
                    "bSortable": false
                }, {
                    "data": 8,
                    className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/careers/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[8]);
                },
...
$(window).on('load', function() {
    if ($.cookie('careerssearch')) {
        $('#searchfilter').val($.cookie('careerssearch'));
