    ...
    <div class="col-xl-12">
        <div class="card">
        	@if($iTotalRecords > 0)
                ...
                <div class="card-header cmpage-topheader border border-dashed border-end-0 border-start-0 border-top-0">
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('careers-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/careers/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('careers::template.careersModule.addcareers') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('careers::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('careers::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('careers::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>
                                        @if($userIsAdmin)
                                            <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <select class="form-select" id="category" name="category">
                                                ...
                                                @if(!empty($careerCategory))
                                                    @foreach ($careerCategory as $cat)
                                                        @php $selected = ''; @endphp
                                                        @if(isset($career->intFKCategory))
                                                            @if($cat['id'] == $career->intFKCategory)
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'Careers','Permission_Delete'=>'careers-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'careers'])
                @endif
                @else
...
<script type="text/javascript">
    ...
    var APPROVE_URL = '{!! url("/powerpanel/careers/ApprovedData_Listing") !!}';
    var getChildData = window.site_url + "/powerpanel/careers/getChildData";
    var getChildData_rollback = window.site_url + "/powerpanel/careers/getChildData_rollback";
    var ApprovedData_Listing = window.site_url + "/powerpanel/careers/ApprovedData_Listing";
    var rollbackRoute = window.site_url + "/powerpanel/careers/rollback-record";
    var Get_Comments = '{!! url("/powerpanel/careers/Get_Comments") !!}';
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/careers/careers-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
