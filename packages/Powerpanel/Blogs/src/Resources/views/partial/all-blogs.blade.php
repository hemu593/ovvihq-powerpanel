<div class="ac-modal modal fade bd-example-modal-lg" id="sectionBlogsModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"> <!-- composer-element-popup ckeditor-popup ckbusiness-popup -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="cm-floating">
                    ...
                    <select name="blogscat" class="form-select" id="cat-template-layout"> <!-- form-control bootstrap-select bs-select cat-class -->
