    ...
    var handleTeam = function() {
        $("#frmBoardofdirectors").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit 
                ...
                $('.alert-danger', $('#frmBoardofdirectors')).show();
            },
        ...
        $('#frmBoardofdirectors input').on('keypress', function(e) {
            if (e.which == 13) {
                if ($('#frmBoardofdirectors').validate().form()) {
                    $('#frmBoardofdirectors').submit(); //form validation success, call ajax form submit
                    $("button[type='submit']").attr('disabled', 'disabled');
                }
                return false;
            }
