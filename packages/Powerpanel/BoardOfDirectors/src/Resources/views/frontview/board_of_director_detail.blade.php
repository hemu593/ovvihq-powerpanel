                ...
                <div class="-desc">
                    ...
                    <div class="cms" data-aos="fade-up">
                        {{-- @if(isset($boardofdirectors->varDepartment) && !empty($boardofdirectors->varDepartment))
                            ...
                            @endif
                            @if(isset($boardofdirectors->varEmail) && !empty($boardofdirectors->varEmail))

                            <h3>Email :-</h3><p>{{ $boardofdirectors->varEmail}}<p>

                            @endif
                            @if(isset($boardofdirectors->varPhoneNo) && !empty($boardofdirectors->varPhoneNo))

                            <h3>Phone :-</h3><p>{{ $boardofdirectors->varPhoneNo}}<p>
                        ...
                        {!! htmlspecialchars_decode($txtDescription) !!}
                         ...
                         @elseif(isset($boardofdirectors->varShortDescription) && !empty($boardofdirectors->varShortDescription))

                         <p>{!! $boardofdirectors->varShortDescription !!}</p>
