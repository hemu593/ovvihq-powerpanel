        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left Services_title_P_2 mob-show_div'
                    }, {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-center Services_cat_P_3'
                    }, {
                        "data": 4,
                        "name": 'serviceCode',
                        className: 'text-center Services_sdate_P_4'
                    },
                    // {
                    //     "data": 5,
                    //     "name": 'applicationFee',
                    //     className: 'text-center Services_edate_P_5'
                    // },
                    { "data": 5, className: 'text-center Services_order_P_6', 'name': 'intDisplayOrder' },
                    {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-center Services_publish_P_7 publish_switch'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
                        className: 'text-right last_td_action Services_dactions_P_8 mob-show_div'
                    },
                ],
                "ajax": {
