    ...
    <div class="col-xl-12">
        ...
        <div class="card">
        	@if($iTotalRecords > 0)
                    ...
                    <div class="d-xl-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-shrink-0 addpage-btn order-sm-2">
                            @can('publications-create')
                                <a class="btn btn-light btn-theme bg-gradient waves-effect waves-light btn-label" href="{{ url('powerpanel/publications/add') }}">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <i class="ri-add-line label-icon align-middle fs-20 me-2"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            {{ trans('publications::template.publicationsModule.addPublications') }}
                                        </div>
                                    </div>
                                </a>
                            @endcan
                                    ...
                                    <div class="p-3 dropdown-body">
                                        <div class="mb-3" id="hidefilter">
                                            <select class="form-select" id="statusfilter">
                                                <option value="">{!! trans('publications::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('publications::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('publications::template.common.unpublish') !!}</option>
                                            </select>
                                        </div>
                                        @if($userIsAdmin)
                                            <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            ...
                            $tablearray = [
                                'DataTableTab'=>[
                                    'ColumnSetting'=>[
                                        ...
                                        ['Identity_Name'=>'sdate','TabIndex'=>'2','Name'=>'Publication Date'],
                                    ...
                                    'DataTableHead'=>[
                                        ...
                                        ['Title'=>'Publication Date','Align'=>'left'],
                            ...
                            @endphp
                            @include('powerpanel.partials.datatable-view',['ModuleName'=>'Publications','Permission_Delete'=>'publications-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                        </div>
                    </div>
                </div><!-- end card-body -->
                ...
                @include('powerpanel.partials.quickeditpopup',['TableName'=>'publications'])
                @endif
                @else
                @if (File::exists(base_path() . '/resources/views/powerpanel/partials/addrecordsection.blade.php') != null)
                @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/publications/add')])
                @endif
            @endif
...
@section('scripts')
    <script type="text/javascript">
        window.site_url = '{!! url("/") !!}';
        var DELETE_URL = '{!! url("/powerpanel/publications/DeleteRecord") !!}';
        var onePushShare = '{!! url("/powerpanel/share") !!}';
        var onePushGetRec = '{!! url("/powerpanel/share/getrec") !!}';
        var APPROVE_URL = '{!! url("/powerpanel/publications/ApprovedData_Listing") !!}';
        var rollbackRoute = window.site_url + "/powerpanel/publications/rollback-record";
        var getChildData = window.site_url + "/powerpanel/publications/getChildData";
        var getChildData_rollback = window.site_url + "/powerpanel/publications/getChildData_rollback";
        var ApprovedData_Listing = window.site_url + "/powerpanel/publications/ApprovedData_Listing";
        var Get_Comments = window.site_url + "/powerpanel/publications/Get_Comments";
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/publications/publications-datatables-ajax.js?v='.time() }}" type="text/javascript"></script>
