<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="sectionPublicationModuleTemplate" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-0">
                ...
                <div class="cm-floating">
                    ...
                    <select class="form-control cat-class" data-choices name="publicationscat" id="cat-template-layout">
                ...
                <div class="cm-floating">
                    <label class="control-label col-form-label">Limit 
                        <span class="img-note" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Note: All the publications will be shown if Limit not entered">
