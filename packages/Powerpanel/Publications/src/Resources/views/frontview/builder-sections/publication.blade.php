@if(Request::segment(2) == 'retail-fuel-prices' && Request::segment(3) == '') 
<div class="container">
@endif
    @if(isset($data['publication']) && !empty($data['publication']) && count($data['publication']) > 0)
        @if(Request::segment(1) == 'team' && Request::segment(2) == '') 
            <div class="container p-0 d-none">
                <div class="row n-pb-50 n-pt-30">
                    <div class="col-md-12">
                        <h3 class="nqtitle n-pt-lg-20">Board of Directors Minutes</h3>
                                    ...
                                    @foreach($data['publication'] as $key => $publication)
                                        ...
                                        @foreach($docObj as $key => $val)
                                            ...
                                            <li style=""><a class="" href="{{$docURL }}" download>
                                                ...
                                                {{ date('d', strtotime($publication->PublicationDate)) }}
                                                {{ date('M', strtotime($publication->PublicationDate)) }}
                                                {{ date('Y', strtotime($publication->PublicationDate)) }}
                                            </a></li>
