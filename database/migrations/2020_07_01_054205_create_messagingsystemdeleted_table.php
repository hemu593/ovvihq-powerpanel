...
class CreateMessagingsystemdeletedTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('messagingsystemdeleted', function (Blueprint $table) {
    ...
    public function down() {
        Schema::drop('messagingsystemdeleted');
    }
