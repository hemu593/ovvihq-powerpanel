...
class CreateServicesTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->unsignedInteger('intFkCategory')->collation('utf8_general_ci')->default(0);
            $table->string('varSector',50)->collation('utf8mb4_unicode_ci')->nullable()->default(null);
            $table->string('varTitle', 255)->collation('utf8_general_ci')->nullable()->default(null);
            $table->string('serviceCode', 255)->collation('utf8_general_ci')->nullable()->default(null);
            ...
            $table->string('fkIntDocId',255)->collation('utf8mb4_unicode_ci')->nullable()->default(null);
            $table->string('applicationFee',500)->collation('utf8mb4_unicode_ci')->nullable()->default(null);
            $table->string('noteTitle',500)->collation('utf8mb4_unicode_ci')->nullable()->default(null);
            $table->string('noteLink',500)->collation('utf8mb4_unicode_ci')->nullable()->default(null);
            $table->char('displayInServiceFee', 1)->collation('utf8mb4_unicode_ci')->default('N');
            ...
            $table->text('varTags')->collation('utf8mb4_unicode_ci')->nullable()->default(null);
