...
class CreateEventsTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->string('varLocation', 255)->collation('utf8_general_ci')->nullable()->default(null);
            $table->text('varAddress')->collation('utf8_general_ci')->nullable()->default(null);
            $table->string('varShortDescription', 500)->collation('utf8_general_ci');
            $table->string('varAdminEmail', 255)->collation('utf8_general_ci')->nullable()->default(null);
            $table->string('varAdminPhone', 20)->collation('utf8_general_ci')->nullable()->default(null);
