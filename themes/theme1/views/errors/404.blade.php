        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <div class="nqtitle n-fw-800 n-lh-110 text-uppercase"><span>ERROR 404</span> <br/>Oopsie! Something's missing...</div>
                    <div class="desc n-fs-20 n-fw-500 n-lh-130 n-mt-15 n-mt-lg-30">You may have mis-typed the URL. Or the page has been removed. <br>Actually, there is nothing to see here...</div>
