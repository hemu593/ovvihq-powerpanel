...
<div class='row'>
    ...
    @if($data['subtype'] == 'TwoColumns_1')
            ...
            @if(isset($data['content']['content']) && $data['content']['content'] != '')
            @php
            $data = array('title' => $data['content']['content']);
            @endphp
            <div class="col-12 col-lg-4" data-aos="fade-right">
            @include('visualcomposer::frontview.builder-sections.page-elements.onlytitle',array('data'=>$data))
            </div>
            @endif
            @endif

            @if(isset($data['type']) &&  $data['type'] == 'custom_section')
            <!-- Custom Section -->
            @if(isset($data['content']['title']) && $data['content']['title'] != '')
            <div class="col-12 col-lg-4 col-sm-6 n-mt-25 n-mt-lg-0" data-aos="fade-left">
            @include('visualcomposer::frontview.builder-sections.page-elements.custom_section')
            </div>
            @endif
            @endif

            @if(isset($data['type']) && $data['type'] == 'formdata')
    ...
    @if(isset($data['subtype']) && $data['subtype'] == 'TwoColumns_2')
    ...
    @if(isset($data['subtype']) && $data['subtype'] == 'TwoColumns_3')
    ...
    @endif
    @if(isset($data['Columns']) && $data['Columns'] == '3')
    </div>
    </div>
    </section>
@endif
