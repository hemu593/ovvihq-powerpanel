...
@if(isset($PageData['response']) && !empty($PageData['response']) && $PageData['response'] != '[]')
    <section class="inner-page-gap whois-information">
        ...
        <div class="container">
            <div class="row">
                @include('forms-and-fees::frontview.forms-and-fees-left-panel')
                <div class="col-xl-9 n-mt-25 n-mt-xl-0" data-aos="fade-up" id="applicationforms">
...
<script src="{{ $CDN_PATH.'assets/js/packages/forms-and-fees/forms-and-fees.js' }}" type="text/javascript"></script>
@if(!Request::ajax())
