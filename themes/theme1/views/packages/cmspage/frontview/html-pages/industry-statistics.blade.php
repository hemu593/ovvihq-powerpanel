<section class="inner-page-gap bod-meetings">
    <!-- This design depends on the board-of-directors-meetings -->
                        ...
                        @php } @endphp
                            <article class="-items w-100 n-bs-1 n-pa-20 n-p-relative n-bgc-white-500">
                                <div class="documents align-items-start">
                                    ...
                                    <div>
                                        <a class="-link n-ah-a-500" href="#" download="" title="">ICT Industry Statistics to 31 December 2018 (excel format)</a>
