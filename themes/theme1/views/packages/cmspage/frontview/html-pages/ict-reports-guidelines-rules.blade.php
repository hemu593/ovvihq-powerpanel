                            ...
                            <article>
                                ...
                                <div class="form-group ac-form-group n-mb-0">
                                    <select class="selectpicker ac-input" data-width="100%" title="Sort by Category">
                                        <option>Ict Industry Statistics</option>
                                        <option>Ict Reports</option>
                                        <option>Ict Guidelines</option>
                                        <option>ICT Rules</option>
                                        <option>Ict Quarterly Licence Fee Reports</option>
                                    </select>
                                </div>
                            </article>
                        </div>
