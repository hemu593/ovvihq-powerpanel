<section class="inner-page-gap legislation-regulation">
            ...
            <div class="col-xl-9 n-mt-25 n-mt-xl-0">
                <div class="row">
                    @php for ($x = 1; $x <= 3; $x++) { @endphp
                        @php if ( $x & 1 ) { @endphp
                            <div class="col-sm-6 n-gapp-sm-3 n-gapm-sm-2" data-aos="fade-right">
                        @php } else { @endphp
                            <div class="col-sm-6 n-gapp-sm-3 n-gapm-sm-2" data-aos="fade-left">
                        @php } @endphp
                            <div class="documents">
                                <div class="-doct-img">
