/**
 * This method validates rfps form fields
 * since   2016-12-24
 * author  NetQuick
 */
var Validate = function() {
    var handleRfps = function() {
        $("#frmRfps").validate({
        ...
        $('#frmRfps input').keypress(function(e) {
            if (e.which == 13 && e.keyCode != 188) {
                if ($('#frmRfps').validate().form()) {
                    $('#frmRfps').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
