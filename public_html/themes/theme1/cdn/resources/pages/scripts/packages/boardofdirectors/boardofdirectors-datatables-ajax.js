    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/boardofdirectors/get_list", // ajax source
                },
        ...
        grid1.init({
            ...
            loadingMessage: 'Loading...',
             dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/boardofdirectors/get_list_New", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
    ...
    var handleRecords2 = function () {
        ...
        grid2.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/boardofdirectors/get_list_draft", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
    ...
    var handleRecords3 = function () {
        ...
        grid3.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/boardofdirectors/get_list_trash", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[6]);
                },
    ...
    var handleRecords4 = function () {
        ...
        grid4.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/boardofdirectors/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[7]);
                },
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/boardofdirectors/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
