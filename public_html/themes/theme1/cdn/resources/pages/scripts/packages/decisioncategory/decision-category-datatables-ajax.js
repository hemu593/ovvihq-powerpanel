        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 3,
                        "bSortable": false,
                        className: 'text-center DecisionCategory_cat_P_3'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        ...
                        "data": 6,
                        className: 'text-center DecisionCategory_hits_P_6',
                        "bSortable": false
                    }, {
                        "data": 7,
                        "name": 'intDisplayOrder',
                        className: 'text-center DecisionCategory_order_P_7'
                    }, {
                        "data": 8,
                        "bSortable": false,
                        className: 'text-center publish_switch DecisionCategory_publish_P_8'
                    },
                    {
                        "data": 9,
                        "bSortable": false,
                ...
                "columns": [
                    ...
                    },
                    {
                       ...
                       "name": 'dtEndDateTime',
                        ...
                        "data": 5,
                        className: 'text-center DecisionCategory_hits_A_6'
                    },  {
                        "data": 6,
                        "bSortable": false,
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                    ...
                    },
                    {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-center publish_switch DecisionCategory_hits_D_6'
                    },
                    {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-center publish_switch DecisionCategory_publish_D_8'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
        ...
        grid4.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 6,
                        className: 'text-center DecisionCategory_hits_F_6',
                        "bSortable": false
                    },
                    {
                        "data": 7,
