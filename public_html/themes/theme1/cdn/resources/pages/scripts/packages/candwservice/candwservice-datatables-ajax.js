...
var TableDatatablesAjax = function() {
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left CandWService_title_P_2 mob-show_div'
                    },
                    {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center CandWService_sdate_P_4'
                    }, {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-center CandWService_publish_P_5 publish_switch'
                    },
                    {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-right last_td_action CandWService_dactions_P_6 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/candwservice/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function(e) {
            ...
            if (action.length >= 2) {
                $.cookie('CandWServicesearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else if (action.length < 1) {
                $.removeCookie('CandWServicesearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left CandWService_title_A_2 mob-show_div',
                        "bSortable": true
                    },
                    {
                        "data": 2,
                        "name": 'dtDateTime',
                        className: 'text-center CandWService_sdate_A_4'
                    },
                    {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-right last_td_action CandWService_dactions_A_5 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/candwservice/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left CandWService_title_D_2 mob-show_div'
                    },
                    {
                        "data": 2,
                        "name": 'dtDateTime',
                        className: 'text-center CandWService_sdate_D_4'
                    }, {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-center publish_switch CandWService_publish_D_4'
                    },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-right last_td_action CandWService_dactions_D_5 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/candwservice/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left CandWService_title_T_2 mob-show_div'
                    },
                    {
                        "data": 2,
                        "name": 'dtDateTime',
                        className: 'text-center CandWService_sdate_T_4'
                    },
                    {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-right last_td_action CandWService_dactions_T_5 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/candwservice/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    // $(nRow).attr('data-order', aData[5]);
                },
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left CandWService_title_F_2 mob-show_div'
                    },
                    {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center CandWService_sdate_F_4'
                    },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-right last_td_action CandWService_dactions_F_5 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/candwservice/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    // $(nRow).attr('data-order', aData[6]);
                },
...
$(window).on('load', function() {
    if ($.cookie('CandWServicesearch')) {
        $('#searchfilter').val($.cookie('CandWServicesearch'));
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/candwservice/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
