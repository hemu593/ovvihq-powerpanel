...
var TableDatatablesAjax = function() {
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 2,
                        className: 'text-left mob-show_div Companies_title_P_2',
                        "name": 'varTitle',
                        "bSortable": true
                    }, 
                     {
                        "data": 3,
                        className: 'text-center mob-show_div Companies_title_P_2',
                        "bSortable": true
                    }, 
                    {
                        "data": 4,
                        className: 'text-center Companies_cat_P_3',
                        "name": 'intFKCategory'
                    },
                    {
                        "data": 5,
                        ...
                        "data": 6,
                        className: 'text-center publish_switch Companies_publish_P_4',
                        "bSortable": false
                    }, {
                        "data": 7,
                        className: 'text-right last_td_action mob-show_div Companies_dactions_P_5',
                        "bSortable": false
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/companies/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function(e) {
            ...
            if (action.length >= 2) {
                $.cookie('Companiessearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else {
                $.removeCookie('Companiessearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    "name": 'varTitle',
                    className: 'text-center mob-show_div Companies_title_A_2',
                    "bSortable": true
                },
                   {
                        "data": 2,
                ...
                {
                    "data": 3,
                    className: 'text-center Companies_cat_A_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 4,
                    className: 'text-center',
                    ...
                    "data": 5,
                    className: 'text-right last_td_action mob-show_div Companies_dactions_A_9',
                    "bSortable": false
                }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/companies/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        className: 'text-left mob-show_div Companies_title_D_2',
                        "name": 'varTitle',
                        "bSortable": true
                    },
                     {
                    ...
                    {
                        "data": 3,
                        className: 'text-center Companies_cat_D_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 4,
                        className: 'text-center',
                    ...
                    {
                        "data": 5,
                        className: 'text-center publish_switch Companies_publish_D_8',
                        "bSortable": false
                    }, {
                        "data": 6,
                        className: 'text-right last_td_action mob-show_div Companies_dactions_D_9',
                        "bSortable": false
                    }
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/companies/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        className: 'text-left mob-show_div Companies_title_T_2',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Companies_cat_T_3',
                        "name": 'intFKCategory'
                    },
                    {
                        "data": 3,
                        ...
                        "data": 4,
                        className: 'text-right last_td_action mob-show_div Companies_dactions_T_9',
                        "bSortable": false
                    }
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/companies/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 2,
                        className: 'text-left mob-show_div Companies_title_F_2',
                        "name": 'varTitle',
                        "bSortable": true
                    },
                     {
                    ...
                    {
                        "data": 4,
                        className: 'text-center Companies_title_F_2 ',
                        "name": 'intFKCategory'
                    },
                    {
                        "data": 5,
                    ...
                    {
                        "data": 6,
                        className: 'text-right last_td_action mob-show_div Companies_dactions_F_9',
                        "bSortable": false
                    }
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/companies/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
...
$(window).on('load', function() {
    if ($.cookie('Companiessearch')) {
        $('#searchfilter').val($.cookie('Companiessearch'));
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/companies/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
