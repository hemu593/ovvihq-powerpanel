    ...
    return {
        ...
        eventsTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class, startdate, enddate, eventscat) {
            ...
            if (edit == 'N') {
                ...
                section += '<input id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-config="' + config + '" data-class="' + extra_class + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" data-eventscat="' + eventscat + '" data-sdate="' + startdate + '" module="events" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-config="' + config + '" data-class="' + extra_class + '" module="events" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" data-eventscat="' + eventscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        newsTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class, startdate, enddate, newscat) {
            ...
            if (newscat.trim() != '' && newscat != null) {
                manageRecordURL = baseURL + 'news?category=' + newscat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" data-newscat="' + newscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" module="news" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-newscat="' + newscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-sdesc="' + sectiondesc + '" module="news" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        publicRecordTemplate: function(val, sectionlimit, template, edit, extra_class, newscat) {
            ...
            if (edit == 'N') {
                ...
                section += '<input id="' + iCount + '"  data-type="' + template + '" data-class="' + extra_class + '"  data-slimit="' + sectionlimit + '"  data-newscat="' + newscat + '" module="public-record" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '"  data-type="' + template + '" data-class="' + extra_class + '" data-slimit="' + sectionlimit + '" data-newscat="' + newscat + '" module="public-record" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        interconnectionsTemplate: function(val, parentorg, template, extraclass, edit) {
            ...
            if (edit == 'N') {
                ...
                section += '<div class="col-md-12"><label><b>' + val + '</b></label><a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a></div>';
                section += '<input module="interconnections" id="' + iCount + '" data-type="' + template + '" data-parentorg="' + parentorg + '" data-orgclass="' + extraclass + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<div class="col-md-12"><label><b>' + val + '</b></label><a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a></div>';
                section += '<input module="interconnections" id="' + edit + '" data-type="' + template + '" data-parentorg="' + parentorg + '" data-orgclass="' + extraclass + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        faqTemplate: function(val, sectionlimit, extra_class, template, edit, startdate, enddate, faqcat) {
            ...
            if (edit == 'N') {
                ...
                section += '<input module="faq" id="' + iCount + '" data-class="' + extra_class + '" data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-faqcat="' + faqcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="faq" id="' + edit + '" data-class="' + extra_class + '" data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-faqcat="' + faqcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        publicationTemplate: function(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, publicationscat) {
            ...
            if (edit == 'N') {
                ...
                section += '<input module="publications" id="' + iCount + '" data-sector="' + sector + '" data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-publicationscat="' + publicationscat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="publications" id="' + edit + '" data-sector="' + sector + '" data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-publicationscat="' + publicationscat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        decisionTemplate: function(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, decisioncat) {
            ...
            if (edit == 'N') {
                ...
                section += '<input module="decision" id="' + iCount + '" data-sector="' + sector + '" data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-decisioncat="' + decisioncat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="decision" id="' + edit + '" data-sector="' + sector + '" data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-decisioncat="' + decisioncat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        addCustomRecord: function(sectionid, imgid, imgsrc, title, link, desc, edit) {
            ...
            if (typeof edit == 'undefined' || edit == '') {
                ...
                section += title;
                section += '<a href="javascript:;" data-id="' + sectionid + '" data-img="' + imgid + '" data-imgsrc="' + imgsrc + '" data-title="' + title + '" data-link="' + link + '" data-desc="' + desc + '" data-mode="edit" class="add-custom-record" title="edit"> <i class="fa fa-pencil" aria-hidden="true"></i> </a>';
        ...
        moduleSectionsEvents: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            ...
            if (edit == 'N') {
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="events" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-extraclass="' + extraclass + '" data-layout="' + layoutType + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="events" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="events" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-extraclass="' + extraclass + '" data-layout="' + layoutType + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="events" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsComplaintServices: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            ...
            if (edit == 'N') {
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="complaint-services" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="complaint-services" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="complaint-services" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="complaint-services" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsNews: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            ...
            if (edit == 'N') {
                ...
                section += '</a>';
                section += '</div>';
                section += '<input id="' + iCount + '" module="news" type="hidden" data-filter="' + template + '" data-config="' + config + '" data-extraclass="' + extraclass + '" data-layout="' + layoutType + '" data-caption="' + caption + '" data-desc="' + desc + '" data-type="module" value="news" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input id="' + edit + '" type="hidden" data-filter="' + template + '" data-config="' + config + '" data-extraclass="' + extraclass + '" data-layout="' + layoutType + '" data-caption="' + caption + '" data-desc="' + desc + '" data-type="module" module="news" value="news" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        submitFrmSectionDecisionModuleTemplate: function() {
            if ($('#frmSectionDecisionModuleTemplate').validate().form()) {
                ...
                builder.decisionTemplate(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, decisioncat);
        ...
        submitFrmSectionPublicRecordModuleTemplate: function() {
            if ($('#frmSectionPublicRecordModuleTemplate').validate().form()) {
                ...
                builder.publicRecordTemplate(val, sectionlimit, template, edit, extra_class, newscat);
        ...
        addColumns: function(sectionid, no_of_column, column_class, animation) {
            ...
            section += '<a href="javascript:;" data-id="' + editor + '-row-' + row_count + '"  class="edit-col-row" title="Delete"><i class="action-icon edit fa fa-pencil"></i></a>';
            section += '<div class="ui-new-section-add col-sm-12">';
            for (i = 1; i <= no_of_column; i++) {
                ...
                section += '<a href="javascript:;" data-editor="' + editor + '-row-' + row_count + '-col-' + i + '" class="edit-column" title="Edit"><i class="action-icon edit fa fa-pencil"></i></a>';
                section += '<div class="clearfix"></div>';
...
$(document).on('click', '.decision-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionDecisionModuleTemplate').modal({
        backdrop: 'static',
        keyboard: false
    });
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionDecisionModuleTemplate #addSection').text('Update');
        ...
        $('#sectionDecisionModuleTemplate #addSection').text('Add');
...
$(document).on('click', '.add-row', function(event) {
    ...
    section += '<a href="javascript:;" data-id="' + editor + '" class="edit-row" title="Delete"><i class="action-icon edit fa fa-pencil"></i></a>';
    section += '<div class="ui-new-section-add col-sm-12">';
