        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [
                    ...
                    { "data": 3, className: 'text-center', "name": 'txtMessage', "bSortable": false },
                    { "data": 4, className: 'text-center', "name": 'created_at' },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/online-polling-lead/get_list", // ajax source
                },
                "order": [
                        [4, "desc"]
                    ...
                    if (exportRadioVal == 'selected_records') {
                        if ($('#ExportRecord').click) {
                            if ($('input[name="delete[]"]:checked').val()) {
                                ...
                                var ajaxurl = window.site_url + "/powerpanel/online-polling-lead/ExportRecord" + ip;
                        ...
                        var ajaxurl = window.site_url + "/powerpanel/online-polling-lead/ExportRecord";
                        window.location = ajaxurl;
                    }
                }
            }
