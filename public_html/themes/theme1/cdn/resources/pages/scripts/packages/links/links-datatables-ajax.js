        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 3,
                        className: 'text-center Links_cat_P_3',
                        "name": 'intFKCategory',
                        "bSortable": true
                    }, {
                        "data": 4,
                        className: 'text-center Links_link_P_4',
                        "name": 'txtLink',
                        "bSortable": false
                    }, {
                        "data": 5,
                        className: 'text-center Links_sdate_P_5',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 6,
                        className: 'text-center Links_edate_P_6',
                        "name": 'dtEndDateTime',
                        "bSortable": true
                    }, {
                        "data": 7,
                        className: 'text-center Links_order_P_7',
                        "name": 'intDisplayOrder'
                    }, {
                        "data": 8,
                        className: 'text-center publish_switch Links_publish_P_8',
                        "bSortable": false
                    }, {
                        "data": 9,
        ...
        grid2.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 6,
                        className: 'text-center publish_switch Links_publish_D_8',
                        "bSortable": false
                    }, {
                        "data": 7,
