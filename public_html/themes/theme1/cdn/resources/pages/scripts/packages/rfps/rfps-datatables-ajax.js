...
var TableDatatablesAjax = function() {
    var handleRecords = function() {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left Rfps_title_P_2 mob-show_div'
                    }, {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-center Rfps_cat_P_3'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-center Rfps_sdate_P_4'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-center Rfps_edate_P_5'
                    }, {
                        "data": 6,
                        className: 'text-center Rfps_hits_P_6',
                        "bSortable": false
                    }, {
                        "data": 7,
                        "bSortable": false,
                        className: 'text-center Rfps_publish_P_7 publish_switch'
                    },
                    {
                        "data": 8,
                        "bSortable": false,
                        className: 'text-right last_td_action Rfps_dactions_P_8 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/rfps/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function(e) {
            ...
            if (action.length >= 2) {
                $.cookie('Rfpssearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else if (action.length < 1) {
                $.removeCookie('Rfpssearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        $(document).on('click', '#rfpsRange', function(e) {
            e.preventDefault();
            var action = {};
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left Rfps_title_A_2 mob-show_div',
                        "bSortable": true
                    }, {
                        "data": 2,
                        "bSortable": false,
                        className: 'text-center Rfps_cat_A_3'
                    }, {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center Rfps_sdate_A_4'
                    }, {
                        "data": 4,
                        "name": 'dtEndDateTime',
                        className: 'text-center Rfps_edate_A_5'
                    }, {
                        "data": 5,
                        className: 'text-center Rfps_hits_A_6',
                        "bSortable": false
                    },
                    {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-right last_td_action Rfps_dactions_A_8 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/rfps/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left Rfps_title_D_2 mob-show_div'
                    }, {
                        "data": 2,
                        "bSortable": false,
                        className: 'text-center Rfps_cat_D_3'
                    }, {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center Rfps_sdate_D_4'
                    }, {
                        "data": 4,
                        "name": 'dtEndDateTime',
                        className: 'text-center Rfps_edate_D_5'
                    }, {
                        "data": 5,
                        className: 'text-center Rfps_hits_D_6',
                        "bSortable": false
                    }, {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-center publish_switch Rfps_publish_D_7'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
                        className: 'text-right last_td_action Rfps_dactions_D_8 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/rfps/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left Rfps_title_T_2 mob-show_div'
                    }, {
                        "data": 2,
                        "bSortable": false,
                        className: 'text-center Rfps_cat_T_3'
                    }, {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center Rfps_sdate_T_4'
                    }, {
                        "data": 4,
                        "name": 'dtEndDateTime',
                        className: 'text-center Rfps_edate_T_5'
                    }, {
                        "data": 5,
                        className: 'text-center Rfps_hits_T_6',
                        "bSortable": false
                    },
                    {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-right last_td_action Rfps_dactions_T_8 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/rfps/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[5]);
                },
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left Rfps_title_F_2 mob-show_div'
                    }, {
                        "data": 3,
                        "bSortable": false,
                        className: 'text-center Rfps_cat_F_3'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-center Rfps_sdate_F_4'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-center Rfps_edate_F_5'
                    }, {
                        "data": 6,
                        className: 'text-center Rfps_hits_F_6',
                        "bSortable": false
                    },
                    {
                        "data": 7,
                        "bSortable": false,
                        className: 'text-right last_td_action Rfps_dactions_F_8 mob-show_div'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/rfps/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[6]);
                },
...
$(window).on('load', function() {
    if ($.cookie('Rfpssearch')) {
        $('#searchfilter').val($.cookie('Rfpssearch'));
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/rfps/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
