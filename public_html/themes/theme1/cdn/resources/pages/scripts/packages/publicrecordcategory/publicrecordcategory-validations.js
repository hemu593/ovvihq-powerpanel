...
var Validate = function() {
    var handleServiceCategory = function() {
        $("#frmPublicRecordCategory").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmDocumentcenterCategory')).show();
            },
        ...
        $('#frmPublicRecordCategory input').keypress(function(e) {
            if (e.which == 13 && e.keyCode != 188) {
                if ($('#frmPublicRecordCategory').validate().form()) {
                    $('#frmPublicRecordCategory').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
