        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div ServiceCategory_title_P_2'
                    }, {
                        "data": 3,
                        className: 'text-center ServiceCategory_sdate_P_3',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 4,
                        className: 'text-center ServiceCategory_edate_P_4',
                        "name": 'dtEndDateTime',
                        "bSortable": true
                    }, {
                        "data": 5,
                        className: 'text-center ServiceCategory_order_P_5',
                        "name": 'intDisplayOrder'
                    }, {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-center publish_switch ServiceCategory_publish_P_7'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div ServiceCategory_dactions_P_8'
                    },
                ],
                "ajax": {
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div ServiceCategory_title_A_2',
                        "bSortable": true
                    }, {
                        "data": 2,
                        "name": 'dtDateTime',
                        className: 'text-center ServiceCategory_sdate_A_3'
                    }, {
                        "data": 3,
                        className: 'text-center ServiceCategory_edate_A_4',
                        "name": 'dtEndDateTime',
                        "bSortable": false
                    },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div ServiceCategory_dactions_A_8'
                    }
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/service-category/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div ServiceCategory_title_D_2'
                    }, {
                        "data": 2,
                        className: 'text-center ServiceCategory_sdate_D_3',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 3,
                        className: 'text-center ServiceCategory_edate_D_4',
                        "name": 'dtEndDateTime',
                        "bSortable": true
                    }, {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-center publish_switch ServiceCategory_publish_D_7'
                    },
                    {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div ServiceCategory_dactions_D_8'
                    },
                ],

                "ajax": {
                    "url": window.site_url + "/powerpanel/service-category/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div ServiceCategory_title_T_2'
                    }, {
                        "data": 2,
                        className: 'text-center ServiceCategory_sdate_T_3',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 3,
                        className: 'text-center ServiceCategory_edate_T_4',
                        "name": 'dtEndDateTime',
                        "bSortable": true
                    },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div ServiceCategory_dactions_T_8'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/service-category/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    // $(nRow).attr('data-order', aData[7]);
                },
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 2,
                        "name": 'varTitle',
                        className: 'text-left mob-show_div ServiceCategory_title_F_2'
                    }, {
                        "data": 3,
                        className: 'text-center ServiceCategory_sdate_F_3',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 4,
                        className: 'text-center ServiceCategory_edate_F_4',
                        "name": 'dtEndDateTime',
                        "bSortable": true
                    },
                    {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-right last_td_action mob-show_div ServiceCategory_dactions_F_8'
                    },
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/service-category/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    // $(nRow).attr('data-order', aData[7]);
                },
