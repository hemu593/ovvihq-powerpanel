    ...
    return {
        ...
        teamTemplate: function(val, config, template, edit, configTxt, layout, extra_class) {
            ...
            if (edit == 'N') {
                ...
                section += '<input data-extclass="' + extra_class + '" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-config="' + config + '" type="hidden" module="team" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<div class="col-md-12"><label><b>' + val + '</b></label> <a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a> <ul><li>Template: ' + template + '</li></ul></div>';
                section += '<input id="' + edit + '" data-extclass="' + extra_class + '" data-layout="' + layout + '" data-type="' + template + '" data-config="' + config + '" module="team" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
