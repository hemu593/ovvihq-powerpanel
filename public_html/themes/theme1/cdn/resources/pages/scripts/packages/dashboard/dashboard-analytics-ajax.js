		...
		var plot_statistics = $.plot($("#site_statistics"), [{			
			...
			var previousPoint = null;
				...
				*/
				...
				$('#chart_10').closest('.portlet').find('.fullscreen').on('click',function() {
					map.invalidateSize();
				});
			},
		init: function() {			
...
$('#chart_browser_hits').closest('.portlet').find('.fullscreen').on('click',function() {
...
$('#chart_os_hits').closest('.portlet').find('.fullscreen').on('click',function() {
	chart.invalidateSize();
});
...
$('#chart_vistor_hits').closest('.portlet').find('.fullscreen').on('click',function() {
	chart.invalidateSize();
});
}
