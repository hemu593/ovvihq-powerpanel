    ...
    var handleNews = function() {
        $("#frmCareerCategory").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit  
                ...
                $('.alert-danger', $('#frmCareerCategory')).show();
            },
        ...
        $('#frmCareerCategory input').keypress(function(e) {
            if (e.which == 13 && e.keyCode != 188) {
                if ($('#frmCareerCategory').validate().form()) {
                    $('#frmCareerCategory').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
