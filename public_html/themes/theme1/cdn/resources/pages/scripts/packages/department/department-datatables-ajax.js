        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 3,
                        className: 'text-center Department_email_P_3',
                        "name": 'varEmail',
                        "bSortable": true
                    }, {
                        "data": 4,
                        className: 'text-center Department_sdate_P_4',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 5,
                        className: 'text-center Department_edate_P_5',
                        "name": 'dtEndDateTime',
                        "bSortable": true
                    },
                    {
                        "data": 6,
                        className: 'text-center Department_order_P_6',
                        "name": 'intDisplayOrder'
                    }, {
                        "data": 7,
                        className: 'text-center publish_switch Department_publish_P_7',
                        "bSortable": false
                    }, {
                        "data": 8,
