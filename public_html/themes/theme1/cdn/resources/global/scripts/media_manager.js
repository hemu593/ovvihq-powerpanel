                ...
                if ($('.media_manager.multiple-selection').is('[data-multiple]') && multiple_selection == false) {
                    ...
                    $('.img-box-active').each(function(index) {
                        ...
                        imgSRC += '<li id="' + id[1] + '">\n\
													<span>\n\
														<img src="' + imageURL + '" />\n\
														<a href="javascript:;" onclick="MediaManager.removeImageFromGallery(' + id[1] + ');" class="delect_image" data-dismiss="fileinput"><i class="ri-delete-bin-line"></i></a>\n\
													</span>\n\
												</li>';
                ...
                if (multiple_selection == true) {
                    ...
                    $('.active_video').each(function(index) {
                        ...
                        vidSRC += '<li id="' + id[1] + '">\n\
																																																																<span>\n\
																																																																				<img src="' + imageURL + '" />\n\
																																																																				<a href="javascript:;" onclick="MediaManager.removeVideoFromVideoManager(' + id[1] + ');" class="delect_image" data-dismiss="fileinput"><i class="ri-delete-bin-line"></i></a>\n\
																																																																</span>\n\
																																																												</li>';
        ...
        insertDocument: function() {
            ...
            if ($('.user_uploaded_docs .contains_thumb').hasClass('document-box-active')) {
                ...
                if (multiple_selection) {
                            ...
                            if (data_id == 'Composer_doc') {
                                docSRC += '<li id="doc_' + value + '">\n\
									<span>\n\
													...
													<a href="javascript:;" onclick="MediaManager.removeDocumentFromComposerBlock(' + value + ');" class="delect_image" data-dismiss="fileinput"><i class="ri-delete-bin-line"></i></a>\n\
									</span>\n\
								</li>';
                            } else {
                                ...
                                docSRC += '<li id="doc_' + value + '">\n\
									<span>\n\
													<img src="' + image_url + '" />\n\
													<a href="javascript:;" onclick="MediaManager.removeDocumentFromGallery(' + value + ');" class="delect_image" data-dismiss="fileinput"><i class="ri-delete-bin-line"></i></a>\n\
									</span>\n\
								</li>';
                            }
                        ...
                        if (data_id == 'Composer_doc') {
                            ...
                            if (!ckOpen && $.inArray(id[1], alreadySelectedDocArray) == -1) {
                                docSRC += '<li id="doc_' + id[1] + '">\n\
													<span>\n\
																	<img src="' + CDN_PATH + 'assets/images/document_icon.png' + '" />\n\
																	<a href="javascript:;" onclick="MediaManager.removeDocumentFromComposerBlock(' + id[1] + ');" class="delect_image" data-dismiss="fileinput"><i class="ri-delete-bin-line"></i></a>\n\
                            ...
                            if (ckOpen || (!ckOpen && $.inArray(id[1], alreadySelectedDocArray) == -1)) {
                                ...
                                docSRC += '<li id="doc_' + id[1] + '">\n\
												<span>\n\
														<img src="' + image + '" />\n\
														<a href="javascript:;" onclick="MediaManager.removeDocumentFromGallery(' + id[1] + ');" class="delect_image" data-dismiss="fileinput"><i class="ri-delete-bin-line"></i></a>\n\
												</span>\n\
								</li>';
                            }
                        }
                    ...
                    if (data_id == 'Composer_doc') {
                        $('#frmSectionOnlyDocument').find('.item-data.imgip1').val(doc_ids.join(','));
