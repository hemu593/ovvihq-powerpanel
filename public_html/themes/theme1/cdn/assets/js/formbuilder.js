    ...
    var handleFormBuilder = function () {
        $("#formbuildername").validate({
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit   
                $('.alert-danger', $('#formbuildername')).show();
            },
        ...
        $('#formbuildername input').keypress(function (e) {
            if (e.which == 13) {
//                if ($('#formbuildername').validate().form()) {
//                    $("#contact_submit").attr("disabled","disabled");
//                    SetBackGround();
//                    $('#formbuildername').submit(); //form validation success, call ajax form submit
//                }
                return false;
            }
        });
...
$('input[name=formbuildername]').change(function () {
    var email = $(this).val();
