...
var Menu = function() {
    ...
    return {
                ...
                success: function(data) {
                    if (data.length > 0) {
                        ...
                        if (obj.title != undefined) {
                            ...
                            $('#menuTitleErrT').html('');
                            $('#menu-item-add input').val(null);
                            $('#menu-item-add').modal('hide');
                        }
                    } else {
                        $('#menu-item-add').modal('hide');
                        $('#menuTitleErrT').html('');
        ...
        reorder: function() {
            ...
            var state = $('input[name=active]').prop('checked') == true ? 'Y' : 'N';
        ...
        add_menu_item: function() {
            ...
            var state = $('input[name=active]').is(':checked')==true?'Y':'N';
...
jQuery(document).ready(function() {
    ...
    $(document).on('click', '.activeItem', function() {
        ...
        if (this.checked) {
            console.log("if one");
            $(this).parent().removeClass('menu-published')
            $($(this).parent().parent().parent().find('ol').find('input')).each(function() {
                console.log("iffff oneeee");
                $(this).prop('checked', true);
            });
        } else {
            console.log("else one");
            $(this).parent().addClass('menu-published')
            $($(this).parent().parent().parent().find('ol').find('input')).each(function() {
                console.log("else oneeeeeeeeeeeeeee");
    ...
    $(document).ajaxStop(function() {
        if (!menuUpdated) {
            $('input[name=active]').change(function(event, state) {
                menuUpdated = true;
            });
        }
    });
...
$('#menu-item-add').on('hidden.bs.modal', function() {
    $('#menuTitleErrT').html('');
});
...
//     alert("herere ");
//     $(this).is(':checked') ? $(this).parent().addClass('menu-published') : $(this).parent().removeClass('menu-published');
//     // if ($(this).checked) {
//     //     $($(this).parent().parent().parent().find('ol').find('input')).each(function() {
//     //         console.log("iffff");
//     //         $(this).prop('checked', true);
