            ...
            switch (data.method) {
                ...
                case 'getCroppedCanvas':
                    if (result) {
                        ...
                        // Bootstrap's Modal
                        $('#getCroppedCanvasModal').css({
                            "display": "block"
                        });
                        $('#getCroppedCanvasModal').modal('show').find('.cropped_image').html('<img src=' + result.toDataURL(uploadedImageType) + ' />');

                        //download.download = uploadedImageName;
                        //$download.attr('href', result.toDataURL(uploadedImageType));

                        $('#save_as_new').on('click', function(e) {
