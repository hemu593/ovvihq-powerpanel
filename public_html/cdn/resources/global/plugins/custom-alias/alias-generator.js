    ...
    $.ajax({
        ...
        complete: function() {
            ...
            if (formpageurl != 'page_template') {
                ...
                $('#previewid').html('<a class="btn btn-info bg-gradient waves-effect waves-light btn-label me-1" onClick="generatePreview(\'' + previewurl + '\');" title="Preview" ><div class="flex-shrink-0"><i class="ri-eye-line label-icon align-middle fs-20 me-2"></i></div>Preview</a>');
            } else {
                $('#previewid').html('<a class="btn btn-info bg-gradient waves-effect waves-light btn-label me-1 without_bg_icon openLink" onClick="generatePreview(\'' + previewurl + '\');" title="Preview" ><div class="flex-shrink-0"><i class="ri-eye-line label-icon align-middle fs-20 me-2"></i></div>Preview</a>');
            }
        },
        error: function() {
            console.log('error!');
...
$(document).on('click', '.editAlias', function() {
    ...
    var frontURL = '<a href="javascript:void(0);" class="editAlias" title="Edit"></a><a href="javascript:void(0);" class="without_bg_icon openLink" onClick="generatePreview(\'' + previewurl + '\');" title="Open Link" ><i class="ri-external-link-line" aria-hidden="true"></i></a>';
    $('.alias-group').html('<div class="form-group"><label class="form_title mb-0" for="site_name">Url :</label> <a href="javascript:void;" class="alias">' + links + '</a><a href="javascript:void(0);" class="editAlias"> <i class="ri-pencil-line"></i>  ' + frontURL + '  </a></div><div class="editAliasForm mt-3"><div class="form-group form-md-line-input cm-floating"><label class="form_title m-0" for="site_name">Alias</label> <input class="form-control input-sm edited" name="new-alias" id="new-alias" value="' + updated_alias + '" type="text" maxlength="150"/> <div class="d-flex justify-content-between align-items-center pt-2"><span class="alias-btn"><a class="btn btn-soft-primary waves-effect waves-light btn-sm update-alias" href="javascript:void(0);">Update</a>&nbsp;<a class="btn btn-soft-secondary waves-effect waves-light btn-sm regenerate-alias" href="javascript:void(0);">Regenerate</a>&nbsp;<a class="btn btn-soft-danger waves-effect waves-light btn-sm cancle-alias" href="javascript:void(0);">Cancel</a></span></div> </div></div></div>');
});
