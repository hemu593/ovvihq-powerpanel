        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [
                    ...
                    {"data": 2, className: 'text-center', "name": 'varIpAddress'},
                    {"data": 3, className: 'text-center', "name": 'created_at'},
                ],
                "ajax": {
                    "url": window.site_url + "/powerpanel/hits-report/get_list", // ajax source
                },
                "order": [
                    [3, "desc"]
                    ...
                    if (exportRadioVal == 'selected_records') {
                        if ($('#ExportRecord').click) {
                            if ($('input[name="delete[]"]:checked').val()) {
                                ...
                                var ajaxurl = window.site_url + "/powerpanel/hits-report/ExportRecord" + ip;
                        ...
                        var ajaxurl = window.site_url + "/powerpanel/hits-report/ExportRecord";
                        window.location = ajaxurl;
                    }
                }
            }
