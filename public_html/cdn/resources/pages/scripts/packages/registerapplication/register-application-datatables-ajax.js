        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    {
                        "data": 4,
                        className: 'text-left Blogs_image_P_4',
                        "bSortable": false
                    },
                    {
                        "data": 5,
                        className: 'text-left Careers_hits_P_5',
                        "bSortable": false
                    }, {
                        "data": 6,
                        className: 'text-left Careers_order_P_6',
                        "name": 'intDisplayOrder'
                    }, {
                        "data": 7,
                        className: 'text-left form-switch Careers_publish_P_7',
                        "bSortable": false
                    }, {
                        "data": 8,
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/register-application/get_list", // ajax source
                },
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    {
                        "data": 2,
                        className: 'text-center Careers_title_P_2 mob-show_div',
                        "name": 'varStatus',
                        "bSortable": true
                    },
                    {
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/register-application/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "data": 5,
                        className: 'text-center form-switch Careers_publish_P_7',
                        "bSortable": false
                    }, {
                        "data": 6,
                        className: 'text-right Careers_dactions_P_9 last_td_action mob-show_div',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/register-application/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    {
                        "data": 3,
                        className: 'text-center Blogs_image_F_3',
                        "bSortable": false
                    },
                    {
                        "data": 4,
                        className: 'text-center Careers_hits_F_4',
                        "bSortable": false
                    },
                    {
                        "data": 5,
                        className: 'text-right Careers_dactions_F_7 last_td_action mob-show_div',
                        "bSortable": false
                    }, {
                        "data": 6,
                        className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/register-application/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[6]);
                },
    ...
    var handleRecords4 = function() {
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/register-application/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[7]);
                },
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/register-application/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
