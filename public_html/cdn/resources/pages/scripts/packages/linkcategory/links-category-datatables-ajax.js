        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    {
                        "data": 3,
                        className: 'text-left LinksCategory_order_P_5',
                        "name": 'intDisplayOrder'
                    }, {
                        "data": 4,
                        className: 'text-left form-switch LinksCategory_publish_P_6',
                        "bSortable": false
                    }, {
                        "data": 5,
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    {
                        "data": 2,
                        className: 'text-center form-switch LinksCategory_publish_D_6',
                        "bSortable": false
                    }, {
                        "data": 3,
