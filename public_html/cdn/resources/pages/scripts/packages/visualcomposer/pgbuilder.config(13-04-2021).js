...
var builder = function() {
    ...
    return {
                ...
                if ($(this).hasClass('img-rt-area')) {
                    ...
                    $(this).find('.column-list .col-row').each(function(col_row_index) {
                        ...
                        $(this).find('.ui-new-section-add .columns').each(function(col_index) {
                            ...
                            if ($('div[data-editor="' + col_id + '-element"]').hasClass('titleOnly')) {

                                var title = $('#' + col_id + '-element').val();
                                var eclass = $('#' + col_id + '-element').attr('data-class');
                                var elementObj = {
                                    type: 'only_title',
                                    val: {
                                        content: title,
                            ...
                            } else if ($('div[data-editor="' + col_id + '-element"]').hasClass('text-area')) {

                                var content = $('#' + col_id + '-element').val();
                                var eclass = $('#' + col_id + '-element').attr('data-class');
                            ...
                            } else if ($('div[data-editor="' + col_id + '-element"]').hasClass('img-area')) {

                                var img = $('#' + col_id + '-element').val();
                                var source = $('#' + col_id + '-element').prev().attr('src');
                                var caption = $('#' + col_id + '-element').data('caption');
                                var extra_class = $('#' + col_id + '-element').data('extra_class');
                                var data_width = $('#' + col_id + '-element').data('width');
                                var align = $('#' + col_id + '-element').data('type');
                            ...
                            } else if ($('div[data-editor="' + col_id + '-element"]').hasClass('img-document')) {
                                console.log('img-doc')
                                var img = $('#' + col_id + '-element').val();
                                var source = $('#' + col_id + '-element').prev().attr('src');
                                var caption = $('#' + col_id + '-element').data('caption');
                                var doc_date_time = $('#' + col_id + '-element').data('doc_date_time');
                            ...
                            } else if ($('div[data-editor="' + col_id + '-element"]').hasClass('buttonInfoOnly')) {

                                var txt = $('#' + col_id + '-element').val();
                                var caption = $('#' + col_id + '-element').data('caption');
                                var target = $('#' + col_id + '-element').data('linktarget');
                                var align = $('#' + col_id + '-element').data('type');
        ...
        licenceregisterTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class) {
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
        ...
        onlyTitle: function(val, extClass, edit) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                section += '<div>';
                section += '<a href="javascript:;" title="Edit" data-id="' + col_id + '-element" class="only-title">';
                section += '<i class="action-icon edit fa fa-pencil"></i>';
                section += '</a>';
                section += '<div class="clearfix"></div>';
                section += '<div class="ui-new-section-add titleOnly" data-editor="' + col_id + '-element">';
                section += '<div class="col-md-12">' + val + '</div>';
                section += '<input id="' + col_id + '-element" data-class="' + extClass + '" type="hidden" class="txtip" value="' + val1 + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
        ...
        addTextArea: function(val, extClass, edit) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                section += '<div>';
                section += '<a href="javascript:;" title="Edit" data-id="' + col_id + '-element" class="text-block">';
                section += '<i class="action-icon edit fa fa-pencil"></i>';
                section += '</a>';
                section += '<div class="clearfix"></div>';
                section += '<div class="ui-new-section-add text-area" data-editor="' + col_id + '-element">';
                section += '<div class="col-md-12">' + val + '</div>';
                section += '<input id="' + col_id + '-element" data-class="' + extClass + '" type="hidden" class="txtip" value="' + val1 + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
        ...
        addImage: function(imgsrc, val, imgCaption, extraClass, type, edit, folderid, data_width) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + col_id + '-element" class="only-image">';
                    section += '<i class="action-icon edit fa fa-pencil"></i>';
                    section += '</a>';
                    section += '<div class="clearfix"></div>';
                    section += '<div class="ui-new-section-add img-area" data-editor="' + col_id + '-element">';
                    ...
                    section += '<input id="' + col_id + '-element" data-caption="' + imgCaption + '" data-extra_class="' + extraClass + '" data-type="' + type + '" data-folderid="' + folderid + '" data-width="' + data_width + '" type="hidden" class="imgip" value="' + val + '"/>';
                    section += '</div>';
                    section += '</div>';
                    section += '</div>';
                    ...
                    //     section += '<i class="icon"><img height="45" title="Align Left" width="50" src="' + CDN_PATH + 'assets/images/packages/visualcomposer/image-left.png" alt=""></i>';
                    // } else if (type == 'image-rt-txt') {
                    //     section += '<i class="icon"><img height="45" title="Align Right" width="50" src="' + CDN_PATH + 'assets/images/packages/visualcomposer/image-right.png" alt=""></i>';
                    // } else if (type == 'image-center-txt') {
                    //     section += '<i class="icon"><img height="45" title="Align Top" width="50" src="' + CDN_PATH + 'assets/images/packages/visualcomposer/image-center.png" alt=""></i>';
                    // }
        ...
        addDocument: function(imgsrc, val, edit, folderid, caption, doc_date_time) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + col_id + '-element"   class="only-document">';
                    section += '<i class="action-icon edit fa fa-pencil"></i>';
                    section += '</a>';
                    section += '<div class="clearfix"></div>';
                    section += '<div class="ui-new-section-add img-document" data-editor="' + col_id + '-element">';
                    section += '<div class="docdatahtml"></div>';
                    section += '<input id="' + col_id + '-element"  type="hidden" class="imgip" data-caption="' + caption + '" data-doc_date_time="' + doc_date_time + '" data-folderid="' + folderid + '" value="' + val + '"/>';
                    section += '</div>';
                    section += '<div class="clearfix"></div>';
                    section += '</div>';
                    ...
                    $.ajax({
                        ...
                        success: function(html) {
                            $('#' + col_id + '-element').parents('div[data-editor="' + col_id + '-element"]').find(".docdatahtml").html(html);
                            $.loader.close(true);
                        }
                    });
                    ...
                    section += '<input id="' + col_id + '-element"  type="hidden" class="imgip" data-caption="' + caption + '" data-doc_date_time="' + doc_date_time + '" value="' + val + '"/>';
                    section += '<div class="docdatahtml"></div>';
                    section += '<div class="clearfix"></div>';
        ...
        onlySectionButton: function(val, linktarget, buttonlink, type, edit) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                if (edit == 'N') {
                    ...
                    section += '<a href="javascript:;" title="Edit" data-id="' + col_id + '-element" class="section-button">';
                    section += '<i class="action-icon edit fa fa-pencil"></i>';
                    section += '</a>';
                    section += '<div class="clearfix"></div>';
                    section += '<div class="ui-new-section-add buttonInfoOnly" data-editor="' + col_id + '-element">';
                    ...
                    section += '<input id="' + col_id + '-element" data-caption="' + val + '" data-linktarget="' + linktarget + '" data-type="' + type + '" type="hidden" class="txtip" value="' + buttonlink + '"/>';
                    section += '<div class="clearfix"></div>';
                    section += '</div>';
        ...
        submitFrmSectionLicenceRegisterModuleTemplate: function() {
            if ($('#frmSectionLicenceRegisterModuleTemplate').validate().form()) {
                ...
                var sectiondesc = $('#frmSectionLicenceRegisterModuleTemplate textarea[name=section_description]').val();
                var template = $('#frmSectionLicenceRegisterModuleTemplate input[name=template]').val();
                var config = $('#frmSectionLicenceRegisterModuleTemplate select[name=section_config]').val();
                var configTxt = $('#frmSectionLicenceRegisterModuleTemplate #config option:selected').text();
                var extra_class = $('#frmSectionLicenceRegisterModuleTemplate input[name=extra_class]').val();

                var layout = $('#frmSectionLicenceRegisterModuleTemplate select[name=layoutType]').val();
                builder.licenceregisterTemplate(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class);
        ...
        submitFrmSectionOnlyDocument: function() {
            if ($('#frmSectionOnlyDocument').validate().form()) {
                ...
                builder.addDocument(imgsrc, val, edit, folderid, caption, doc_date_time);
                builder.reInitSortable();
                $('#frmSectionOnlyDocument').find('.folder_1').val('');
                $('#frmSectionOnlyDocument').find('.imgip').val('');
        ...
        submitFrmAddColumn: function() {
            if ($('#frmAddColumns').validate().form()) {
                ...
                if (edit == 'Y') {
                    ...
                    var column_class = $('#frmAddColumns input[name=column_class]').val();
                    var animation = $('#frmAddColumns select[name=animation]').val();
                    builder.addColumns(no_of_column, column_class, animation);
        ...
        addColumns: function(no_of_column, column_class, animation) {
            ...
            for (i = 1; i <= no_of_column; i++) {
                ...
                section += '<div class="clearfix"></div>';
                section += '<div class="ui-new-section-add ' + editor + '-row-' + row_count + '-col-' + i + '">';
            ...
            $('.add-columns.clicked').prev().append(section);
        },
...
$(document).on('click', '.only-title', function(event) {
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        var extclass = $('#' + id + '-element').data('class');
        $('#sectionTitle input[name=editing]').val('Y');
...
$(document).on('click', '.section-button', function(event) {
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        if (id != '' && id != undefined) {
            var caption = $('#' + id + '-element').data('caption');
            var target = $('#' + id + '-element').data('linktarget');
            var align = $('#' + id + '-element').data('type');
            var value = $('#' + id + '-element').val();
...
$(document).on('click', '.add-row', function(event) {
    ...
    section += '<a href="javascript:;" class="add-icon add-columns"><i class="fa fa-plus" aria-hidden="true"></i></a>';
...
$(document).on('click', '.add-columns', function(event) {
    ...
    $('#frmAddColumns input[name=sectionid]').val('');
