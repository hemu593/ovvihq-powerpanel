    ...
    return {
        ...
        fillFormObj: function() {
            ...
            $('.section-item').each(function() {
                ...
                if ($(this).hasClass('img-rt-area')) {
                    ...
                    var txt = $(this).find('.txtip').val();
                    var eclass = $(this).find('.txtip').data('class');
                    var headingtype = $(this).find('.txtip').data('headingtype');
                    var obj = {
                        type: 'only_title',
                        val: {
                            content: txt,
                    ...
                    var catname = $(this).find('.txtip').data('cname');
                ...
                } else if ($(this).hasClass('decisionTemplate')) {
                    ...
                    var type = $(this).find('.txtip').data('type');
                    var extra_class = $(this).find('.txtip').data('class');
                    var decisioncat = $(this).find('.txtip').data('decisioncat');
                    var sectorType = $(this).find('input[type=hidden]').data('sector');
                    var obj = {
                        type: 'decision_template',
                        val: {
                            title: caption,
                            limit: slimit,
                            class: extra_class,
                    ...
                    var sdesc = $(this).find('.txtip').data('sdesc');
                    var type = $(this).find('.txtip').data('type');
                    var extclass = $(this).find('.txtip').data('class');
                    ...
                    $(this).find('.column-list .col-row').each(function(col_row_index) {
                        ...
                        var column_row_width = $('input[data-id="' + col_row_id + '"]').attr('data-column-row-width');
                        ...
                        obj['val'][col_row_index] = {
                            ...
                            column_row_width: column_row_width
                        };
                        ...
                        $(this).find('.ui-new-section-add .columns').each(function(col_index) {
                            ...
                            var col_width = $('input[data-id="' + col_id + '"]').attr('data-width');
                            ...
                            $('.' + col_id + ' .cms-element').each(function(element_index) {
                                ...
                                if ($('div[data-editor="' + ele_id + '"]').hasClass('titleOnly')) {
                                    ...
                                    var headingtype = $('#' + ele_id).attr('data-headingtype');
                                    ...
                                    var txt = $('#' + ele_id).val();
                                    var extclass = $('#' + ele_id).data('extclass');
                                    var caption = $('#' + ele_id).data('caption');
        ...
        spacerTemplate: function(config, edit, configTxt) {
            ...
            if (edit == 'N') {
                ...
                section += '<i class="action-icon edit ri-pencil-fill"></i>';
                section += '</a>';
        ...
        eventsTemplate: function(val, sectionlimit, template, edit, extra_class, eventscat, categoryName) {

            let manageRecordURL = baseURL + 'events';
            if (eventscat.trim() != '' && eventscat != null) {
                manageRecordURL = baseURL + 'events?category=' + eventscat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<div class="col-md-12"><label><b>' + val + '</b></label> <a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a> </div>';
                ...
                if (str != '' && str != 'undefined') {
                    section += '<div class="col-md-12"><b>Category:</b>' + str + '</div>';
                }

                if (sectionlimit != '' && typeof sectionlimit != 'undefined') {
                    section += '<div class="col-md-12"><b>Limit:</b>' + sectionlimit + '</div>';
                }
                section += '<input id="' + iCount + '"  data-type="' + template + '" data-class="' + extra_class + '" data-cname="' + categoryName + '" data-slimit="' + sectionlimit + '" data-eventscat="' + eventscat + '" module="events"  type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '" data-type="' + template + '"  data-class="' + extra_class + '" module="events" data-cname="' + categoryName + '" data-slimit="' + sectionlimit + '" data-eventscat="' + eventscat + '"  type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        careerTemplate: function(val, sectionlimit, sectiondesc, extra_class, template, edit) {
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<div class="col-md-12"><b>Description:</b><label>' + sectiondesc + '</label></div>';
                section += '<div class="col-md-12"><b>Limit:</b><label>' + sectionlimit + '</label></div>';
                section += '<input id="' + iCount + '" data-class="' + extra_class + '"  data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<div class="col-md-12"><b>Description:</b><label>' + sectiondesc + '</label></div>';
                section += '<div class="col-md-12"><b>Limit:</b><label>' + sectionlimit + '</label></div>';
                section += '<input id="' + edit + '" data-class="' + extra_class + '" data-type="' + template + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        newsTemplate: function(val, sectionlimit, template, edit, extra_class) {
            let manageRecordURL = baseURL + 'news';
            ...
            if (edit == 'N') {
                ...
                section += '<input id="' + iCount + '"  data-type="' + template + '" data-class="' + extra_class + '"  data-slimit="' + sectionlimit + '"   module="news" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '"  data-type="' + template + '" data-class="' + extra_class + '"  data-slimit="' + sectionlimit + '"    module="news" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        publicRecordTemplate: function(val, sectionlimit, template, edit, extra_class, newscat, categoryName) {
            console.log('newscat', newscat);
            let manageRecordURL = baseURL + 'public-record';
            if (newscat.trim() != '' && newscat != null) {
                manageRecordURL = baseURL + 'public-record?category=' + newscat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input id="' + iCount + '"  data-type="' + template + '" data-class="' + extra_class + '" data-cname="' + categoryName + '"  data-slimit="' + sectionlimit + '"  data-newscat="' + newscat + '" module="public-record" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '"  data-type="' + template + '" data-class="' + extra_class + '" data-cname="' + categoryName + '" data-slimit="' + sectionlimit + '" data-newscat="' + newscat + '" module="public-record" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        latestNewsTemplate: function(val, template, edit, extra_class) {
            ...
            if (edit == 'N') {
                ...
                section += '<div class="col-md-12"><label><b>' + val + '</b></label> <a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a> </div>';
                section += '<input id="' + iCount + '" data-type="' + template + '" module="news" data-class="' + extra_class + '"   type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
        ...
        QuickLinkTemplate: function(val, template, edit, extra_class, startdate, enddate) {
            let manageRecordURL = baseURL + 'quick-links';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="quick-links" id="' + iCount + '" data-type="' + template + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-class="' + extra_class + '"   type="hidden" class="txtip" value="' + val + '"/>';
                ...
                section += '<input module="quick-links" id="' + edit + '" data-type="' + template + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-class="' + extra_class + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        interconnectionsTemplate: function(val, parentorg, template, extraclass, edit, categoryName, sector) {
            let manageRecordURL = baseURL + 'interconnections';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                var stro = sector;
                var res = stro.toUpperCase(sector);
                if (res != '' && res != 'undefined') {
                    section += '<div class="col-md-12"><b>Sector:</b>' + res + '</div>';
                }

                section += '<input module="interconnections" id="' + iCount + '" data-cname="' + categoryName + '" data-type="' + template + '" data-sector="' + sector + '" data-parentorg="' + parentorg + '" data-orgclass="' + extraclass + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="interconnections" id="' + edit + '" data-type="' + template + '" data-sector="' + sector + '" data-cname="' + categoryName + '" data-parentorg="' + parentorg + '" data-orgclass="' + extraclass + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        linkTemplate: function(val, sectionlimit, extra_class, template, edit, startdate, enddate, linkcat) {
            let manageRecordURL = baseURL + 'links-category';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="links-category" id="' + iCount + '" data-class="' + extra_class + '" data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-linkcat="' + linkcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="links-category" id="' + edit + '" data-class="' + extra_class + '" data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-linkcat="' + linkcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        faqTemplate: function(val, sectionlimit, extra_class, template, edit, startdate, enddate, faqcat, categoryName) {
            let manageRecordURL = baseURL + 'faq';
            if (faqcat.trim() != '' && faqcat != null) {
                manageRecordURL = baseURL + 'faq?category=' + faqcat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input module="faq" id="' + iCount + '" data-cname="' + categoryName + '" data-class="' + extra_class + '" data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-faqcat="' + faqcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="faq" id="' + edit + '" data-class="' + extra_class + '" data-cname="' + categoryName + '" data-type="' + template + '"  data-slimit="' + sectionlimit + '" data-faqcat="' + faqcat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        blogsTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class, startdate, enddate, blogscat) {
            let manageRecordURL = baseURL + 'blogs';
            if (blogscat.trim() != '' && blogscat != null) {
                manageRecordURL = baseURL + 'blogs?category=' + blogscat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-blogscat="' + blogscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" module="blogs" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-blogscat="' + blogscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" module="blogs" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        numberAllocationsTemplate: function(val, sectionlimit, template, edit, extra_class) {
            let manageRecordURL = baseURL + 'number-allocation';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="number-allocation" id="' + iCount + '" data-type="' + template + '" data-class="' + extra_class + '" data-slimit="' + sectionlimit + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="number-allocation" id="' + edit + '" data-type="' + template + '" data-class="' + extra_class + '" data-slimit="' + sectionlimit + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        serviceTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class, servicecat) {
            let manageRecordURL = baseURL + 'service';
            if (servicecat.trim() != '' && servicecat != null) {
                manageRecordURL = baseURL + 'service?category=' + servicecat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input module="service" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-servicecat="' + servicecat + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="service" id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-servicecat="' + servicecat + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        candwserviceTemplate: function(val, sectionlimit, template, edit, extra_class) {
            let manageRecordURL = baseURL + 'candwservice';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="candwservice" id="' + iCount + '"  data-type="' + template + '" data-class="' + extra_class + '"  data-slimit="' + sectionlimit + '"  type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="candwservice" id="' + edit + '"  data-type="' + template + '" data-class="' + extra_class + '"   data-slimit="' + sectionlimit + '"  type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        consultationsTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class, startdate, enddate, blogscat) {
            let manageRecordURL = baseURL + 'consultations';
            if (blogscat.trim() != '' && blogscat != null) {
                manageRecordURL = baseURL + 'consultations?category=' + blogscat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input module="consultations" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-blogscat="' + blogscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="consultations" id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-blogscat="' + blogscat + '" data-sdate="' + startdate + '" data-edate="' + enddate + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        complaintservicesTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class) {
            let manageRecordURL = baseURL + 'complaint-services';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="complaint-services" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="complaint-services" id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        fmbroadcastingTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class) {
            let manageRecordURL = baseURL + 'fmbroadcasting';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="fmbroadcasting" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="fmbroadcasting" id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        boardofdirectorsTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class) {
            let manageRecordURL = baseURL + 'boardofdirectors';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="boardofdirectors" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="boardofdirectors" id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        registerapplicationTemplate: function(val, sectionlimit, template, edit, extra_class) {
            let manageRecordURL = baseURL + 'register-application';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="register-application" id="' + iCount + '" data-type="' + template + '" data-class="' + extra_class + '" data-slimit="' + sectionlimit + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="register-application" id="' + edit + '" data-class="' + extra_class + '" data-slimit="' + sectionlimit + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        licenceregisterTemplate: function(val, sectionlimit, sector, template, edit, sectorTxt, extra_class) {
            ...
            let manageRecordURL = baseURL + 'licence-register';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                var str = sector;
                var res = str.toUpperCase(sector);
                if (res != '' && res != 'undefined') {
                    section += '<div class="col-md-12"><b>Sector:</b>' + res + '</div>';
                }
                ...
                section += '<input module="licence-register" id="' + iCount + '" data-type="' + template + '" data-class="' + extra_class + '" data-sector="' + sector + '" data-slimit="' + sectionlimit + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="licence-register" id="' + edit + '" data-type="' + template + '" data-class="' + extra_class + '" data-sector="' + sector + '" data-slimit="' + sectionlimit + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        formsandfeesTemplate: function(val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout, extra_class) {
            let manageRecordURL = baseURL + 'forms-and-fees';
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                section += '<div class="ui-state-default">';
                ...
                section += '<input module="forms-and-fees" id="' + iCount + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="forms-and-fees" id="' + edit + '" data-layout="' + layout + '" data-type="' + template + '" data-class="' + extra_class + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-sdesc="' + sectiondesc + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },

        publicationTemplate: function(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, publicationscat, categoryName) {
            let manageRecordURL = baseURL + 'publications';
            if (publicationscat.trim() != '' && publicationscat != null) {
                manageRecordURL = baseURL + 'publications?category=' + publicationscat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<input module="publications" id="' + iCount + '" data-sector="' + sector + '" data-cname="' + categoryName + '"  data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-publicationscat="' + publicationscat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="publications" id="' + edit + '" data-sector="' + sector + '" data-cname="' + categoryName + '" data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-publicationscat="' + publicationscat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        decisionTemplate: function(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, decisioncat, categoryName) {
            let manageRecordURL = baseURL + 'decision';
            if (decisioncat.trim() != '' && decisioncat != null) {
                manageRecordURL = baseURL + 'decision?category=' + decisioncat;
            }
            var section = '';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<i class="action-icon delete ri-delete-bin-line"></i>';
                section += '</a>';
                section += '<a href="javascript:;" data-filter="' + template + '" title="Edit" data-id="' + iCount + '" class="decision-template">';
                section += '<i class="action-icon edit ri-pencil-fill"></i>';
                section += '</a>';
                section += '<div class="clearfix"></div>';
                section += '<div class="defoult-module section-item decisionTemplate" data-editor="' + iCount + '">';
                section += '<div class="col-md-12"><label><b>' + val + '</b></label><a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a></div>';
                ...
                section += '<input module="decision" id="' + iCount + '" data-sector="' + sector + '" data-cname="' + categoryName + '" data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-decisioncat="' + decisioncat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                section += '</div>';
                ...
                section += '<input module="decision" id="' + edit + '" data-sector="' + sector + '" data-cname="' + categoryName + '"   data-class="' + extra_class + '" data-type="' + template + '" data-config="' + config + '" data-slimit="' + sectionlimit + '" data-decisioncat="' + decisioncat + '" type="hidden" class="txtip" value="' + val + '"/>';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        TwoColumns: function() {
            ...
            section += '<div class="ui-new-section-add add-element hidecol" data-innerplus="two_col_1"><a href="javascript:;"  data-innerplus="two_col_1" class="add-icon add-element"><i class="ri-add-fill" aria-hidden="true"></i></a></div>';
            ...
            section += '<div class="ui-new-section-add add-element hidecol" data-innerplus="two_col_2"><a href="javascript:;" data-innerplus="two_col_2" class="add-icon add-element"><i class="ri-add-fill" aria-hidden="true"></i></a></div>';
            section += '<div class="twocol1"></div>';
            section += '</div>';
            section += '</div></div>';
            section += '</div>';
        ...
        ThreeColumns: function() {
            ...
            section += '<div class="ui-new-section-add add-element hidecol" data-innerplus="two_col_3"><a href="javascript:;" data-innerplus="two_col_3" class="add-icon add-element"><i class="ri-add-fill" aria-hidden="true"></i></a></div>';
            section += '<div class="twocol1"></div>';
            section += '</div>';
            section += '</div>';
        ...
        FourColumns: function() {
            ...
            section += '<div class="ui-new-section-add add-element hidecol" data-innerplus="two_col_4"><a href="javascript:;" data-innerplus="two_col_4" class="add-icon add-element"><i class="ri-add-fill" aria-hidden="true"></i></a></div>';
            section += '<div class="twocol1"></div>';
            section += '</div>';
            section += '</div>';
        ...
        onlyTitle: function(val, extClass, edit, headingtype) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                if (edit != 'N') {
                    ...
                    section += '<input id="' + edit + '" data-class="' + extClass + '" data-headingtype ="' + headingtype + '" type="hidden" class="txtip" value="' + val1 + '"/>';
                    section += '<div class="clearfix"></div>';
                    ...
                    section += '<div class="col-md-12">' + val + '</div>';
                    section += '<input id="' + col_id + '-element-' + ele_count + '" data-class="' + extClass + '" data-headingtype ="' + headingtype + '" type="hidden" class="txtip" value="' + val1 + '"/>';
                    section += '<div class="clearfix"></div>';
                    section += '</div>';
                    section += '</div>';
                ...
                if (edit == 'N') {
                    ...
                    section += '<div class="col-md-12">' + val + '</div>';
                    section += '<input id="' + iCount + '" data-class="' + extClass + '" data-headingtype ="' + headingtype + '" type="hidden" class="txtip" value="' + val1 + '"/>';
                    section += '<div class="clearfix"></div>';
                    section += '</div>';
                    section += '</div>';
        ...
        onlySectionButton: function(val, linktarget, buttonlink, type, edit, extclass) {
            ...
            if ($('.add-cms-block').hasClass('clicked')) {
                ...
                if (edit != 'N') {
                    ...
                    section += '</div>';
                    section += '<div class="clearfix"></div>';
                    section += '<input id="' + edit + '" data-caption="' + val + '" data-linktarget="' + linktarget + '" data-extclass="' + extclass + '" data-type="' + type + '" type="hidden" class="txtip" value="' + buttonlink + '"/>';
                    section += '<div class="clearfix"></div>';
                    ...
                    section += '</div>';
                    section += '<div class="clearfix"></div>';
                    section += '<input id="' + col_id + '-element-' + ele_count + '" data-caption="' + val + '" data-linktarget="' + linktarget + '" data-extclass="' + extclass + '" data-type="' + type + '" type="hidden" class="txtip" value="' + buttonlink + '"/>';
                    section += '<div class="clearfix"></div>';
                    section += '</div>';
                    section += '</div>';
                ...
                if (edit == 'N') {
                    ...
                    section += '<input id="' + iCount + '" data-caption="' + val + '" data-linktarget="' + linktarget + '" data-extclass="' + extclass + '" data-type="' + type + '" type="hidden" class="txtip" value="' + buttonlink + '"/>';
                    section += '<div class="clearfix"></div>';
                    section += '</div>';
                    section += '</div>';
                    ...
                    section += '<input id="' + edit + '" data-caption="' + val + '" data-linktarget="' + linktarget + '" data-type="' + type + '" type="hidden" class="txtip" data-extclass="' + extclass + '" value="' + buttonlink + '"/>';
                    section += '<div class="clearfix"></div>';
                    $('#section-container').find('div[data-editor=' + edit + ']').html(section);
                }
            }
        ...
        addCustomSection: function(title, template, extclass, layoutType, subtitle) {
            ...
            if (edit == 'N') {
                ...
                section += '<i class="ri-add-fill"></i>&nbsp;Add custom record';
                section += '</a>';
                section += '</div>';
        ...
        addCustomRecord: function(sectionid, imgid, imgsrc, title, link, desc, edit) {
            ...
            if (typeof edit == 'undefined' || edit == '') {
                ...
                section += title;
                section += '<a href="javascript:;" data-id="' + sectionid + '" data-img="' + imgid + '" data-imgsrc="' + imgsrc + '" data-title="' + title + '" data-link="' + link + '" data-desc="' + desc + '" data-mode="edit" class="add-custom-record" title="edit"> <i class="ri-pencil-fill" aria-hidden="true"></i> </a>';
                section += '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a>';
                section += '</li>';
        ...
        onlyVideo: function(val, title, videoType, edit) {
            ...
            var vidIco = videoType == 'Vimeo' ?
                '<a title="' + val + '" target="_blank" href="' + val + '"><i class="ri-video-fill" aria-hidden="true"></i></a>' :
                '<a title="' + val + '" target="_blank" href="' + val + '"><i class="ri-youtube-fill" aria-hidden="true"></i></a>';
        ...
        addGalleryImage: function(images, imgPosition, edit) {
            ...
            if (edit == 'N') {
                ...
                $.each(images, function(index, value) {
                    section += '<li data-id="' + index + '" id="' + index + '-item-' + iCount + '"><img height="50" width="50" src="' + value + '"/><a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
                section += '</div>';
        ...
        moduleSectionsEvents: function(caption, recids, recTitle, edit, template, extraclass) {
            let manageRecordURL = baseURL + 'events';
            var section = '';
            var customize = '<a href="javascript:;" data-module="events" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '<div class="col-md-12">';
                section += '<label><b>' + caption + '</b>&nbsp;</label> <a class="" target="_blank" title="Manage Records" href="' + manageRecordURL + '">Manage Records</a>';
                section += '<ul class="record-list">';
                $.each(recids, function(index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + iCount + '">' + recTitle[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
                section += '<a data-id="' + iCount + '" data-filter="' + template + '" title="Add more" class="add-link events-module" href="javascript:;">';
                section += '<i class="ri-add-fill"></i>&nbsp;Add more';
                section += '</a>';
                section += '</div>';
                section += '<input module="events" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-extraclass="' + extraclass + '" data-caption="' + caption + '" data-type="module" value="events" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                $.each(eventsIds, function(index, value) {
                    section += '<li data-customized="' + eventsCustomized[index] + '" data-img="' + eventsImg[index] + '" data-imgsrc="' + eventsImgSrc[index] + '" data-imgheight="' + eventsImgheight[index] + '" data-imgwidth="' + eventsImgwidth[index] + '" data-imgpoint="' + eventsImgpoint[index] + '" data-phone="' + eventsPhone[index] + '" data-email="' + eventsEmail[index] + '" data-website="' + eventsWebsite[index] + '" data-address="' + eventsAddress[index] + '" data-description="' + eventsDescription[index] + '" data-id="' + value + '" id="' + value + '-item-' + edit + '">' + eventsTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="events" id="' + edit + '" data-filter="' + template + '" type="hidden"  data-extraclass="' + extraclass + '"  data-caption="' + caption + '" data-type="module" value="events" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsPhotoAlbum: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="photoalbum" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
        ...
        moduleSectionsVideoAlbum: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="videoalbum" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
        ...
        moduleSectionsBlogs: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'blogs';
            var section = '';
            var customize = '<a href="javascript:;" data-module="blogs" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
        ...
        moduleSectionsService: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'service';
            var section = '';
            var customize = '<a href="javascript:;" data-module="service" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="service" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="service" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="service"  id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="service" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsCandWService: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'candwservice';
            var section = '';
            var customize = '<a href="javascript:;" data-module="candwservice" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="candwservice" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="candwservice" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="candwservice" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="candwservice" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        moduleSectionsConsultations: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'consultations';
            var section = '';
            var customize = '<a href="javascript:;" data-module="consultations" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="consultations" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="consultations" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="consultations" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="consultations" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },

        moduleSectionsComplaintServices: function(caption, recids, recTitle, edit, template, extraclass) {
            let manageRecordURL = baseURL + 'complaint-services';
            var section = '';
            var customize = '<a href="javascript:;" data-module="complaint-services" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="complaint-services" id="' + iCount + '" data-filter="' + template + '" type="hidden"  data-extraclass="' + extraclass + '"  data-caption="' + caption + '" data-type="module" value="complaint-services" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="complaint-services" id="' + edit + '" data-filter="' + template + '" type="hidden"  data-extraclass="' + extraclass + '"  data-caption="' + caption + '" data-type="module" value="complaint-services" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsFMBroadcasting: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'fmbroadcasting';
            var section = '';
            var customize = '<a href="javascript:;" data-module="fmbroadcasting" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="fmbroadcasting" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="fmbroadcasting" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="fmbroadcasting" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="fmbroadcasting" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsBoardofDirectors: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'boardofdirectors';
            var section = '';
            var customize = '<a href="javascript:;" data-module="boardofdirectors" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="boardofdirectors" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="boardofdirectors" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="boardofdirectors" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="boardofdirectors" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsRegisterofApplications: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'register-application';
            var section = '';
            var customize = '<a href="javascript:;" data-module="register-application" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="register-application" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="register-application" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="register-application" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="register-application" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsLicenceRegister: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            let manageRecordURL = baseURL + 'licence-register';
            var section = '';
            var customize = '<a href="javascript:;" data-module="licence-register" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="licence-register" id="' + iCount + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="licence-register" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="licence-register" id="' + edit + '" data-filter="' + template + '" type="hidden" data-config="' + config + '" data-layout="' + layoutType + '" data-extraclass="' + extraclass + '" data-desc="' + desc + '" data-caption="' + caption + '" data-type="module" value="licence-register" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsFormsandFees: function(caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="forms-and-fees" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
        ...
        moduleSectionsPublication: function(caption, desc, recids, recTitle, edit, template, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="publication" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
        ...
        moduleSectionsPromotions: function(caption, config, configTxt, recids, recTitle, edit, template, layoutType) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="promotion" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                $.each(promotionsIds, function(index, value) {
                    section += '<li data-customized="' + promotionsCustomized[index] + '" data-img="' + promotionsImg[index] + '" data-imgsrc="' + promotionsImgSrc[index] + '" data-imgheight="' + promotionsImgheight[index] + '" data-imgwidth="' + promotionsImgwidth[index] + '" data-imgpoint="' + promotionsImgpoint[index] + '" data-phone="' + promotionsPhone[index] + '" data-email="' + promotionsEmail[index] + '" data-website="' + promotionsWebsite[index] + '" data-address="' + promotionsAddress[index] + '" data-description="' + promotionsDescription[index] + '" data-id="' + value + '" id="' + value + '-item-' + edit + '">' + promotionsTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsNews: function(caption, recids, recTitle, edit, template, extraclass) {
            let manageRecordURL = baseURL + 'news';
            var section = '';
            var customize = '<a href="javascript:;" data-module="news" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input id="' + iCount + '" module="news" type="hidden" data-filter="' + template + '" data-extraclass="' + extraclass + '"  data-caption="' + caption + '"  data-type="module" value="news" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                $.each(newsIds, function(index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + newsTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input id="' + edit + '" type="hidden" data-filter="' + template + '"  data-extraclass="' + extraclass + '"  data-caption="' + caption + '"  data-type="module" module="news" value="news" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        moduleSectionsAlerts: function(caption, recids, recTitle, edit, template, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="alerts" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                $.each(alertsIds, function(index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + alertsTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsLinks: function(caption, recids, recTitle, edit, template, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="links" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                $.each(linksIds, function(index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + linksTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsFaqs: function(caption, recids, recTitle, edit, template, extraclass) {
            let manageRecordURL = baseURL + 'faq';
            var section = '';
            var customize = '<a href="javascript:;" data-module="faqs" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="faq" id="' + iCount + '" type="hidden" data-filter="' + template + '" data-extraclass="' + extraclass + '" data-caption="' + caption + '"  data-type="module" value="faqs" />';
                section += '<div class="clearfix"></div>';
                section += '</div>';
                ...
                section += '</a>';
                section += '</div>';
                section += '<input module="faq" id="' + edit + '" type="hidden" data-filter="' + template + '" data-extraclass="' + extraclass + '" data-caption="' + caption + '" data-type="module" value="faqs" />';
                section += '<div class="clearfix"></div>';
                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
            }
        },
        ...
        moduleSectionsDepartment: function(caption, recids, recTitle, edit, template, extraclass) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="department" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                $.each(departmentIds, function(index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + departmentTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsArticles: function(caption, config, configTxt, recids, recTitle, edit, template, layoutType, featuredRestaurant) {
            var section = '';
            var customize = '<a href="javascript:;" data-module="articles" class="customize-icon" title="Customize"> <i class="ri-settings-3-fill" aria-hidden="true"></i> </a>';
            if (edit == 'N') {
                var iCount = 'item-' + ($('.ui-state-default').length + 1);
                ...
                $.each(articlesIds, function(index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + articlesTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="ri-time-fill" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        submitFrmSectionEventsModuleTemplate: function() {
            if ($('#frmSectionEventsModuleTemplate').validate().form()) {
                ...
                var cName = $('#frmSectionEventsModuleTemplate .eventCategory').find(":selected").text();
                if (cName == 'Select CategorySelect Category') {
                    categoryName = '';
                } else {
                    var categoryName = cName.replace("Select Category", " ");
                }
                builder.eventsTemplate(val, sectionlimit, template, edit, extra_class, eventscat, categoryName);
        ...
        submitFrmSectionCareerModuleTemplate: function() {
            if ($('#frmSectionCareerModuleTemplate').validate().form()) {
                ...
                var sectionlimit = $('#frmSectionCareerModuleTemplate input[name=section_limit]').val();
                var sectiondesc = $('#frmSectionCareerModuleTemplate textarea[name=section_description]').val();
                ...
                builder.careerTemplate(val, sectionlimit, sectiondesc, extra_class, template, edit);
        ...
        submitFrmSectionCandWServiceModuleTemplate: function() {
            if ($('#frmSectioncandwserviceModuleTemplate').validate().form()) {
                ...
                builder.candwserviceTemplate(val, sectionlimit, template, edit, extra_class);
        ...
        submitFrmSectionLicenceRegisterModuleTemplate: function() {
            if ($('#frmSectionLicenceRegisterModuleTemplate').validate().form()) {
                ...
                var sector = $('#frmSectionLicenceRegisterModuleTemplate select[name=sector]').val();
        ...
        submitFrmSectionPublicationModuleTemplate: function() {
            if ($('#frmSectionPublicationModuleTemplate').validate().form()) {
                ...
                var categoryName = $('#frmSectionPublicationModuleTemplate select[name=publicationscat]').find(":selected").text();
                if (categoryName == 'Select Category') {
                    categoryName = '';
                }
                var publicationscat = $('#frmSectionPublicationModuleTemplate select[name=publicationscat]').val();
                var sector = $('#frmSectionPublicationModuleTemplate select[name=sectortype]').val();
                builder.publicationTemplate(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, publicationscat, categoryName);
                $('#sectionPublicationModuleTemplate').modal('hide');
            }
        },
        submitFrmSectionDecisionModuleTemplate: function() {
            if ($('#frmSectionDecisionModuleTemplate').validate().form()) {
                var edit = $('#frmSectionDecisionModuleTemplate input[name=editing]').val() != '' ? $('#frmSectionDecisionModuleTemplate input[name=editing]').val() : 'N';
                $('#no-content').addClass('d-none');
                $('#has-content').removeClass('d-none');
                var val = $('#frmSectionDecisionModuleTemplate input[name=section_title]').val();
                var sectionlimit = $('#frmSectionDecisionModuleTemplate input[name=section_limit]').val();

                var template = $('#frmSectionDecisionModuleTemplate input[name=template]').val();
                var config = $('#frmSectionDecisionModuleTemplate select[name=section_config]').val();
                var configTxt = $('#frmSectionDecisionModuleTemplate #config option:selected').text();
                var extra_class = $('#frmSectionDecisionModuleTemplate input[name=extra_class]').val();

                var decisioncat = $('#frmSectionDecisionModuleTemplate select[name=decisioncat]').val();
                var categoryName = $('#frmSectionDecisionModuleTemplate select[name=decisioncat]').find(":selected").text();
                if (categoryName == 'Select Category') {
                    categoryName = '';
                }
                var sector = $('#frmSectionDecisionModuleTemplate select[name=sectortype]').val();
                builder.decisionTemplate(val, sectionlimit, config, template, edit, configTxt, sector, extra_class, decisioncat, categoryName);
                $('#sectionDecisionModuleTemplate').modal('hide');
            }
        },
        ...
        submitFrmSectionNewsModuleTemplate: function() {
            if ($('#frmSectionNewsModuleTemplate').validate().form()) {
                ...
                builder.newsTemplate(val, sectionlimit, template, edit, extra_class);
        ...
        submitFrmSectionPublicRecordModuleTemplate: function() {
            if ($('#frmSectionPublicRecordModuleTemplate').validate().form()) {
                ...
                var categoryName = $('#frmSectionPublicRecordModuleTemplate select[name=newscat]').find(":selected").text();
                if (categoryName == 'Select Category') {
                    categoryName = '';
                }
                //                var layout = $('#frmSectionPublicRecordModuleTemplate select[name=layoutType]').val();
                builder.publicRecordTemplate(val, sectionlimit, template, edit, extra_class, newscat, categoryName);
        ...
        submitFrmSectionInterconnectionsModuleTemplate: function() {
            if ($('#frmSectionInterconnectionsModule').validate().form()) {
                ...
                var categoryName = $('#frmSectionInterconnectionsModule select[name=parentorg]').find(":selected").text();
                if (categoryName == 'Select Category') {
                    categoryName = '';
                }
                var sector = $('#frmSectionInterconnectionsModule select[name=sectortype]').val();
                builder.interconnectionsTemplate(val, parentorg, template, extraclass, edit, categoryName, sector);
        ...
        submitFrmSectionFaqsModuleTemplate: function() {
            if ($('#frmSectionFaqsModuleTemplate').validate().form()) {
                ...
                var categoryName = $('#frmSectionFaqsModuleTemplate select[name=faqcat]').find(":selected").text();
                if (categoryName == 'Select Category') {
                    categoryName = '';
                }
                builder.faqTemplate(val, sectionlimit, extra_class, template, edit, startdate, enddate, faqcat, categoryName);
        ...
        submitFrmSectionTitle: function() {
            if ($('#frmSectionTitle').validate().form()) {
                ...
                var headingtype = $('#frmSectionTitle #heading_layout_type').val();
                builder.onlyTitle(val, extClass, edit, headingtype);
                builder.reInitSortable();
        ...
        submitFrmSectionButton: function() {
            if ($('#frmSectionButton').validate().form()) {
                ...
                var extclass = $('#frmSectionButton input[name=extra_class_only_btn]').val();
                ...
                builder.onlySectionButton(val, linktarget, buttonlink, type, edit, extclass);
                builder.reInitSortable();
        ...
        submitFrmSectionEventsModule: function() {
            if ($('#frmSectionEventsModule').validate().form()) {
                ...
                builder.moduleSectionsEvents(imgCaption, recids, recTitle, edit, template, extraclass);
                builder.reInitSortable();
        ...
        submitFrmSectionComplaintServicesModule: function() {
            if ($('#frmSectionComplaintServicesModule').validate().form()) {
                ...
                builder.moduleSectionsComplaintServices(imgCaption, recids, recTitle, edit, template, extraclass);
                builder.reInitSortable();
        ...
        submitFrmSectionNewsModule: function() {
            if ($('#frmSectionNewsModule').validate().form()) {
                ...
                var recids = [];
                var recTitle = [];
                builder.moduleSectionsNews(imgCaption, recids, recTitle, edit, template, extraclass);
                builder.reInitSortable();
        ...
        submitFrmEditColRow: function(item_id) {
            ...
            if ($('#frmEditColRow').validate().form()) {
                ...
                var checkbox = $('input[name="column_row_width"]:checked').length;

                if (checkbox == 0) {
                    var column_row_width = "F";
                } else {
                    var column_row_width = "T";
                }

                // if ($('input[name="column_row_width"]:checked').length > 0) {
                //     var column_row_width = $('#column_row_width').attr('checked', true);
                // } else {
                //     var column_row_width = $('#column_row_width').attr('checked', false);
                // }
                ...
                $('input[data-id="' + item_id + '"]').attr('data-column-row-width', column_row_width);
        ...
        addColumns: function(sectionid, no_of_column, column_class, animation) {
            ...
            section += '<a href="javascript:;" data-id="' + editor + '-row-' + row_count + '"  class="delete-col-row" title="Delete"><i class="action-icon delete ri-delete-bin-line"></i></a>';
            section += '<a href="javascript:;" data-id="' + editor + '-row-' + row_count + '"  class="edit-col-row" title="Delete"><i class="action-icon edit ri-pencil-fill"></i></a>';
            ...
            for (i = 1; i <= no_of_column; i++) {
                ...
                section += '<a href="javascript:;" data-id="' + editor + '-row-' + row_count + '-col-' + i + '" class="delete-column" title="Delete"><i class="action-icon delete ri-delete-bin-line"></i></a>';
                section += '<a href="javascript:;" data-editor="' + editor + '-row-' + row_count + '-col-' + i + '" class="edit-column" title="Edit"><i class="action-icon edit ri-pencil-fill"></i></a>';
                section += '<div class="clearfix"></div>';
                section += '<div class="ui-new-section-add ' + editor + '-row-' + row_count + '-col-' + i + '"><strong> Column ' + i + '</strong></div>';
                section += '<a href="javascript:;" data-id="' + editor + '-row-' + row_count + '-col-' + i + '" class="add-icon add-cms-block"><i class="ri-add-fill" aria-hidden="true"></i></a>';
...
$(document).on('click', '#insert_document', function() {
    $('.gallary_manager').css('display', 'none');
});
...
$(document).on('click', '.formsandfees_tab', function(event) {
    $('#formsandfees .forms-and-fees').addClass('hide');
})
...
$(document).on('click', '.add-element', function(event) {
    ...
    if (moduleID != undefined && moduleID != '') {
        showModuleWiseBlocks(moduleID);
    } else {
        showModuleWiseBlocks(3);
    }
...
$(document).on('click', '.only-title', function(event) {
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        var headingtype = $('.titleOnly #' + id).data('headingtype');

        $('#sectionTitle input[name=editing]').val(id);
        $('#sectionTitle #only_title').val(value);
        $('#sectionTitle #extra_class').val(extclass);
        $('#sectionTitle select[name=HeadinglayoutType] option[value=' + headingtype + ']').prop('selected', true);

        if (typeof id != undefined) {
            $('#sectionTitle #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
            $('#sectionTitle #exampleModalLabel b').text('Update Section Title');
        } else {
            $('#sectionTitle #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
        ...
        $('#sectionTitle #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
        $('#sectionTitle #heading_layout_type option').removeAttr("selected");
...
if ($('.composerbody div:first').removeClass('text-block')) {
    $(document).on('click', '.text-block', function(event) {
        ...
        if ($('.add-cms-block').hasClass('clicked')) {
            ...
            if (typeof id != undefined) {
                $('#sectionContent #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
                $('#sectionContent #exampleModalLabel b').text('Update Text Block');
            } else {
                $('#sectionContent #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.accordian-block', function(event) {
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        $('#sectionAccordian #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionAccordian #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.only-image', function(event) {
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        $('#sectionOnlyImage #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionOnlyImage #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.only-document', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionOnlyDocument').modal('show');
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        $('#sectionOnlyDocument #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionOnlyDocument #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$('#sectionOnlyDocument').on('shown.bs.modal', function() {
    ...
    //     timepicker: false
    // });
    $('#sectionOnlyDocument #doc_date_time').flatpickr({
...
$(document).on('click', '.only-video', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .videoclass').length == 1) {
        ...
        $('#sectionVideo #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionVideo #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.iframeonly', function(event) {
    if (!$(this).hasClass('section-item')) {
        ...
        if (typeof id != 'undefined') {
            ...
            $('#sectionIframe .addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
            $('#sectionIframe #exampleModalLabel b').text('Edit Iframe');
        } else {
            $('#sectionIframe input[name=editing]').val('');
            $('#sectionIframe .extraClass').val('cms n-mb-25');
            $('#sectionIframe input[name=content]').val('');
            $('#sectionIframe .addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.image-with-information', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .imgcontentclass').length == 1) {
        ...
        $('#sectionImage #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionImage #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.video-with-information', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionVideoContent').modal('show');
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .videocontentclass').length == 1) {
        ...
        $('#sectionVideoContent #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionVideoContent #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.google-map', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .mapclass').length == 1) {
        ...
        $('#sectionMap #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionMap #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.contact-info', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .contactinfoclass').length == 1) {
        ...
        $('#sectionContactInfo #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionContactInfo #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.section-button', function(event) {
    ...
    if ($('.add-cms-block').hasClass('clicked')) {
        ...
        if (id != '' && id != undefined) {
            ...
            var extClass = $('.buttonInfoOnly #' + id).data('extclass');
            ...
            $('#sectionButton #extra_class_only_btn').val(extClass);
            ...
            $('#sectionButton #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
            ...
            $('#sectionButton #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
            $('#sectionButton #exampleModalLabel b').text('Add Button');
            $('#sectionButton #extra_class_only_btn').val('');
...
$(document).on('click', '.two-part-content', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .twotextareaclass').length == 1) {
        ...
        $('#sectiontwoContent #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectiontwoContent #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.only-spacer', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionSpacerTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionSpacerTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        $('#sectionSpacerTemplate #exampleModalLabel b').text('Edit Content Spacer');
    } else {
        $('#sectionSpacerTemplate input[name=editing]').val('');
        $('#sectionSpacerTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.home-information', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .homeimagecontclass').length == 1) {
        ...
        $('#sectionHomeImage #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionHomeImage #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.custom-section', function(event) {
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .customSection').length == 1) {
        ...
        $('#customSectionBase #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#frmCustomSectionBase #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#frmCustomSectionBase #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.add-custom-record', function(event) {
    ...
    if (typeof id != 'undefined') {
        ...
        $('#customSection #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .add-custom-record').length == 1) {
        ...
        $('#customSection #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
...
$(document).on('click', '.image-gallery', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionGalleryImage').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionGalleryImage #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionGalleryImage #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    }
});
...
$(document).on('click', '.events-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionEventsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        extclass = $('#' + id).data('class');
        var template = $('#' + id).data('type');
        eventscat = $('#' + id).data('eventscat');

        $('#sectionEventsModuleTemplate input[name=editing]').val(id);
        $('#sectionEventsModuleTemplate input[name=template]').val(template);
        ...
        $('#sectionEventsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        if (template == 'current-month-events') {
            $('#sectionEventsModuleTemplate #exampleModalLabel b').text('Update Current Month Events');
        } else {
        ...
        var value = $(this).text();
        var template = $(this).find('a').attr('data-filter');
        ...
        $('#sectionEventsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
        if (template == 'current-month-events') {
            $('#sectionEventsModuleTemplate #exampleModalLabel b').text('Add Current Month Events');
        } else {
    ...
    //     timepicker: true
    // });
    $('#sectionEventsModuleTemplate #events_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT,
        enableTime: true
    });
    $('#sectionEventsModuleTemplate #events_end_date_time').flatpickr({
...
$(document).on('click', '.career-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionCareerModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionCareerModuleTemplate input[name=editing]').val(id);
        $('#sectionCareerModuleTemplate #section_title').val($.trim(value));
        $('#sectionCareerModuleTemplate #section_limit').val($.trim(slimit));
        $('#sectionCareerModuleTemplate #section_description').val(sdesc);
        $('#sectionCareerModuleTemplate #extra_class').val(extclass);

        $('#sectionCareerModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        $('#sectionCareerModuleTemplate #exampleModalLabel b').text('Edit Career');

    } else {
        var value = $(this).text();
        $('#sectionCareerModuleTemplate input[name=editing]').val('');
        $('#sectionCareerModuleTemplate #section_title').val($.trim(value));
        $('#sectionCareerModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
        $('#sectionCareerModuleTemplate #exampleModalLabel b').text('Add Career');
    }

    $('#sectionCareerModuleTemplate input[name=template]').val($(this).data('filter'));
});

$('#sectionCareerModuleTemplate').on('shown.bs.modal', function() {
    validateCareerTemplate.init();
}).on('hidden.bs.modal', function() {
    validateCareerTemplate.reset();
});


$(document).on('click', '.blogs-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionBlogsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionBlogsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionBlogsModuleTemplate #blogs_start_date_time').val(startdate);
        $('#sectionBlogsModuleTemplate #blogs_end_date_time').val(enddate);
        $('#sectionBlogsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    //     timepicker: true
    // });
    var date1=$('#sectionBlogsModuleTemplate #blogs_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT+ " H:i",
        enableTime: true,
        autoclose:true,
    ...
    var date2 = $('#sectionBlogsModuleTemplate #blogs_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        enableTime: true,
        autoclose:true,
    });
...
$(document).on('click', '.number-allocations', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionNumberAllocationsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionNumberAllocationsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionNumberAllocationsModuleTemplate #extra_class').val(extclass);
        $('#sectionNumberAllocationsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.service-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionServiceModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionServiceModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionServiceModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.candwservice-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectioncandwserviceModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectioncandwserviceModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectioncandwserviceModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.consultations-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionConsultationsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionConsultationsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionConsultationsModuleTemplate #consultations_start_date_time').val(startdate);
        $('#sectionConsultationsModuleTemplate #consultations_end_date_time').val(enddate);
        $('#sectionConsultationsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    //     timepicker: true
    // });
    $('#sectionConsultationsModuleTemplate #consultations_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT,
        enableTime: true
    });
    $('#sectionConsultationsModuleTemplate #consultations_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionConsultationsModuleTemplate #consultations_start_date_time').val() ? jQuery('#sectionConsultationsModuleTemplate #consultations_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.complaint-services-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionComplaintServicesModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionComplaintServicesModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionComplaintServicesModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.fmbroadcasting-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionFMBroadcastingModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionFMBroadcastingModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionFMBroadcastingModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.boardofdirectors-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionBoardofDirectorsTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionBoardofDirectorsTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionBoardofDirectorsTemplate #extra_class').val(extclass);
        $('#sectionBoardofDirectorsTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.register-application-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionRegisterofApplicationsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionRegisterofApplicationsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionRegisterofApplicationsModuleTemplate #extra_class').val(extclass);
        $('#sectionRegisterofApplicationsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.licence-register-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionLicenceRegisterModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionLicenceRegisterModuleTemplate select[name=sector] option[value=' + sector + ']').prop('selected', true);
        ...
        $('#sectionLicenceRegisterModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionLicenceRegisterModuleTemplate select[name=sector] option:first').prop('selected', true);
        $('#sectionLicenceRegisterModuleTemplate #extra_class').val(extclass);
        $('#sectionLicenceRegisterModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.forms-and-fees-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionFormsAndFeesModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionFormsAndFeesModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionFormsAndFeesModuleTemplate #extra_class').val(extclass);
        $('#sectionFormsAndFeesModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.publication-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionPublicationModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionPublicationModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionPublicationModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.decision-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionDecisionModuleTemplate').modal('show');

    var ajaxUrl = site_url + '/powerpanel/decision-category/getAllCategory';
    jQuery.ajax({
        type: "POST",
        url: ajaxUrl,
        dataType: 'HTML',
        async: false,
        success: function(result) {
            $('#sectionDecisionModuleTemplate #cat-template-layout').html(result);
        },
        complete: function() {
    ...
    if (typeof id != 'undefined') {
        ...
        config = $('#' + id).data('config');
        extclass = $('#' + id).data('class');
        decisioncat = $('#' + id).data('decisioncat');

        $('#sectionDecisionModuleTemplate input[name=editing]').val(id);
        $('#sectionDecisionModuleTemplate #section_title').val($.trim(value));
        $('#sectionDecisionModuleTemplate #section_limit').val($.trim(slimit));

        $('#sectionDecisionModuleTemplate #extra_class').val(extclass);
        if (decisioncat != '') {
            $('#sectionDecisionModuleTemplate select[name=decisioncat] option[value=' + decisioncat + ']').prop('selected', true);
        }
        $('#sectionDecisionModuleTemplate select[name=sectortype] option[value=' + sector + ']').prop('selected', true);

        $('#sectionDecisionModuleTemplate select[name=section_config] option[value=' + config + ']').prop('selected', true);
        $('#sectionDecisionModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        $('#sectionDecisionModuleTemplate #exampleModalLabel b').text('Edit Decision');
    } else {
        var value = $(this).text();
        $('#sectionDecisionModuleTemplate input[name=editing]').val('');
        $('#sectionDecisionModuleTemplate #section_title').val($.trim(value));
        $('#sectionDecisionModuleTemplate #extra_class').val(extclass);
        $('#sectionDecisionModuleTemplate select[name=publicationscat] option:first').prop('selected', true);
        $('#sectionDecisionModuleTemplate select[name=sectortype] option:first').prop('selected', true);

        $('#sectionDecisionModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
        $('#sectionDecisionModuleTemplate #exampleModalLabel b').text('Add Decision');
    }

    $('#sectionDecisionModuleTemplate input[name=template]').val($(this).data('filter'));
});

$('#sectionDecisionModuleTemplate').on('shown.bs.modal', function() {
    // $('#sectionDecisionModuleTemplate select').selectpicker();
    validateDecisionTemplate.init();
}).on('hidden.bs.modal', function() {
    // $('#sectionDecisionModuleTemplate select').selectpicker('destroy');
    validateDecisionTemplate.reset();
});
...
$(document).on('click', '.photoalbum-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionPhotoAlbumModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionPhotoAlbumModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionPhotoAlbumModuleTemplate #photo_start_date_time').val(startdate);
        $('#sectionPhotoAlbumModuleTemplate #photo_end_date_time').val(enddate);
        $('#sectionPhotoAlbumModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    //     timepicker: true
    // });
    $('#sectionPhotoAlbumModuleTemplate #photo_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT,
        enableTime: true
    });
    $('#sectionPhotoAlbumModuleTemplate #photo_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionPhotoAlbumModuleTemplate #photo_start_date_time').val() ? jQuery('#sectionPhotoAlbumModuleTemplate #photo_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.videogallery-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionVideoAlbumModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionVideoAlbumModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionVideoAlbumModuleTemplate #photo_start_date_time').val(startdate);
        $('#sectionVideoAlbumModuleTemplate #photo_end_date_time').val(enddate);
        $('#sectionVideoAlbumModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    //     timepicker: true
    // });
    $('#sectionVideoAlbumModuleTemplate #photo_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT,
        enableTime: true
    });
    $('#sectionVideoAlbumModuleTemplate #photo_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionVideoAlbumModuleTemplate #photo_start_date_time').val() ? jQuery('#sectionVideoAlbumModuleTemplate #photo_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.news-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionNewsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionNewsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionNewsModuleTemplate #news_start_date_time').val(startdate);
        $('#sectionNewsModuleTemplate #news_end_date_time').val(enddate);
        $('#sectionNewsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    //     timepicker: true
    // });
    $('#sectionNewsModuleTemplate #news_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT,
        enableTime: true
    });
    $('#sectionNewsModuleTemplate #news_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionNewsModuleTemplate #news_start_date_time').val() ? jQuery('#sectionNewsModuleTemplate #news_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.public-record-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionPublicRecordModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionPublicRecordModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionPublicRecordModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.quick-links-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionQuickLinkTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionQuickLinkTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionQuickLinkTemplate #qlink_start_date_time').val(startdate);
        $('#sectionQuickLinkTemplate #qlink_end_date_time').val(enddate);
        $('#sectionQuickLinkTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    $('#sectionQuickLinkTemplate #qlink_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT,
        enableTime: true
    });
    $('#sectionQuickLinkTemplate #qlink_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionQuickLinkTemplate #qlink_start_date_time').val() ? jQuery('#sectionQuickLinkTemplate #qlink_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.latest-news-template', function(event) {
    ...
    $('#pgBuiderSections').modal('hide');
    $('#sectionLatestNewsTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionLatestNewsTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionLatestNewsTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.alerts-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionAlertsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionAlertsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionAlertsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    $('#sectionAlertsModuleTemplate #alert_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        enableTime: true
    });

    $('#sectionAlertsModuleTemplate #alert_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionAlertsModuleTemplate #alert_start_date_time').val() ? jQuery('#sectionAlertsModuleTemplate #alert_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.department-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionDepartmentModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionDepartmentModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionDepartmentModuleTemplate #department_start_date_time').val(startdate);
        $('#sectionDepartmentModuleTemplate #department_end_date_time').val(enddate);
        $('#sectionDepartmentModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    $('#sectionDepartmentModuleTemplate #department_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        enableTime: true
    });
    $('#sectionDepartmentModuleTemplate #department_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionAlertsModuleTemplate #alert_start_date_time').val() ? jQuery('#sectionAlertsModuleTemplate #alert_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.organizations', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionOrganizationsModule').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionOrganizationsModule #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionOrganizationsModule #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.interconnections', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionInterconnectionsModule').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionInterconnectionsModule select[name=sectortype] option[value=' + sector + ']').prop('selected', true);
        $('#sectionInterconnectionsModule #extra_class').val(extclass);
        $('#sectionInterconnectionsModule #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionInterconnectionsModule select[name=sectortype] option:first').prop('selected', true);
        $('#sectionInterconnectionsModule #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.links-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionLinksModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionLinksModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionLinksModuleTemplate #link_start_date_time').val(startdate);
        $('#sectionLinksModuleTemplate #link_end_date_time').val(enddate);
        $('#sectionLinksModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    $('#sectionLinksModuleTemplate #link_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        enableTime: true
    });
    $('#sectionLinksModuleTemplate #link_start_date_time').flatpickr({
...
$(document).on('click', '.faqs-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionFaqsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionFaqsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionFaqsModuleTemplate #faq_start_date_time').val(startdate);
        $('#sectionFaqsModuleTemplate #faq_end_date_time').val(enddate);
        $('#sectionFaqsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
    ...
    $('#sectionFaqsModuleTemplate #faq_start_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        enableTime: true
    });
    $('#sectionFaqsModuleTemplate #faq_end_date_time').flatpickr({
        dateFormat: DEFAULT_DATE_FORMAT + " H:i",
        minDate: jQuery('#sectionFaqsModuleTemplate #faq_start_date_time').val() ? jQuery('#sectionFaqsModuleTemplate #faq_start_date_time').val() : false,
        enableTime: true
    });
...
$(document).on('click', '.promotions-template', function(event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionPromotionsModuleTemplate').modal('show');
    ...
    if (typeof id != 'undefined') {
        ...
        $('#sectionPromotionsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
        ...
        $('#sectionPromotionsModuleTemplate #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
...
$(document).on('click', '.add-row', function(event) {
    ...
    section += '<i title="Drag" class="action-icon move ri-arrow-left-right-line"></i>';
    section += '<a href="javascript:;" data-id="' + editor + '" class="delete-row" title="Delete"><i class="action-icon delete ri-delete-bin-line row-delete"></i></a>';
    section += '<a href="javascript:;" data-id="' + editor + '" class="edit-row" title="Delete"><i class="action-icon edit ri-pencil-fill"></i></a>';
    section += '<div class="ui-new-section-add col-sm-12">';
    section += '<div class="column-list clearfix" data-id="' + editor + '-column-list"></div>';
    section += '<a href="javascript:;" data-id="' + editor + '"  title="Add Column(s)" class="add-icon add-columns"><i class="ri-layout-column-line" aria-hidden="true"></i></a>';
...
$(document).on('click', '.edit-col-row', function(event) {
    ...
    var column_row_width = $('input[data-id="' + item_id + '"]').attr('data-column-row-width');

    $('#frmEditColRow input[name="col_row_class"]').val(extclass);
    $('#frmEditColRow select[name="animation"]').val(animation);
    if (column_row_width == "T") {
        $('#column_row_width').prop('checked', true)
    } else {
        $('#column_row_width').prop('checked', false)
    }
...
$(document).on('click', '.add-columns', function(event) {
    ...
    $('#frmAddColumns #addSection').html('<div class="flex-shrink-0"><i class="ri-add-line label-icon align-middle fs-20 me-2"></i></div>Add');
});
...
$(document).on('click', '.edit-column', function(event) {
    ...
    $('#frmAddColumns #addSection').html('<div class="flex-shrink-0"><i class="ri-pencil-line label-icon align-middle fs-20 me-2"></i></div>Update');
...
$(document).on('click', '.add-cms-block', function(event) {
    ...
    $('.nav-tabs li').each(function() {
        ...
        if (id == 'blocks_tab') {
            $(this).show();
            $('#' + id + ' a').trigger("click");
        } else if (id == 'allmodules_tab') {
            $(this).show();
        } else if (id == 'forms_tab') {
            $(this).show();
        } else if (id == 'publications_tab') {
            $(this).show();
        } else if (id == 'service_tab') {
            $(this).show();
        } else if (id == 'events_tab') {
            $(this).show();
        } else if (id == 'team_tab') {
            $(this).show();
        } else if (id == 'decision_tab') {
            $(this).show();
        } else {
            $(this).hide();
        }
...
var validateSectionOnlyIframe = function() {
    var handleSectionOnlyIframe = function() {
        $("#frmSectionIframe").validate({
            ...
            messages: {
                content: {
                    required: "Please enter the Iframe url"
                }
            },
            errorPlacement: function(error, element) {
                if (element.parent('.input-group').length) {
...
var validateCareerTemplate = function() {
    var handleCareerTemplate = function() {
        $("#frmSectionCareerModuleTemplate").validate({
            ...
            submitHandler: function(form) {
                builder.submitFrmSectionCareerModuleTemplate();
                return false;
            }
        });
...
var validateDecisionTemplate = function() {
    var handleDecisionTemplate = function() {
        $("#frmSectionDecisionModuleTemplate").validate({
            errorElement: 'span', //default input error message container
            errorClass: 'help-block', // default input error message class
            ignore: [],
            rules: {
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionDecisionModuleTemplate')).show();
            },
            highlight: function(element) { // hightlight error inputs
                $(element).closest('.form-group').addClass('has-error'); // set error class to the control group
            },
            ...
            submitHandler: function(form) {
                builder.submitFrmSectionDecisionModuleTemplate();
                return false;
            }
        });
        $('#frmSectionDecisionModuleTemplate input').keypress(function(e) {
            if (e.which == 13) {
                builder.submitFrmSectionDecisionModuleTemplate();
                return false;
            }
    ...
    return {
        //main function to initiate the module
        init: function() {
            handleDecisionTemplate();
        },
        reset: function() {
            var validator = $("#frmSectionDecisionModuleTemplate").validate();
            validator.resetForm();
        }
    };
}();
