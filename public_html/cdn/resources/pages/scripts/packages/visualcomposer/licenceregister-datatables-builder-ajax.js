            ...
            jQuery.ajax({
                ...
                success: function (result) {
                    ...
                    if(result.recordsTotal == 0 || result.found == 0 && ignoreItems == '' ) {
                        ...
                        $('#frmSectionLicenceRegisterModule').find('#addSection').attr('disabled','disabled');
                    }else{
                        $('#frmSectionLicenceRegisterModule').find('#addSection').removeAttr('disabled');
                    }
                      }
                },
...
$('#sectionLicenceRegisterModule').on('shown.bs.modal', function () {
    ...
    LicenceRegisterDataTable.init(start, range,false);
                ...
                if ($('input[name=found]').val() > 0) {
                    ...
                    setTimeout(function () {
                        if ($('#sectionLicenceRegisterModule #record-table tr').length < $('input[name=total_records]').val()) {
                            ...
                            LicenceRegisterDataTable.init(start, range,true);
                        } else {
                            $('#datatable_licence-register_ajax').closest('.col-md-12').loading('stop');
                        }
                    }, 1000);
