            ...
            jQuery.ajax({
                ...
                success: function (result) {
                    ...
                    if(result.recordsTotal == 0 || result.found == 0 && ignoreItems == '' ) {
                        ...
                        $('#frmSectionComplaintServicesModule').find('#addSection').attr('disabled','disabled');
                    }else{
                        $('#frmSectionComplaintServicesModule').find('#addSection').removeAttr('disabled');
                    }
                }
                },
...
$('#sectionComplaintServicesModule').on('shown.bs.modal', function () {
    ...
    ComplaintServicesDataTable.init(start, range,false);
                ...
                if ($('input[name=found]').val() > 0) {
                    ...
                    setTimeout(function () {
                        if ($('#sectionComplaintServicesModule #record-table tr').length < $('input[name=total_records]').val()) {
                            ...
                            ComplaintServicesDataTable.init(start, range,true);
                        } else {
                            $('#datatable_complaint-services_ajax').closest('.col-md-12').loading('stop');
                        }
                    }, 500);
