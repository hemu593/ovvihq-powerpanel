        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 3,
                        "bSortable": false,
                        className: 'text-left News_cat_P_3'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-left News_sdate_P_4'
                    }, {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-left News_publish_P_7 publish_switch'
                    },
                    {
                        "data": 6,
                        "bSortable": false,
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/public-record/get_list", // ajax source
                },
    ...
    var handleRecords1 = function() {
        ...
        grid1.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/public-record/get_list_New", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 4,
                        "bSortable": false,
                        className: 'text-center form-switch News_publish_D_7'
                    },
                    {
                        "data": 5,
                        "bSortable": false,
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/public-record/get_list_draft", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
    ...
    var handleRecords3 = function() {
        ...
        grid3.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/public-record/get_list_trash", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[4]);
                },
    ...
    var handleRecords4 = function() {
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/public-record/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function(nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[5]);
                },
...
var Custom = function() {
    return {
        ...
        getModuleRecords: function(sectorName) {
            ...
            var ajaxUrl = site_url + '/powerpanel/public-record/getSectorwiseCategoryGrid';
            jQuery.ajax({
                type: "POST",
                url: ajaxUrl,
                dataType: 'HTML',
                ...
                async: false,
                beforeSend: function() {
                	/*if(typeof choicesEl['category_id'] != "undefined"){
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/public-record/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
