        ...
        grid.init({
            ...
            dataTable: {
                ...
                "language": {
                    ...
                    "data": 1,
                    "name": 'varTitle',
                    "class": 'text-left Publications_title_P_2 mob-show_div',
                    'bSortable': true
                }, {
                    "data": 2,
                    "name": 'PublicationDate',
                    "class": 'text-center Publications_sdate_P_4'
                }, {
                    "data": 3,
                    "bSortable": false,
                    "class": 'text-center Publications_cat_P_6'
                }, {
                    "data": 4,
                    "bSortable": false,
                    "class": 'text-center form-switch Publications_publish_P_8',
                }, {
                    "data": 5,
...
var Custom = function() {
    return {
        ...
        getModuleRecords: function(sectorName) {
            ...
            var ajaxUrl = site_url + '/powerpanel/publications/getSectorwiseCategoryGrid';
            jQuery.ajax({
                type: "POST",
                url: ajaxUrl,
                dataType: 'HTML',
