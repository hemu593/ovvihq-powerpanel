                ...
                "columns": [{
                    ...
                    },
                    {
                    ...
                    },
                     {
                        "data": 3,
                         "name": 'DecisionDate',
                        className: 'text-left Decision_sdate_P_4'
                    },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-left Decision_cat_P_6'
                    }, {
                        "data": 5,
                        "bSortable": false,
                        className: 'text-left form-switch Decision_publish_P_8',
                    },
                    {
                        "data": 6,
                        "bSortable": false,
            ...
            dataTable: {
                ...
                "columns": [{
                    ...
                    },
                    {
                        "data": 3,
                         "name": 'DecisionDate',
                        className: 'text-center Decision_sdate_P_4'
                    },
                    {
                        "data": 4,
                        "bSortable": false,
            ...
            dataTable: {
                ...
                "columns": [{
                    ...
                    },
                    {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-center form-switch Decision_publish_D_8',
                    },
                    {
                        "data": 5,
                        "bSortable": false,
...
var Custom = function() {
    return {
        ...
        getModuleRecords: function(sectorName) {
            ...
            var ajaxUrl = site_url + '/powerpanel/decision/getSectorwiseCategoryGrid';
            jQuery.ajax({
                type: "POST",
                url: ajaxUrl,
                dataType: 'HTML',
