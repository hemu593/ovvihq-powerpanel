        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    'class': 'text-left FaqCategory_title_P_1 mob-show_div',
                    'name': 'varTitle',
                    'bSortable': true
                }, {
                    "data": 2,
                    "class": 'text-left FaqCategory_order_P_2',
                    "name": 'intDisplayOrder'
                }, {
                    "data": 3,
                    'class': 'text-center form-switch FaqCategory_publish_P_3',
                    'name': 'publish',
                    'bSortable': false
                }, {
                    "data": 4,
                    'class': 'text-center FaqCategory_dactions_P_4 last_td_action mob-show_div',
                    'bSortable': false
                } ],
                "ajax": {
