        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 3,
                    className: 'text-left Number_Allocation_cat_P_3',
                    "name": 'intFKCategory'
                }, {
                    "data": 4,
                    className: 'text-left Number_Allocation_service_P_4',
                    "bSortable": false
                }, {
                    "data": 5,
                    "name": 'intDisplayOrder',
                    className: 'text-left Number_Allocation_order_P_5'
                }, {
                    "data": 6,
                    className: 'text-left form-switch Number_Allocation_publish_P_6',
                    "bSortable": false
                }, {
                    "data": 7,
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 5,
                    className: 'text-center form-switch Number_Allocation_publish_P_6',
                    "bSortable": false
                }, {
                    "data": 6,
                    className: 'text-right last_td_action mob-show_div Number_Allocation_dactions_P_7',
