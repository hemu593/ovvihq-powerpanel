    ...
    var handleNews = function() {
        $("#frmServiceCategory").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit  
                ...
                $('.alert-danger', $('#frmServiceCategory')).show();
            },
        ...
        $('#frmServiceCategory input').keypress(function(e) {
            if (e.which == 13 && e.keyCode != 188) {
                if ($('#frmServiceCategory').validate().form()) {
                    $('#frmServiceCategory').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
