        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 3,
                        "bSortable": false,
                        className: 'text-left Rfps_cat_P_3'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-left Rfps_sdate_P_4'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-left Rfps_edate_P_5'
                    }, {
                        "data": 6,
                        className: 'text-left Rfps_hits_P_6',
                        "bSortable": false
                    }, {
                        "data": 7,
                        "bSortable": false,
                        className: 'text-left Rfps_publish_P_7 publish_switch'
                    },
                    {
                        "data": 8,
                        "bSortable": false,
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 6,
                        "bSortable": false,
                        className: 'text-center form-switch Rfps_publish_D_7'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
