        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 3,
                        "bSortable": false,
                        className: 'text-left Organizations_designation_P_3'
                    }, {
                        "data": 4,
                        "bSortable": false,
                        className: 'text-left Organizations_porganization_P_4'
                    },
                    {
                        "data": 5,
                        "name": 'intDisplayOrder',
                        className: 'text-left Organizations_displayorder_P_5'
                    },
                    {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-left form-switch Organizations_publish_P_6'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
