        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [
                    ...
                    { "data": 2, className: 'text-center',"name": 'email'},
                    { "data": 3, className: 'text-center', "name": 'txnId'},
                    { "data": 4, className: 'text-center', "name": 'txnStatus'},
                    { "data": 5, className: 'text-center'},
                    { "data": 6, className: 'text-center', "name": 'payment_date'}
                ],
                "ajax": {
