        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                    ...
                    "data": 1,
                    'class': 'text-left CareerCategory_title_P_1 mob-show_div',
                    'name': 'varTitle',
                    'bSortable': true
                }, {
                    "data": 2,
                    "class": 'text-left CareerCategory_order_P_5',
                    "name": 'intDisplayOrder'
                }, {
                    "data": 3,
                    'class': 'text-center form-switch CareerCategory_publish_P_3',
                    'name': 'chrPublish',
                    'bSortable': false
                }, {
                    "data": 4,
...
var TableDatatablesAjax4 = function() {
    var handleRecords4 = function() {
        ...
        grid4.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                    ...
                    "data": 2,
                    "class": 'text-left CareerCategory_order_P_2',
                    "name": 'intDisplayOrder'
                }, {
                    "data": 3,
                    'class': 'text-center form-switch CareerCategory_publish_P_3',
        ...
        grid4.getDataTable().column(2).visible(false);
