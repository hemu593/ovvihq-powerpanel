...
function getAdminUsers() {
    ...
    $.ajax({
        type: "POST",
        url: window.site_url + '/powerpanel/workflow/get-admin-users',
        async: false,
        beforeSend: function() {
            choicesEl['user'].destroy();
        },
        success: function(result) {
            $("#user").html(result).trigger('change');
...
function getModulesByRole(roleIds) {
    $('body').loader(loaderConfig);
    $.ajax({
        type: "POST",
        url: window.site_url + '/powerpanel/workflow/get-module-by-role',
        data: {
            role_id: roleIds
        },
        async: false,
