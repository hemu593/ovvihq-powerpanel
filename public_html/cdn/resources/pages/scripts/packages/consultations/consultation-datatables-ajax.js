        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 3,
                        "bSortable": false,
                        className: 'text-left Consultation_cat_P_3'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-left Consultation_sdate_P_4'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-left Consultation_edate_P_5'
                    }, {
                        "data": 6,
                        "bSortable": false,
                        className: 'text-left Consultation_publish_P_6 publish_switch'
                    },
                    {
                        "data": 7,
                        "bSortable": false,
        ...
        grid2.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "columns": [{
                        ...
                        "data": 5,
                        "bSortable": false,
                        className: 'text-center form-switch Consultation_publish_P_7'
                    },
                    {
                        "data": 6,
                        "bSortable": false,
