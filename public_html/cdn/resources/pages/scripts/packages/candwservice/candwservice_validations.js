    ...
    var handleNews = function() {
        $("#frmCandWService").validate({
            ...
            invalidHandler: function(event, validator) { //display error alert on form submit  
                ...
                $('.alert-danger', $('#frmCandWService')).show();
            },
        ...
        $('#frmCandWService input').keypress(function(e) {
            if (e.which == 13 && e.keyCode != 188) {
                if ($('#frmCandWService').validate().form()) {
                    $('#frmCandWService').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
...
jQuery(document).ready(function() {
    ...
    $('#cwServices_date').datetimepicker({
