...
function setTitle() {
    let title = $('.tab-pane.active h4').text() + ' Settings';
    title = title.replace("Settings Settings", "Settings");
    $('#page-topbar h4').text(title);
}

$('.simplebar-content li a').click(function() {
    var tabid = $(this).data('id');

    $('.tab-pane').removeClass('active');
    $('.tab-pane[id="' + tabid + '"]').addClass('active');
