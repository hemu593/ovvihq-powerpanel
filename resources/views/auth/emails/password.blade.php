                ...
                <tr>
                  <td width="100%" style="padding:20px 20px 15px" align="center">
                    <a href="{{url('/')}}" title="{{ Config::get('Constant.SITE_NAME') }}">
                      <img src="{!! App\Helpers\resize_image::resize(Config::get('Constant.FRONT_LOGO_ID'),300,200) !!}" alt="{{ Config::get('Constant.SITE_NAME') }}" style="height:120px;width:120px" />
                    </a>
                  </td>
                </tr>
              </tbody>
            ...
            <tr>
              <td width="100%" style="margin: 0;padding:0px 15px 10px 5px;" align="center">
                ...
                @if(isset($facebookLink) && !empty($facebookLink))
                  ...
                  <img src="{{Config::get('Constant.CDN_PATH').'assets/images/socials/facebook_icon2.png'}}" alt="{{ Config::get('Constant.SITE_NAME') }} Facebook" style="display: inline-block;" width="32" height="32" border="0" title="{{ Config::get('Constant.SITE_NAME') }} Facebook"></a>&nbsp;
                @endif
                @if(isset($twitterLink) && !empty($twitterLink))
                  <a href="{{$twitterLink}}" style="color:#ededed;">
                  <img alt="{{ Config::get('Constant.SITE_NAME') }} Twitter" src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/twitter_icon2.png' }}" title="{{ Config::get('Constant.SITE_NAME') }} Twitter" style="display: inline-block;" width="32" height="32" border="0"></a>&nbsp;
                @endif
                @if(isset($linkedLink) && !empty($linkedLink))
                  <a href="{{$linkedLink}}" style="color:#ededed;">
                  <img alt="{{ Config::get('Constant.SITE_NAME') }} Linkedin" src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/linkedin_icon2.png' }}" title="{{ Config::get('Constant.SITE_NAME') }} Linkedin" style="display: inline-block;" width="32" height="32" border="0"></a>&nbsp;
                @endif
                @if(isset($youtubeLink) && !empty($youtubeLink))
                  <a href="{{$youtubeLink}}" style="color:#ededed;">
                  <img alt="{{ Config::get('Constant.SITE_NAME') }} Youtube" src="{{ Config::get('Constant.CDN_PATH').'assets/images/socials/youtube_icon2.png' }}" title="{{ Config::get('Constant.SITE_NAME') }} Youtube" style="display: inline-block;" width="32" height="32" border="0"></a>&nbsp;
                @endif
                </span>
              </td>
            </tr>
