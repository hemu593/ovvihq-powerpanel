                    ...
                    <div class="search-part">
                        @if(!empty($inf))
                            ...
                            @if(isset($inf) && isset($inf['varMetaTitle']))
                                ...
                                @php 
                                    ...
                                    $privateLink = "";
                                    if(isset($inf['privateLink']) && isset($inf['chrPageActive']) && $inf['chrPageActive'] == 'PR') {
                                        $privateLink = $inf['privateLink'];
                                    }
                                @endphp
                                <h4 class="page-title"><span class="{!! $Class_metatitle !!}" id="meta_title">{{ $metaTitle }}</span></h4>
                                <a class="link" href="{{ $varURL.'/'.$privateLink }}" target="_blank">{{ $varURL }}</a>
                            @endif
                            {{-- Meta Description --}}
                        ...
                        @if(empty($inf))
                            <div class="seo_editor mt-3" style="display: none;">
                                <h4 class="page-title"><span id="meta_title"></span></h4>
                                <p class="seo_link mb-0">
                                    <a onClick="generatePreview('{{url('/previewpage?url='.(url('/')))}}');" class="snippet_alias link"></a>
                                </p>
                                <p class="mb-1"><span id="meta_description"></span></p>
                            </div>
                        @endif
